...
.field private mWhiteListActionList:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap<",
            "Ljava/lang/String;",
...
.method constructor <init>(Lcom/android/server/AlarmManagerService;Landroid/content/Context;Landroid/os/Handler;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, Lcom/android/server/AlarmManagerService$Alignment;->mWhiteListActionList:Ljava/util/HashMap;
...
.method checkExactActionMap(Ljava/lang/String;Ljava/lang/String;Ljava/util/HashMap;)Z
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method convertToAligned(Lcom/android/server/AlarmManagerService$Alarm;Z)J
    ...
    iget-object v12, v1, Lcom/android/server/AlarmManagerService$Alignment;->mWhiteListActionList:Ljava/util/HashMap;

    invoke-virtual {v1, v10, v0, v12}, Lcom/android/server/AlarmManagerService$Alignment;->checkExactActionMap(Ljava/lang/String;Ljava/lang/String;Ljava/util/HashMap;)Z
...
.method dump(Ljava/io/PrintWriter;)V
    ...
    iget-object v0, p0, Lcom/android/server/AlarmManagerService$Alignment;->mWhiteListActionList:Ljava/util/HashMap;
...
.method public initBlackAlarm()V
    .locals 31
    ...
    const-string v2, "alarm.push.timer.action"

    const-string/jumbo v3, "wns.heartbeat"

    const-string v4, "action_heartbeat_plot_alarm_cycle"

    const-string/jumbo v5, "io.rong.push.HeartBeat"

    const-string v6, "action_keep_alive_close"

    const-string v7, "HEART_BEAT"

    const-string v8, "CONNECT_EVENT"

    const-string v9, "AlarmTaskSchedule"

    const-string v10, "com.q.m.QS"

    const-string/jumbo v11, "intent.action.COCKROACH"

    const-string v12, "com.baidu.sofire.x0"

    const-string/jumbo v13, "push_heart_beat"

    const-string v14, "com.huawei.intent.action.PUSH_OFF"

    const-string v15, "com.huawei.action.CONNECT_PUSHSRV"

    const-string v16, "com.huawei.intent.action.PUSH"

    const-string/jumbo v17, "hyphenate.chat.heatbeat.soulapp#soul"

    const-string v18, "com.tencent.android.tpush.service.channel.heartbeatIntent"

    const-string v19, "com.dianping.push.START"

    const-string v20, "com.dianping.push.RECONNECT"

    const-string v21, "com.dianping.push.KEEP_ALIVE"

    const-string v22, "com.xiaomi.push.PING_TIMER"

    const-string v23, "com.baidu.android.pushservice.PushService"

    const-string v24, "cn.jpush.android.service.AlarmReceiver"

    const-string v25, "com.tencent.tmsdk.HeartBeatPlot.ACTION_HEARTBEAT_PLOT_ALARM_CYCLE"

    const-string v26, "com.jio.myjio/com.ril.jio.jiosdk.receiver.JioNetworkChangeReceiver"

    const-string v27, "com.sinovatech.unicom.ui/com.sinovatech.unicom.separatemodule.notice.NoticeWakefulReceiver"

    const-string v28, "com.google.android.gms.gcm.HEARTBEAT_ALARM"

    const-string v29, "com.google.android.intent.action.GCM_RECONNECT"

    const-string v30, "alibaba_push_wakeup_alarm_action"
    ...
    iget-object v2, v0, Lcom/android/server/AlarmManagerService$Alignment;->mAlarmBlacklist:Ljava/util/HashMap;

    const-string v3, "black_action"
    ...
    const-string v28, "alibaba_push_wakeup_alarm_action"
...
.method public resolveConfigFromJSON(Lorg/json/JSONArray;)V
    ...
    const-string/jumbo v5, "white_list_action_list"
    ...
    iget-object v3, p0, Lcom/android/server/AlarmManagerService$Alignment;->mWhiteListActionList:Ljava/util/HashMap;
    ...
    :cond_12
    iget-object v10, p0, Lcom/android/server/AlarmManagerService$Alignment;->mWhiteListActionList:Ljava/util/HashMap;
    ...
    :try_start_7
    iget-object v11, p0, Lcom/android/server/AlarmManagerService$Alignment;->mWhiteListActionList:Ljava/util/HashMap;
