...
.method private handleInitialize()V
    ...
    invoke-static {}, Lcom/android/server/location/GnssLocationProvider;->access$5400()V
    ...
    invoke-static {v0}, Lcom/android/server/location/GnssLocationProvider;->access$5500(Lcom/android/server/location/GnssLocationProvider;)Z
    ...
    invoke-static {v1}, Lcom/android/server/location/GnssLocationProvider;->access$5600(Lcom/android/server/location/GnssLocationProvider;)V
    ...
    invoke-static {v3}, Lcom/android/server/location/GnssLocationProvider;->access$2200(Lcom/android/server/location/GnssLocationProvider;)Ljava/util/Properties;

    move-result-object v3

    invoke-static {v1, v2, v3}, Lcom/android/server/location/GnssLocationProvider;->access$5700(Lcom/android/server/location/GnssLocationProvider;Landroid/content/Context;Ljava/util/Properties;)V
    ...
    invoke-static {v2}, Lcom/android/server/location/GnssLocationProvider;->access$5800(Lcom/android/server/location/GnssLocationProvider;)Landroid/telephony/SubscriptionManager$OnSubscriptionsChangedListener;
    ...
    invoke-static {}, Lcom/android/server/location/GnssLocationProvider;->access$5900()Z
    ...
    invoke-static {v4}, Lcom/android/server/location/GnssLocationProvider;->access$6000(Lcom/android/server/location/GnssLocationProvider;)Landroid/content/BroadcastReceiver;
    ...
    :cond_1
    invoke-static {}, Lcom/android/server/location/GnssLocationProvider;->access$1000()Z
    ...
    invoke-static {v5}, Lcom/android/server/location/GnssLocationProvider;->access$6200(Lcom/android/server/location/GnssLocationProvider;)Landroid/net/ConnectivityManager;
    ...
    invoke-static {v6}, Lcom/android/server/location/GnssLocationProvider;->access$6100(Lcom/android/server/location/GnssLocationProvider;)Landroid/net/ConnectivityManager$NetworkCallback;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v1, v3}, Lcom/android/server/location/GnssLocationProvider;->access$5000(Lcom/android/server/location/GnssLocationProvider;Lcom/android/server/location/GnssLocationProvider$SvStatusInfo;)V
    ...
    invoke-static {v1, v3, v4}, Lcom/android/server/location/GnssLocationProvider;->access$4900(Lcom/android/server/location/GnssLocationProvider;ZLandroid/location/Location;)V
    ...
    invoke-static {v1, v3}, Lcom/android/server/location/GnssLocationProvider;->access$4500(Lcom/android/server/location/GnssLocationProvider;Z)V
    ...
    invoke-static {v1, v3}, Lcom/android/server/location/GnssLocationProvider;->access$4400(Lcom/android/server/location/GnssLocationProvider;I)V
    ...
    invoke-static {v1, v3}, Lcom/android/server/location/GnssLocationProvider;->access$4300(Lcom/android/server/location/GnssLocationProvider;Ljava/net/InetAddress;)V
    ...
    invoke-static {v1, v3}, Lcom/android/server/location/GnssLocationProvider;->access$1400(Lcom/android/server/location/GnssLocationProvider;Landroid/content/Context;)V
    ...
    invoke-static {v1, v3}, Lcom/android/server/location/GnssLocationProvider;->access$502(Lcom/android/server/location/GnssLocationProvider;I)I
    ...
    invoke-static {v1, v3}, Lcom/android/server/location/GnssLocationProvider;->access$4700(Lcom/android/server/location/GnssLocationProvider;Landroid/location/Location;)V
    ...
    invoke-static {v1}, Lcom/android/server/location/GnssLocationProvider;->access$4600(Lcom/android/server/location/GnssLocationProvider;)V
    ...
    invoke-static {v1}, Lcom/android/server/location/GnssLocationProvider;->access$400(Lcom/android/server/location/GnssLocationProvider;)Lcom/android/server/location/NtpTimeHelper;
    ...
    invoke-static {v1, v3}, Lcom/android/server/location/GnssLocationProvider;->access$4200(Lcom/android/server/location/GnssLocationProvider;Landroid/net/Network;)V
    ...
    invoke-static {v1}, Lcom/android/server/location/GnssLocationProvider;->access$3900(Lcom/android/server/location/GnssLocationProvider;)V
    ...
    invoke-static {v1}, Lcom/android/server/location/GnssLocationProvider;->access$4000(Lcom/android/server/location/GnssLocationProvider;)V
    ...
    invoke-static {v1}, Lcom/android/server/location/GnssLocationProvider;->access$5100(Lcom/android/server/location/GnssLocationProvider;)V
    ...
    invoke-static {v1}, Lcom/android/server/location/GnssLocationProvider;->access$5200(Lcom/android/server/location/GnssLocationProvider;)Landroid/os/PowerManager$WakeLock;
    ...
    invoke-static {v3, v0}, Lcom/android/server/location/GnssLocationProvider;->access$5300(Lcom/android/server/location/GnssLocationProvider;I)Ljava/lang/String;
