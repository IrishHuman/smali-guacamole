...
.field private static GNSSLOCATION_BUGREPORT_CLASS:Ljava/lang/String; = null

.field private static final GNSSLOCATION_BUGREPORT_ISSUE_NAME:Ljava/lang/String; = "data_issue_name"

.field private static GNSSLOCATION_BUGREPORT_PACKAGE:Ljava/lang/String; = null

.field private static final GNSSLOCATION_BUGREPORT_SPECIAL_NAME:Ljava/lang/String; = "data_special_name"
...
.field private static final GNSSLOCATION_TRACK_SEND_BUGREPORT:I = 0x64
...
.field private static final LPPE_CP_PROFILE:Ljava/lang/String; = "persist.sys.gps.lppe.cp"
...
.field private static mGnssLocationExceptionNum:J
...
.field private mGnssLocationBugreportConnection:Landroid/content/ServiceConnection;

.field private mGnssLocationBugreportService:Landroid/os/Messenger;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/location/GnssLocationProvider;->GNSSLOCATION_BUGREPORT_PACKAGE:Ljava/lang/String;

    const-string v0, "com.oneplus.opbugreportlite.BugReportLiteService"

    sput-object v0, Lcom/android/server/location/GnssLocationProvider;->GNSSLOCATION_BUGREPORT_CLASS:Ljava/lang/String;

    const-wide/16 v0, 0x0

    sput-wide v0, Lcom/android/server/location/GnssLocationProvider;->mGnssLocationExceptionNum:J

    const/4 v0, 0x0

    sput v0, Lcom/android/server/location/GnssLocationProvider;->mGnssLocationExceptionTimeout:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/location/ILocationManager;Landroid/os/Looper;)V
    ...
    iput-object v0, p0, Lcom/android/server/location/GnssLocationProvider;->mGnssLocationBugreportConnection:Landroid/content/ServiceConnection;
    ...
    new-instance v3, Lcom/android/server/location/GnssLocationProvider$17;

    invoke-direct {v3, p0}, Lcom/android/server/location/GnssLocationProvider$17;-><init>(Lcom/android/server/location/GnssLocationProvider;)V
    ...
    invoke-direct {v0, p0, v1, v2}, Lcom/android/server/location/GnssLocationProvider$9;-><init>(Lcom/android/server/location/GnssLocationProvider;Landroid/content/Context;Landroid/os/Handler;)V
...
.method static synthetic access$002(Lcom/android/server/location/GnssLocationProvider;Landroid/os/Messenger;)Landroid/os/Messenger;
    .locals 0

    iput-object p1, p0, Lcom/android/server/location/GnssLocationProvider;->mGnssLocationBugreportService:Landroid/os/Messenger;
...
.method static synthetic access$1300(Lcom/android/server/location/GnssLocationProvider;)V
    .locals 0
...
.method static synthetic access$1400(Lcom/android/server/location/GnssLocationProvider;Landroid/content/Context;)V
    .locals 0
...
.method static synthetic access$2200(Lcom/android/server/location/GnssLocationProvider;)Ljava/util/Properties;
    .locals 1
...
.method static synthetic access$300(Lcom/android/server/location/GnssLocationProvider;)Lcom/android/server/location/GnssStatusListenerHelper;
    .locals 1
...
.method static synthetic access$400(Lcom/android/server/location/GnssLocationProvider;)Lcom/android/server/location/NtpTimeHelper;
    .locals 1
...
.method static synthetic access$500(Lcom/android/server/location/GnssLocationProvider;)I
    .locals 1
...
.method static synthetic access$502(Lcom/android/server/location/GnssLocationProvider;I)I
    .locals 0
...
.method static synthetic access$5100(Lcom/android/server/location/GnssLocationProvider;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/server/location/GnssLocationProvider;->sendBugreport()V

    return-void
.end method

.method static synthetic access$5200(Lcom/android/server/location/GnssLocationProvider;)Landroid/os/PowerManager$WakeLock;
    .locals 1
...
.method static synthetic access$5300(Lcom/android/server/location/GnssLocationProvider;I)Ljava/lang/String;
    .locals 1
...
.method static synthetic access$5500(Lcom/android/server/location/GnssLocationProvider;)Z
    .locals 1
...
.method static synthetic access$5600(Lcom/android/server/location/GnssLocationProvider;)V
    .locals 0
...
.method static synthetic access$5700(Lcom/android/server/location/GnssLocationProvider;Landroid/content/Context;Ljava/util/Properties;)V
    .locals 0
...
.method static synthetic access$5800(Lcom/android/server/location/GnssLocationProvider;)Landroid/telephony/SubscriptionManager$OnSubscriptionsChangedListener;
    .locals 1
...
.method static synthetic access$6000(Lcom/android/server/location/GnssLocationProvider;)Landroid/content/BroadcastReceiver;
    .locals 1
...
.method static synthetic access$6100(Lcom/android/server/location/GnssLocationProvider;)Landroid/net/ConnectivityManager$NetworkCallback;
    .locals 1
...
.method static synthetic access$6200(Lcom/android/server/location/GnssLocationProvider;)Landroid/net/ConnectivityManager;
    .locals 1
...
.method static synthetic access$6400(Lcom/android/server/location/GnssLocationProvider;Landroid/location/Location;)V
    .locals 0
...
.method static synthetic access$700(Lcom/android/server/location/GnssLocationProvider;)V
    .locals 0
...
.method static synthetic access$800(Lcom/android/server/location/GnssLocationProvider;IILjava/lang/Object;)V
    .locals 0
...
.method static synthetic access$900(Lcom/android/server/location/GnssLocationProvider;I)V
    .locals 0
...
.method private bindGnssLocationBugreportInit()V
    .locals 5
    ...
    sget-object v2, Lcom/android/server/location/GnssLocationProvider;->GNSSLOCATION_BUGREPORT_PACKAGE:Ljava/lang/String;

    sget-object v3, Lcom/android/server/location/GnssLocationProvider;->GNSSLOCATION_BUGREPORT_CLASS:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/server/location/GnssLocationProvider;->mGnssLocationBugreportConnection:Landroid/content/ServiceConnection;
    ...
    const-string v2, "bindGnssLocationBugreportInit"
    ...
    sget-object v4, Lcom/android/server/location/GnssLocationProvider;->GNSSLOCATION_BUGREPORT_CLASS:Ljava/lang/String;
...
.method private handleReportLocation(ZLandroid/location/Location;)V
    ...
    invoke-direct {p0}, Lcom/android/server/location/GnssLocationProvider;->updateGnssDetectionStatus()V
...
.method private handleReportSvStatus(Lcom/android/server/location/GnssLocationProvider$SvStatusInfo;)V
    ...
    :goto_0
    iget v6, p1, Lcom/android/server/location/GnssLocationProvider$SvStatusInfo;->mSvCount:I
    ...
    iget-object v6, p1, Lcom/android/server/location/GnssLocationProvider$SvStatusInfo;->mCn0s:[F
    ...
    const-string v10, "Cn0 value:"

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v10, p1, Lcom/android/server/location/GnssLocationProvider$SvStatusInfo;->mCn0s:[F

    aget v10, v10, v0

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(F)Ljava/lang/StringBuilder;

    const-string v10, "...CN0 gnssPassed:"
    ...
    :cond_3
    sget-boolean v6, Lcom/android/server/location/GnssLocationProvider;->VERBOSE:Z
    ...
    const-string/jumbo v10, "svid: "

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v10, p1, Lcom/android/server/location/GnssLocationProvider$SvStatusInfo;->mSvidWithFlags:[I
    ...
    iget-object v10, p1, Lcom/android/server/location/GnssLocationProvider$SvStatusInfo;->mSvElevations:[F
    ...
    iget-object v10, p1, Lcom/android/server/location/GnssLocationProvider$SvStatusInfo;->mSvAzimuths:[F

    aget v10, v10, v0

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(F)Ljava/lang/StringBuilder;

    const-string v10, " carrier frequency: "

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v10, p1, Lcom/android/server/location/GnssLocationProvider$SvStatusInfo;->mSvCarrierFreqs:[F
    ...
    sget v0, Lcom/android/server/location/GnssLocationProvider;->mGnssLocationExceptionTimeout:I
    ...
    invoke-virtual {v0, v1, v3, v2}, Lcom/android/server/location/GnssLocationProvider$LocationExtras;->set(III)V
    ...
    iget-wide v9, p0, Lcom/android/server/location/GnssLocationProvider;->mLastFixTime:J
    ...
    invoke-direct {p0, v8}, Lcom/android/server/location/GnssLocationProvider;->updateStatus(I)V
...
.method private recordOPDiagnoseEvent(ILjava/lang/String;Z)V
    ...
    iget-object v0, p0, Lcom/android/server/location/GnssLocationProvider;->mOPDiagnoseManager:Landroid/os/OPDiagnoseManager;
...
.method private reloadGpsProperties(Landroid/content/Context;Ljava/util/Properties;)V
    ...
    const-string/jumbo v1, "persist.sys.gps.lppe.cp"
    ...
    const-string v5, "emergencyExtensionSeconds is null!"
...
.method private reportMeasurementData(Landroid/location/GnssMeasurementsEvent;)V
    ...
    invoke-direct {v1, p0, p1}, Lcom/android/server/location/GnssLocationProvider$12;-><init>(Lcom/android/server/location/GnssLocationProvider;Landroid/location/GnssMeasurementsEvent;)V
...
.method private reportNavigationMessage(Landroid/location/GnssNavigationMessage;)V
    ...
    invoke-direct {v1, p0, p1}, Lcom/android/server/location/GnssLocationProvider$13;-><init>(Lcom/android/server/location/GnssLocationProvider;Landroid/location/GnssNavigationMessage;)V
...
.method private final sendBugreport()V
    .locals 10
    ...
    const-string v2, "Store the remote info to dropbox"
    ...
    const-string/jumbo v3, "ro.build.ota.versionname"
    ...
    sget-wide v3, Lcom/android/server/location/GnssLocationProvider;->mGnssLocationExceptionNum:J
    ...
    sput v3, Lcom/android/server/location/GnssLocationProvider;->mGnssLocationExceptionTimeout:I

    const-wide/16 v3, 0x0

    sput-wide v3, Lcom/android/server/location/GnssLocationProvider;->mGnssLocationExceptionNum:J
    ...
    const-string v5, "GNSSLOCATION_Track"
    ...
    const-string/jumbo v6, "sendBugreport:"
    ...
    :cond_0
    const-string v4, "GNSS_MDM_Bugreport"
    ...
    const-string v5, "data_issue_name"

    const-string v6, "GNSS_MDM_LOCATION_FAILED"

    invoke-virtual {v4, v5, v6}, Landroid/os/Bundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    const-string v5, "data_special_name"

    const-string v6, "GNSS_MDM_Bugreport"
    ...
    :try_start_0
    iget-object v6, p0, Lcom/android/server/location/GnssLocationProvider;->mGnssLocationBugreportService:Landroid/os/Messenger;

    if-nez v6, :cond_1

    const-string v6, "GnssLocationProvider"

    const-string/jumbo v7, "mGnssLocationBugreportService is null"

    invoke-static {v6, v7}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    invoke-direct {p0}, Lcom/android/server/location/GnssLocationProvider;->bindGnssLocationBugreportInit()V
    ...
    const-string/jumbo v7, "send bugreport failed"
    ...
    const-string/jumbo v9, "sendBugreport failed, e: "
...
.method private setEngineCapabilities(I)V
    ...
    invoke-direct {v1, p0, p1}, Lcom/android/server/location/GnssLocationProvider$14;-><init>(Lcom/android/server/location/GnssLocationProvider;I)V
...
.method private startNavigating(Z)V
    ...
    iget-object v0, p0, Lcom/android/server/location/GnssLocationProvider;->mGnssLocationBugreportService:Landroid/os/Messenger;

    if-nez v0, :cond_0

    const-string v0, "GnssLocationProvider"

    const-string/jumbo v1, "mGnssLocationBugreportService is null"
...
.method private updateGnssDetectionStatus()V
    .locals 6
    ...
    sput-wide v2, Lcom/android/server/location/GnssLocationProvider;->mGnssLocationExceptionNum:J
    ...
    const-string/jumbo v3, "updateGnssDetectionStatus...ExceptionNum = "
    ...
    :cond_0
    sput v1, Lcom/android/server/location/GnssLocationProvider;->mGnssLocationExceptionTimeout:I

    :goto_0
    sget-wide v2, Lcom/android/server/location/GnssLocationProvider;->mGnssLocationExceptionNum:J
    ...
    iget-object v2, p0, Lcom/android/server/location/GnssLocationProvider;->mGnssLocationBugreportService:Landroid/os/Messenger;

    if-nez v2, :cond_2

    const-string v2, "GnssLocationProvider"

    const-string v3, "GnssLocationDeviceBroadcast - mGnssLocationBugreportService is null"
    ...
    const-string/jumbo v3, "recordOPDiagnoseEvent....ISSUE_GPS_LOCATION_FAILED"

    invoke-static {v2, v3}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    sget v2, Landroid/os/OPDiagnoseManager;->ISSUE_GPS_LOCATION_FAILED:I

    const-string v3, "Strong signal location failed"

    invoke-direct {p0, v2, v3, v1}, Lcom/android/server/location/GnssLocationProvider;->recordOPDiagnoseEvent(ILjava/lang/String;Z)V

    const-string v1, "GnssLocationProvider"

    const-string/jumbo v2, "send event: GNSSLOCATION_TRACK_SEND_BUGREPORT"
