...
.field private static STATE_BOOT_COMPLETED:Z = false
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/OemExService;->disableDuplicate:Z

    sput-boolean v0, Lcom/android/server/OemExService;->STATE_BOOT_COMPLETED:Z

    const-string/jumbo v1, "persist.debug.oemex.all"

    invoke-static {v1, v0}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v1

    sput-boolean v1, Lcom/android/server/OemExService;->DEBUG_LOGV:Z

    sput v0, Lcom/android/server/OemExService;->mPackageVerifierEnable:I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Lcom/android/server/OemExService;->mCarChargerNotificationShown:Z

    const/4 v1, 0x1

    iput v1, p0, Lcom/android/server/OemExService;->mBatteryStatus:I

    const/4 v2, 0x0

    iput-object v2, p0, Lcom/android/server/OemExService;->nb:Landroid/app/Notification$Builder;

    iput-object v2, p0, Lcom/android/server/OemExService;->outStream:Ljava/io/FileOutputStream;

    new-instance v3, Ljava/lang/Object;

    invoke-direct {v3}, Ljava/lang/Object;-><init>()V

    iput-object v3, p0, Lcom/android/server/OemExService;->mLock:Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, v3, v2, v1}, Lcom/android/server/OemExService$2;-><init>(Lcom/android/server/OemExService;Landroid/os/Looper;Landroid/os/Handler$Callback;Z)V
    ...
    invoke-direct {v0, p0, v3, v2, v1}, Lcom/android/server/OemExService$3;-><init>(Lcom/android/server/OemExService;Landroid/os/Looper;Landroid/os/Handler$Callback;Z)V

    iput-object v0, p0, Lcom/android/server/OemExService;->mHandler:Landroid/os/Handler;

    new-instance v0, Lcom/android/server/OemExService$6;

    invoke-direct {v0, p0}, Lcom/android/server/OemExService$6;-><init>(Lcom/android/server/OemExService;)V

    iput-object v0, p0, Lcom/android/server/OemExService;->mCarModeReceiver:Landroid/content/BroadcastReceiver;
    ...
    sput-object v2, Lcom/android/server/OemExService;->mActivityManager:Lcom/android/server/am/ActivityManagerService;
    ...
    iput-object v1, p0, Lcom/android/server/OemExService;->mNotificationManager:Landroid/app/NotificationManager;
    ...
    iget-object v3, p0, Lcom/android/server/OemExService;->mCarModeReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v2, p0, Lcom/android/server/OemExService;->mHandlerCarMode:Landroid/os/Handler;
...
.method static synthetic access$1000(Lcom/android/server/OemExService;Landroid/content/Context;Landroid/app/Notification$Builder;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/server/OemExService;->overrideNotificationAppName(Landroid/content/Context;Landroid/app/Notification$Builder;)V
...
.method static synthetic access$1100(Lcom/android/server/OemExService;)Landroid/app/NotificationManager;
    .locals 1

    iget-object v0, p0, Lcom/android/server/OemExService;->mNotificationManager:Landroid/app/NotificationManager;

    return-object v0
.end method

.method static synthetic access$1200(Lcom/android/server/OemExService;)Landroid/app/Notification$Builder;
    .locals 1

    iget-object v0, p0, Lcom/android/server/OemExService;->nb:Landroid/app/Notification$Builder;

    return-object v0
.end method

.method static synthetic access$1202(Lcom/android/server/OemExService;Landroid/app/Notification$Builder;)Landroid/app/Notification$Builder;
    .locals 0

    iput-object p1, p0, Lcom/android/server/OemExService;->nb:Landroid/app/Notification$Builder;

    return-object p1
.end method

.method static synthetic access$1300(Lcom/android/server/OemExService;ILandroid/content/Context;IILandroid/app/Notification$Builder;)V
    .locals 0

    invoke-direct/range {p0 .. p5}, Lcom/android/server/OemExService;->showCarModeNotification(ILandroid/content/Context;IILandroid/app/Notification$Builder;)V

    return-void
.end method

.method static synthetic access$1400(Lcom/android/server/OemExService;)I
    .locals 1

    iget v0, p0, Lcom/android/server/OemExService;->mBatteryStatus:I

    return v0
.end method

.method static synthetic access$1402(Lcom/android/server/OemExService;I)I
    .locals 0

    iput p1, p0, Lcom/android/server/OemExService;->mBatteryStatus:I

    return p1
.end method

.method static synthetic access$1500(Lcom/android/server/OemExService;)Landroid/os/Handler;
    .locals 1

    iget-object v0, p0, Lcom/android/server/OemExService;->mHandlerCarMode:Landroid/os/Handler;
...
.method static synthetic access$1600()Z
    ...
    sget-boolean v0, Lcom/android/server/OemExService;->STATE_BOOT_COMPLETED:Z
...
.method static synthetic access$1602(Z)Z
    ...
    sput-boolean p0, Lcom/android/server/OemExService;->STATE_BOOT_COMPLETED:Z
...
.method static synthetic access$1700()Z
    ...
    sget-boolean v0, Lcom/android/server/OemExService;->disableDuplicate:Z
...
.method static synthetic access$1702(Z)Z
    ...
    sput-boolean p0, Lcom/android/server/OemExService;->disableDuplicate:Z

    return p0
.end method

.method static synthetic access$1800(Lcom/android/server/OemExService;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/server/OemExService;->createNotificationChannel()V

    return-void
.end method

.method static synthetic access$1900(Lcom/android/server/OemExService;Landroid/content/Context;)Landroid/app/Notification$Builder;
    .locals 1

    invoke-direct {p0, p1}, Lcom/android/server/OemExService;->createNotificationBuilder(Landroid/content/Context;)Landroid/app/Notification$Builder;
...
.method static synthetic access$2000(Lcom/android/server/OemExService;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/server/OemExService;->createNotificationChannelForPopup()V

    return-void
.end method

.method static synthetic access$2100(Lcom/android/server/OemExService;Landroid/content/Context;)Landroid/app/Notification$Builder;
    .locals 1

    invoke-direct {p0, p1}, Lcom/android/server/OemExService;->createNotificationBuilderForPopup(Landroid/content/Context;)Landroid/app/Notification$Builder;
...
.method static synthetic access$2200(Lcom/android/server/OemExService;Z)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/OemExService;->saveDNDStateToFile(Z)V

    return-void
.end method

.method static synthetic access$2300(Lcom/android/server/OemExService;)Z
    .locals 1

    iget-boolean v0, p0, Lcom/android/server/OemExService;->mCarChargerNotificationShown:Z

    return v0
.end method

.method static synthetic access$2302(Lcom/android/server/OemExService;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/android/server/OemExService;->mCarChargerNotificationShown:Z

    return p1
.end method

.method static synthetic access$2400(Lcom/android/server/OemExService;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/server/OemExService;->setDontDisturbForCarMode()V

    return-void
.end method

.method static synthetic access$2500(Lcom/android/server/OemExService;Ljava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/OemExService;->startSelectApp(Ljava/lang/String;)V

    return-void
.end method

.method static synthetic access$2600(Lcom/android/server/OemExService;)Ljava/lang/Runnable;
    .locals 1

    iget-object v0, p0, Lcom/android/server/OemExService;->mCarModeRunnable:Ljava/lang/Runnable;

    return-object v0
.end method

.method static synthetic access$2700(Lcom/android/server/OemExService;)I
    .locals 1

    invoke-direct {p0}, Lcom/android/server/OemExService;->getDNDStateFromFile()I
...
.method static synthetic access$2800(Lcom/android/server/OemExService;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/server/OemExService;->disableDontDisturbForCarMode()V
...
.method static synthetic access$900(Lcom/android/server/OemExService;)[I
    .locals 1

    invoke-direct {p0}, Lcom/android/server/OemExService;->getRes()[I
...
.method private createNotificationBuilder(Landroid/content/Context;)Landroid/app/Notification$Builder;
    ...
    invoke-direct {p0}, Lcom/android/server/OemExService;->pendingActivity()Landroid/app/PendingIntent;
...
.method private createNotificationChannel()V
    ...
    const-string v2, "car_charger_notification"
    ...
    iget-object v1, p0, Lcom/android/server/OemExService;->mNotificationManager:Landroid/app/NotificationManager;
...
.method private getDNDStateFromFile()I
    ...
    const-string/jumbo v5, "warp_charge"
    ...
    const-string/jumbo v8, "warp charge, get DND state = "
...
.method private listAPKs(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v5}, Lcom/android/server/OemExService;->listAPKs(Ljava/lang/String;)V
...
.method private onSystemReady(Z)V
    ...
    invoke-virtual {v1}, Lcom/oneplus/threekey/ThreeKeyHw;->init()Z
    ...
    invoke-static {v1}, Lcom/android/server/OemSceneModeController;->getInstance(Landroid/content/Context;)Lcom/android/server/OemSceneModeController;
    ...
    const-string/jumbo v1, "ro.build.eu"
    ...
    const-string v1, "OnePlus7ProTMO"
    ...
    :cond_5
    const-string v1, "/op2/apps/retailmode"
...
.method private pendingActivity()Landroid/app/PendingIntent;
    ...
    const-string/jumbo v1, "oneplus.intent.action.OP_CAR_CHARGER_SETTINGS"
...
.method private saveDNDStateToFile(Z)V
    ...
    iput-object v0, p0, Lcom/android/server/OemExService;->outStream:Ljava/io/FileOutputStream;

    if-eqz p1, :cond_0

    iget-object v0, p0, Lcom/android/server/OemExService;->outStream:Ljava/io/FileOutputStream;
    ...
    :goto_2
    iget-object v1, p0, Lcom/android/server/OemExService;->outStream:Ljava/io/FileOutputStream;
...
.method private showCarModeNotification(ILandroid/content/Context;IILandroid/app/Notification$Builder;)V
    ...
    new-instance v7, Lcom/android/server/OemExService$5;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/server/OemExService$5;-><init>(Lcom/android/server/OemExService;Landroid/app/Notification$Builder;Landroid/content/Context;III)V

    iput-object v7, p0, Lcom/android/server/OemExService;->mCarModeRunnable:Ljava/lang/Runnable;

    if-nez p1, :cond_0

    iget-object v0, p0, Lcom/android/server/OemExService;->mHandlerCarMode:Landroid/os/Handler;

    iget-object v1, p0, Lcom/android/server/OemExService;->mCarModeRunnable:Ljava/lang/Runnable;
