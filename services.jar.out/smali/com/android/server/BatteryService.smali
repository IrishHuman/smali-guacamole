...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lcom/android/server/BatteryService;->mDiagnoseManager:Landroid/os/OPDiagnoseManager;
...
.method private getFastChargeType()I
    ...
    :goto_1
    const-string/jumbo v7, "getFastChargeType io close exception :"
    ...
    const-string/jumbo v7, "getFastChargeType io exception:"
    ...
    const-string/jumbo v7, "getFastChargeType NumberFormatException:"
    ...
    const-string/jumbo v8, "getFastChargeType io close exception :"
...
.method private processValuesLocked(Z)V
    ...
    :goto_2
    iget-object v0, v1, Lcom/android/server/BatteryService;->mDiagnoseManager:Landroid/os/OPDiagnoseManager;
    ...
    sget v9, Landroid/os/OPDiagnoseManager;->ISSUE_CHARGER_INSERT:I

    const-string v10, "charger plugin"

    invoke-virtual {v0, v9, v10}, Landroid/os/OPDiagnoseManager;->writeDiagData(ILjava/lang/String;)Z

    sget-object v0, Lcom/android/server/BatteryService;->TAG:Ljava/lang/String;

    const-string v9, "  charger plugin "
    ...
    sget v9, Landroid/os/OPDiagnoseManager;->ISSUE_CHARGER_REMOVE:I

    const-string v10, "charger remove"

    invoke-virtual {v0, v9, v10}, Landroid/os/OPDiagnoseManager;->writeDiagData(ILjava/lang/String;)Z

    sget-object v0, Lcom/android/server/BatteryService;->TAG:Ljava/lang/String;

    const-string v9, "  charger remove "
    ...
    invoke-virtual {v0, v12, v10}, Landroid/metrics/LogMaker;->addTaggedData(ILjava/lang/Object;)Landroid/metrics/LogMaker;
    ...
    invoke-virtual {v0, v6, v10}, Landroid/metrics/LogMaker;->addTaggedData(ILjava/lang/Object;)Landroid/metrics/LogMaker;
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/server/BatteryService;->updateChgProtectStatus()V

    invoke-direct/range {p0 .. p0}, Lcom/android/server/BatteryService;->updatefasttStatusIsOK()V
    ...
    iget-object v6, v1, Lcom/android/server/BatteryService;->mDiagnoseManager:Landroid/os/OPDiagnoseManager;

    if-eqz v6, :cond_e

    iget-object v6, v1, Lcom/android/server/BatteryService;->mDiagnoseManager:Landroid/os/OPDiagnoseManager;

    sget v10, Landroid/os/OPDiagnoseManager;->ISSUE_CHARGE_STOP:I

    const-string/jumbo v11, "the charger plugin but battery discharging"

    invoke-virtual {v6, v10, v11}, Landroid/os/OPDiagnoseManager;->writeDiagData(ILjava/lang/String;)Z
    ...
    const-string/jumbo v11, "the charger plugin but\tbattery not charging"
    ...
    iget v6, v6, Landroid/hardware/health/V1_0/HealthInfo;->batteryCurrent:I
    ...
    sget v10, Landroid/os/OPDiagnoseManager;->ISSUE_CHARGE_CURRENT_LOW:I

    const-string/jumbo v11, "the charging abnormal or over load cause the charging current  "
    ...
    new-instance v10, Lcom/android/server/BatteryService$11;

    invoke-direct {v10, v1}, Lcom/android/server/BatteryService$11;-><init>(Lcom/android/server/BatteryService;)V
    ...
    const-string v0, "batterychargecounter:%d\n"
    ...
    sget v5, Landroid/os/OPDiagnoseManager;->ISSUE_BATTER_ERROR:I

    const-string v6, "battery over voltage or battery missing"

    invoke-virtual {v0, v5, v6}, Landroid/os/OPDiagnoseManager;->writeDiagData(ILjava/lang/String;)Z
...
.method private updateChgProtectStatus()V
    .locals 8

    new-instance v0, Ljava/io/File;

    const-string v1, "/sys/class/power_supply/battery/chg_protect_status"
    ...
    const-string v5, "chg status normal!"
    ...
    :cond_0
    iget-object v4, p0, Lcom/android/server/BatteryService;->mDiagnoseManager:Landroid/os/OPDiagnoseManager;
    ...
    const-string v6, "ISSUE_BATTER_ERROR"

    invoke-virtual {v4, v5, v6}, Landroid/os/OPDiagnoseManager;->writeDiagData(ILjava/lang/String;)Z
    :try_end_0
    ...
    const-string/jumbo v7, "updateChgProtectStatus io close exception :"
    ...
    const-string v5, "Failure in reading charger type"
    ...
    const-string/jumbo v6, "updateChgProtectStatus io close exception :"
...
.method private updatefasttStatusIsOK()V
    .locals 8

    new-instance v0, Ljava/io/File;

    const-string v1, "/sys/class/power_supply/battery/fastchg_status_is_ok"
    ...
    const-string v5, "chgfast status normal!"
    ...
    sget v5, Landroid/os/OPDiagnoseManager;->ISSUE_DASH_CHARGE_ERROR:I

    const-string v6, "dash error fast charge"
    ...
    const-string/jumbo v7, "updatefasttStatusIsOK io close exception :"
    ...
    const-string/jumbo v6, "updatefasttStatusIsOK io close exception :"
