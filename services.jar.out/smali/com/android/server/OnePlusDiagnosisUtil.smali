...
.field private mDiagManager:Landroid/os/OPDiagnoseManager;
...
.method public constructor <init>(Ljava/lang/String;ILandroid/content/Context;)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/OnePlusDiagnosisUtil;-><init>(Ljava/lang/String;I)V

    iput-object p3, p0, Lcom/android/server/OnePlusDiagnosisUtil;->mContext:Landroid/content/Context;

    iget-object v0, p0, Lcom/android/server/OnePlusDiagnosisUtil;->mContext:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/android/server/OnePlusDiagnosisUtil;->mDiagManager:Landroid/os/OPDiagnoseManager;
...
.method public log(IJIFLjava/lang/String;)V
    ...
    iget-object v5, v0, Lcom/android/server/OnePlusDiagnosisUtil;->mDiagManager:Landroid/os/OPDiagnoseManager;

    if-eqz v5, :cond_1

    sget-boolean v5, Lcom/android/server/OnePlusDiagnosisUtil;->DEBUG_ONEPLUS:Z

    if-eqz v5, :cond_0

    const-string v5, "OnePlusDiagnosisUtil"

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v7, "writeDiagData: type="
    ...
    :cond_1
    iget v5, v0, Lcom/android/server/OnePlusDiagnosisUtil;->mMaxLines:I
    ...
    const-string v12, "%d,%d,%d,%.3f,%d,%.2f,%s,%s,%s"
    ...
    invoke-direct {v0, v2}, Lcom/android/server/OnePlusDiagnosisUtil;->append(Ljava/lang/String;)V
