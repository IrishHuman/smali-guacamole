...
.method public run()V
    ...
    iget-object v5, v1, Lcom/android/server/pm/PackageManagerService$12;->val$internalPackageName:Ljava/lang/String;
    ...
    iget v6, v1, Lcom/android/server/pm/PackageManagerService$12;->val$callingUid:I
    ...
    iget-boolean v7, v1, Lcom/android/server/pm/PackageManagerService$12;->val$canViewInstantApps:Z
    ...
    iget-boolean v8, v1, Lcom/android/server/pm/PackageManagerService$12;->val$deleteAllUsers:Z

    if-nez v8, :cond_3

    iget-object v9, v1, Lcom/android/server/pm/PackageManagerService$12;->this$0:Lcom/android/server/pm/PackageManagerService;

    iget-object v10, v1, Lcom/android/server/pm/PackageManagerService$12;->val$internalPackageName:Ljava/lang/String;

    iget-wide v11, v1, Lcom/android/server/pm/PackageManagerService$12;->val$versionCode:J

    iget v13, v1, Lcom/android/server/pm/PackageManagerService$12;->val$userId:I

    iget v14, v1, Lcom/android/server/pm/PackageManagerService$12;->val$deleteFlags:I
    ...
    iget v9, v1, Lcom/android/server/pm/PackageManagerService$12;->val$userId:I
    ...
    iget-object v10, v1, Lcom/android/server/pm/PackageManagerService$12;->this$0:Lcom/android/server/pm/PackageManagerService;

    iget-object v11, v1, Lcom/android/server/pm/PackageManagerService$12;->val$internalPackageName:Ljava/lang/String;

    iget-wide v12, v1, Lcom/android/server/pm/PackageManagerService$12;->val$versionCode:J

    const/16 v14, 0x3e7

    iget v15, v1, Lcom/android/server/pm/PackageManagerService$12;->val$deleteFlags:I
    ...
    :cond_3
    iget-object v8, v1, Lcom/android/server/pm/PackageManagerService$12;->this$0:Lcom/android/server/pm/PackageManagerService;

    iget-object v9, v1, Lcom/android/server/pm/PackageManagerService$12;->val$internalPackageName:Ljava/lang/String;

    iget-object v10, v1, Lcom/android/server/pm/PackageManagerService$12;->val$users:[I

    invoke-static {v8, v9, v10}, Lcom/android/server/pm/PackageManagerService;->access$5500(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;[I)[I
    ...
    iget v14, v1, Lcom/android/server/pm/PackageManagerService$12;->val$userId:I
    ...
    :cond_4
    iget v9, v1, Lcom/android/server/pm/PackageManagerService$12;->val$deleteFlags:I

    and-int/lit8 v9, v9, -0x3

    iget-object v15, v1, Lcom/android/server/pm/PackageManagerService$12;->val$users:[I
    ...
    iget-wide v7, v1, Lcom/android/server/pm/PackageManagerService$12;->val$versionCode:J
    ...
    invoke-static {v0}, Lcom/android/server/pm/PackageManagerService;->access$5600(Lcom/android/server/pm/PackageManagerService;)Lnet/oneplus/odm/insight/FrameworkEventCollector;
    ...
    invoke-static {v0, v6}, Lcom/android/server/pm/PackageManagerService;->access$5602(Lcom/android/server/pm/PackageManagerService;Lnet/oneplus/odm/insight/FrameworkEventCollector;)Lnet/oneplus/odm/insight/FrameworkEventCollector;
    ...
    iget-object v8, v1, Lcom/android/server/pm/PackageManagerService$12;->val$packageName:Ljava/lang/String;
    ...
    iget-object v6, v1, Lcom/android/server/pm/PackageManagerService$12;->val$packageName:Ljava/lang/String;
