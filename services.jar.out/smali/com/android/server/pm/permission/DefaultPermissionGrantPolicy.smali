...
.method private grantDefaultSystemHandlerPermissions(I)V
    ...
    sget-object v5, Lcom/android/server/pm/permission/DefaultPermissionGrantPolicy;->CARRIER_1_ADAPT_PERMISSIONS:Ljava/util/Set;
    ...
    sget-object v6, Lcom/android/server/pm/permission/DefaultPermissionGrantPolicy;->CARRIER_1_MYACCOUNT_PERMISSIONS:Ljava/util/Set;
    ...
    sget-object v6, Lcom/android/server/pm/permission/DefaultPermissionGrantPolicy;->CARRIER_1_RSU_PERMISSIONS:Ljava/util/Set;
    ...
    sget-object v6, Lcom/android/server/pm/permission/DefaultPermissionGrantPolicy;->LOCATION_PERMISSIONS:Ljava/util/Set;

    move-object/from16 v82, v0

    const/4 v0, 0x0

    invoke-direct {v1, v5, v6, v0, v2}, Lcom/android/server/pm/permission/DefaultPermissionGrantPolicy;->grantRuntimePermissions(Landroid/content/pm/PackageParser$Package;Ljava/util/Set;ZI)V
    ...
    invoke-virtual {v6, v3, v0}, Landroid/content/pm/PackageManager;->hasSystemFeature(Ljava/lang/String;I)Z
    ...
    invoke-direct {v1, v3, v6, v0, v2}, Lcom/android/server/pm/permission/DefaultPermissionGrantPolicy;->grantRuntimePermissions(Landroid/content/pm/PackageParser$Package;Ljava/util/Set;ZI)V
    ...
    invoke-direct {v1, v3, v0, v6, v2}, Lcom/android/server/pm/permission/DefaultPermissionGrantPolicy;->grantRuntimePermissions(Landroid/content/pm/PackageParser$Package;Ljava/util/Set;ZI)V
    ...
    invoke-direct {v1, v6, v0, v3, v2}, Lcom/android/server/pm/permission/DefaultPermissionGrantPolicy;->grantRuntimePermissions(Landroid/content/pm/PackageParser$Package;Ljava/util/Set;ZI)V
    ...
    invoke-direct {v1, v0, v3, v6, v2}, Lcom/android/server/pm/permission/DefaultPermissionGrantPolicy;->grantRuntimePermissions(Landroid/content/pm/PackageParser$Package;Ljava/util/Set;ZI)V

    :cond_40
    new-instance v3, Landroid/content/Intent;

    const-string v6, "android.telephony.action.EMERGENCY_ASSISTANCE"
