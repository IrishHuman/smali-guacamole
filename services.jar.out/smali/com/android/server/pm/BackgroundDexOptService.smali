...
.method private idleOptimization(Lcom/android/server/pm/PackageManagerService;Landroid/util/ArraySet;Landroid/content/Context;Z)I
    ...
    invoke-direct {v8, v10}, Lcom/android/server/pm/BackgroundDexOptService;->getLowStorageThreshold(Landroid/content/Context;)J
...
.method public static runOpdomOptimizationNow(Lcom/android/server/pm/PackageManagerService;Landroid/content/Context;Ljava/util/List;)Z
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_0
    new-instance v1, Lcom/android/server/pm/BackgroundDexOptService;

    invoke-direct {v1}, Lcom/android/server/pm/BackgroundDexOptService;-><init>()V
    ...
    invoke-direct {v1, p0, v2, p1, v3}, Lcom/android/server/pm/BackgroundDexOptService;->idleOptimization(Lcom/android/server/pm/PackageManagerService;Landroid/util/ArraySet;Landroid/content/Context;Z)I
