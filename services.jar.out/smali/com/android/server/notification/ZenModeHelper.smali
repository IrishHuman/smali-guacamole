...
.field private final ZEN_MODE_TYPE_SYSTEM:I
...
.field private final mCarConfigs:Landroid/util/SparseArray;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private mCurrentZenType:I
...
.field private mZenModeCar:I

.field private mZenModeSystem:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;Lcom/android/server/notification/ConditionProviders;)V
    ...
    iput v0, p0, Lcom/android/server/notification/ZenModeHelper;->ZEN_MODE_TYPE_SYSTEM:I

    const/4 v2, 0x1

    iput v2, p0, Lcom/android/server/notification/ZenModeHelper;->ZEN_MODE_TYPE_CAR:I

    new-instance v3, Landroid/util/SparseArray;

    invoke-direct {v3}, Landroid/util/SparseArray;-><init>()V

    iput-object v3, p0, Lcom/android/server/notification/ZenModeHelper;->mCarConfigs:Landroid/util/SparseArray;

    iput v0, p0, Lcom/android/server/notification/ZenModeHelper;->mZenModeCar:I

    iput v0, p0, Lcom/android/server/notification/ZenModeHelper;->mZenModeSystem:I

    iput v0, p0, Lcom/android/server/notification/ZenModeHelper;->mCurrentZenType:I
    ...
    invoke-direct {v3, p0, p2, v1}, Lcom/android/server/notification/ZenModeHelper$H;-><init>(Lcom/android/server/notification/ZenModeHelper;Landroid/os/Looper;Lcom/android/server/notification/ZenModeHelper$1;)V
    ...
    invoke-direct {v1, p0, v3}, Lcom/android/server/notification/ZenModeHelper$SettingsObserver;-><init>(Lcom/android/server/notification/ZenModeHelper;Landroid/os/Handler;)V
    ...
    invoke-direct {v1, v3}, Lcom/android/server/notification/ZenModeFiltering;-><init>(Landroid/content/Context;)V
    ...
    iget-object v1, p0, Lcom/android/server/notification/ZenModeHelper;->mCarConfigs:Landroid/util/SparseArray;
    ...
    invoke-virtual {v0, p0}, Lcom/oneplus/scene/OimcCarModeObserver;->setZenHelper(Lcom/android/server/notification/ZenModeHelper;)V
...
.method static synthetic access$1000(Lcom/android/server/notification/ZenModeHelper;)I
    ...
    iget v0, p0, Lcom/android/server/notification/ZenModeHelper;->mZenModeSystem:I

    return v0
.end method

.method static synthetic access$1100(Lcom/android/server/notification/ZenModeHelper;)Lcom/android/server/notification/ZenModeHelper$H;
    .locals 1
...
.method static synthetic access$1200(Lcom/android/server/notification/ZenModeHelper;)V
    .locals 0
...
.method static synthetic access$1300(Lcom/android/server/notification/ZenModeHelper;)Lcom/android/server/notification/ZenModeHelper$Metrics;
    .locals 1
...
.method static synthetic access$1500(Lcom/android/server/notification/ZenModeHelper;Landroid/service/notification/ZenModeConfig;Ljava/lang/String;Landroid/content/ComponentName;Z)V
    .locals 0
...
.method static synthetic access$700(Lcom/android/server/notification/ZenModeHelper;Ljava/lang/String;)I
    .locals 1

    invoke-direct {p0, p1}, Lcom/android/server/notification/ZenModeHelper;->getZenModeSetting(Ljava/lang/String;)I
...
.method static synthetic access$800(Lcom/android/server/notification/ZenModeHelper;)I
    ...
    iget v0, p0, Lcom/android/server/notification/ZenModeHelper;->mZenModeCar:I

    return v0
.end method

.method static synthetic access$900(Lcom/android/server/notification/ZenModeHelper;IIZ)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/notification/ZenModeHelper;->setZenModeSettingByType(IIZ)V
...
.method private applyConfig(Landroid/service/notification/ZenModeConfig;Ljava/lang/String;Landroid/content/ComponentName;Z)V
    ...
    iget v1, p1, Landroid/service/notification/ZenModeConfig;->type:I

    invoke-direct {p0, p2, p4, v1}, Lcom/android/server/notification/ZenModeHelper;->evaluateZenMode(Ljava/lang/String;ZI)Z
...
.method private cleanUpZenRules()V
    ...
    const-string v0, "cleanUpZenRules"

    invoke-direct {p0, v0}, Lcom/android/server/notification/ZenModeHelper;->resetZenModeOfCar(Ljava/lang/String;)V
...
.method private evaluateZenMode(Ljava/lang/String;ZI)Z
    .locals 4
    ...
    const-string v2, "evaluateZenMode reason: "
    ...
    invoke-direct {p0, v2, p3, v3}, Lcom/android/server/notification/ZenModeHelper;->setZenModeSettingByType(IIZ)V
...
.method private getActiveConfig(I)Landroid/service/notification/ZenModeConfig;
    .locals 5
    ...
    iput p1, p0, Lcom/android/server/notification/ZenModeHelper;->mCurrentZenType:I
    ...
    iput v2, p0, Lcom/android/server/notification/ZenModeHelper;->mCurrentZenType:I

    iget-object v2, p0, Lcom/android/server/notification/ZenModeHelper;->mCarConfigs:Landroid/util/SparseArray;
    ...
    :cond_1
    iget v3, p0, Lcom/android/server/notification/ZenModeHelper;->mCurrentZenType:I

    if-eq v3, p1, :cond_3

    invoke-direct {p0, p1}, Lcom/android/server/notification/ZenModeHelper;->getConfigByType(I)Landroid/service/notification/ZenModeConfig;
    ...
    :goto_0
    invoke-direct {p0, v4, p1, v2}, Lcom/android/server/notification/ZenModeHelper;->setZenModeSettingByType(IIZ)V

    :cond_3
    return-object v0
.end method

.method private getConfigByType(I)Landroid/service/notification/ZenModeConfig;
    .locals 3
...
.method private getConfigs(I)Landroid/util/SparseArray;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I)",
    ...
    iget-object v0, p0, Lcom/android/server/notification/ZenModeHelper;->mCarConfigs:Landroid/util/SparseArray;
...
.method private getZenModeSetting(Ljava/lang/String;)I
    .locals 2
...
.method private isOnePlusVibrateInSilentMode()Z
    .locals 2
...
.method private loadConfigForUser(ILjava/lang/String;)V
    ...
    :cond_1
    iget v0, p0, Lcom/android/server/notification/ZenModeHelper;->mCurrentZenType:I

    invoke-direct {p0, v0}, Lcom/android/server/notification/ZenModeHelper;->getConfigByType(I)Landroid/service/notification/ZenModeConfig;
    ...
    const-string/jumbo v3, "loadConfigForUser mCurrentZenType="
...
.method private resetZenModeOfCar(Ljava/lang/String;)V
    .locals 8
    ...
    invoke-virtual {v1, v0}, Lcom/oneplus/scene/OimcCarModeObserver;->setCarModeOn(Z)V
    ...
    const-string/jumbo v2, "resetZenModeOfCar from "
...
.method private setConfigLocked(Landroid/service/notification/ZenModeConfig;Ljava/lang/String;Landroid/content/ComponentName;Z)Z
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/server/notification/ZenModeHelper;->setConfigLocked(Landroid/service/notification/ZenModeConfig;Ljava/lang/String;Landroid/content/ComponentName;ZI)Z
...
.method private setConfigLocked(Landroid/service/notification/ZenModeConfig;Ljava/lang/String;Landroid/content/ComponentName;ZI)Z
    .locals 8
    ...
    :cond_0
    invoke-direct {p0, p5}, Lcom/android/server/notification/ZenModeHelper;->getConfigs(I)Landroid/util/SparseArray;

    move-result-object v3

    iput p5, p1, Landroid/service/notification/ZenModeConfig;->type:I
    ...
    const-string/jumbo v7, "setConfigLocked: store config for user "
    ...
    iget v7, p0, Lcom/android/server/notification/ZenModeHelper;->mUser:I
    ...
    iget v7, p1, Landroid/service/notification/ZenModeConfig;->type:I
    ...
    const-string/jumbo v7, "setConfigLocked reason="
    ...
    :cond_3
    invoke-direct {p0, p5}, Lcom/android/server/notification/ZenModeHelper;->getActiveConfig(I)Landroid/service/notification/ZenModeConfig;
...
.method private setManualZenMode(ILandroid/net/Uri;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/server/notification/ZenModeHelper;->setManualZenMode(ILandroid/net/Uri;Ljava/lang/String;Ljava/lang/String;ZI)V

    return-void
.end method

.method private setManualZenMode(ILandroid/net/Uri;Ljava/lang/String;Ljava/lang/String;ZI)V
    .locals 19
    ...
    :goto_0
    invoke-direct {v7, v10}, Lcom/android/server/notification/ZenModeHelper;->getConfigs(I)Landroid/util/SparseArray;
    ...
    iput-object v2, v4, Landroid/service/notification/ZenModeConfig;->manualRule:Landroid/service/notification/ZenModeConfig$ZenRule;
    ...
    iput-boolean v1, v3, Landroid/service/notification/ZenModeConfig$ZenRule;->snoozing:Z
    ...
    iput-boolean v1, v2, Landroid/service/notification/ZenModeConfig$ZenRule;->enabled:Z

    iput v8, v2, Landroid/service/notification/ZenModeConfig$ZenRule;->zenMode:I

    iput-object v9, v2, Landroid/service/notification/ZenModeConfig$ZenRule;->conditionId:Landroid/net/Uri;

    move-object/from16 v3, p4

    iput-object v3, v2, Landroid/service/notification/ZenModeConfig$ZenRule;->enabler:Ljava/lang/String;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/android/server/notification/ZenModeHelper;->setConfigLocked(Landroid/service/notification/ZenModeConfig;Ljava/lang/String;Landroid/content/ComponentName;ZI)Z
...
.method private setZenModeSettingByType(IIZ)V
    .locals 3
    ...
    const-string/jumbo v2, "setZenModeSettingByType zen="
    ...
    const-string/jumbo v1, "zen_mode_car"
    ...
    :cond_1
    iput p1, p0, Lcom/android/server/notification/ZenModeHelper;->mZenModeCar:I
    ...
    const-string/jumbo v1, "zen_mode_system"
    ...
    :cond_3
    iput p1, p0, Lcom/android/server/notification/ZenModeHelper;->mZenModeSystem:I
...
.method protected applyRestrictions(ZI)V
    ...
    invoke-direct {p0}, Lcom/android/server/notification/ZenModeHelper;->isOnePlusVibrateInSilentMode()Z
...
.method public dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "mZenModeCar="

    invoke-virtual {p1, v2}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    iget v2, p0, Lcom/android/server/notification/ZenModeHelper;->mZenModeCar:I
    ...
    const-string/jumbo v2, "mZenModeSystem="

    invoke-virtual {p1, v2}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    iget v2, p0, Lcom/android/server/notification/ZenModeHelper;->mZenModeSystem:I
    ...
    const-string/jumbo v2, "mCurrentZenType="

    invoke-virtual {p1, v2}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    iget v2, p0, Lcom/android/server/notification/ZenModeHelper;->mCurrentZenType:I

    invoke-static {v2}, Landroid/provider/Settings$Global;->zenModeTypeToString(I)Ljava/lang/String;
    ...
    const-string/jumbo v3, "mCarConfigs[u="

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v3, p0, Lcom/android/server/notification/ZenModeHelper;->mCarConfigs:Landroid/util/SparseArray;
...
.method protected evaluateZenMode(Ljava/lang/String;Z)Z
    ...
    invoke-direct {p0, p1, p2, v0}, Lcom/android/server/notification/ZenModeHelper;->evaluateZenMode(Ljava/lang/String;ZI)Z
...
.method public getNotificationPolicyByType(I)Landroid/app/NotificationManager$Policy;
    .locals 1
...
.method public getZenModeByType(I)I
    .locals 1
...
.method public setManualZenModeByType(ILandroid/net/Uri;Ljava/lang/String;Ljava/lang/String;I)V
    .locals 7
...
.method public setNotificationPolicyByType(Landroid/app/NotificationManager$Policy;I)V
    .locals 8
    ...
    :try_start_0
    invoke-direct {p0, p2}, Lcom/android/server/notification/ZenModeHelper;->getConfigByType(I)Landroid/service/notification/ZenModeConfig;
    ...
    const-string/jumbo v4, "setNotificationPolicyByType"
    ...
    invoke-direct/range {v2 .. v7}, Lcom/android/server/notification/ZenModeHelper;->setConfigLocked(Landroid/service/notification/ZenModeConfig;Ljava/lang/String;Landroid/content/ComponentName;ZI)Z
