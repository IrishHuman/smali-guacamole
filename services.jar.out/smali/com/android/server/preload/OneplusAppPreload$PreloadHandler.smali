...
.method private isPreloadState()Z
    .locals 2

    invoke-static {}, Lcom/android/server/preload/OneplusAppPreload;->access$1500()Z
    ...
    invoke-static {v0}, Lcom/android/server/preload/OneplusAppPreload;->access$3500(Lcom/android/server/preload/OneplusAppPreload;)Ljava/util/ArrayList;
    ...
    :cond_0
    invoke-static {}, Lcom/android/server/preload/OneplusAppPreload;->access$1600()Z

    move-result v0

    if-nez v0, :cond_2

    invoke-static {}, Lcom/android/server/preload/OneplusAppPreload;->access$4200()Z
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    :pswitch_1
    invoke-direct {p0}, Lcom/android/server/preload/OneplusAppPreload$PreloadHandler;->isPreloadState()Z
    ...
    invoke-static {v5}, Lcom/android/server/preload/OneplusAppPreload;->access$3500(Lcom/android/server/preload/OneplusAppPreload;)Ljava/util/ArrayList;
    ...
    invoke-static {v6}, Lcom/android/server/preload/OneplusAppPreload;->access$3500(Lcom/android/server/preload/OneplusAppPreload;)Ljava/util/ArrayList;
    ...
    invoke-static {v5}, Lcom/android/server/preload/OneplusAppPreload;->access$3900(Lcom/android/server/preload/OneplusAppPreload;)Landroid/util/ArrayMap;
    ...
    invoke-static {v4}, Lcom/android/server/preload/OneplusAppPreload;->access$3500(Lcom/android/server/preload/OneplusAppPreload;)Ljava/util/ArrayList;
    ...
    invoke-static {v3}, Lcom/android/server/preload/OneplusAppPreload$PreloadCandidate;->access$1000(Lcom/android/server/preload/OneplusAppPreload$PreloadCandidate;)Ljava/lang/String;

    move-result-object v7

    invoke-static {v3}, Lcom/android/server/preload/OneplusAppPreload$PreloadCandidate;->access$1200(Lcom/android/server/preload/OneplusAppPreload$PreloadCandidate;)Lcom/android/server/preload/OneplusAppPreload$PreloadSource;
    ...
    :cond_2
    invoke-static {v6, v7, v2}, Lcom/android/server/preload/OneplusAppPreload;->access$3400(Lcom/android/server/preload/OneplusAppPreload;Ljava/lang/String;Z)Z
    ...
    const-string v7, " is not support preload."
    ...
    :goto_0
    invoke-static {}, Lcom/android/server/preload/OneplusAppPreload;->access$4000()Z
    ...
    invoke-static {v2}, Lcom/android/server/preload/OneplusAppPreload;->access$3500(Lcom/android/server/preload/OneplusAppPreload;)Ljava/util/ArrayList;
    ...
    invoke-static {}, Lcom/android/server/preload/OneplusAppPreload;->access$3800()F
    ...
    invoke-static {v1, v0}, Lcom/android/server/preload/OneplusAppPreload;->access$4100(Lcom/android/server/preload/OneplusAppPreload;Ljava/lang/String;)Z
    ...
    invoke-static {v1}, Lcom/android/server/preload/OneplusAppPreload;->access$700(Lcom/android/server/preload/OneplusAppPreload;)Lcom/android/server/am/ActivityManagerService;
...
.method public preloadHighUsedAfterBoot(Ljava/util/ArrayList;)V
    ...
    invoke-static {v6, v3, v0}, Lcom/android/server/preload/OneplusAppPreload;->access$3400(Lcom/android/server/preload/OneplusAppPreload;Ljava/lang/String;Z)Z
    ...
    const-string v8, "Preload package:"

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v7, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v8, " do not support preload"
    ...
    invoke-static {v6, v3, v0}, Lcom/android/server/preload/OneplusAppPreload;->access$3600(Lcom/android/server/preload/OneplusAppPreload;Ljava/lang/String;Z)Z

    move-result v6

    if-nez v6, :cond_3

    new-instance v6, Lcom/android/server/preload/OneplusAppPreload$PreloadCandidate;

    sget-object v7, Lcom/android/server/preload/OneplusAppPreload$PreloadSource;->HIGHUSAGE:Lcom/android/server/preload/OneplusAppPreload$PreloadSource;

    invoke-direct {v6, v3, v7}, Lcom/android/server/preload/OneplusAppPreload$PreloadCandidate;-><init>(Ljava/lang/String;Lcom/android/server/preload/OneplusAppPreload$PreloadSource;)V

    iget-object v7, p0, Lcom/android/server/preload/OneplusAppPreload$PreloadHandler;->this$0:Lcom/android/server/preload/OneplusAppPreload;

    invoke-static {v7}, Lcom/android/server/preload/OneplusAppPreload;->access$3500(Lcom/android/server/preload/OneplusAppPreload;)Ljava/util/ArrayList;
    ...
    invoke-static {}, Lcom/android/server/preload/OneplusAppPreload;->access$3700()I
...
.method public preloadHighUsedAfterDie(Ljava/lang/String;)V
    ...
    invoke-static {v0, p1, v1}, Lcom/android/server/preload/OneplusAppPreload;->access$3400(Lcom/android/server/preload/OneplusAppPreload;Ljava/lang/String;Z)Z
    ...
    invoke-static {v2, p1, v1}, Lcom/android/server/preload/OneplusAppPreload;->access$3600(Lcom/android/server/preload/OneplusAppPreload;Ljava/lang/String;Z)Z
...
.method public startPreload()V
    ...
    invoke-static {v2}, Lcom/android/server/preload/OneplusAppPreload;->access$3300(Lcom/android/server/preload/OneplusAppPreload;)J
    ...
    const-string v7, "Duration is too short, delay 1 minute to preload : "
    ...
    invoke-virtual {p0, v5, v2, v3}, Lcom/android/server/preload/OneplusAppPreload$PreloadHandler;->sendEmptyMessageDelayed(IJ)Z

    goto :goto_0

    :cond_0
    invoke-virtual {p0, v5}, Lcom/android/server/preload/OneplusAppPreload$PreloadHandler;->sendEmptyMessage(I)Z
