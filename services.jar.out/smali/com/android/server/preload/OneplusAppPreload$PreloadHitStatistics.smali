...
.method static synthetic access$500(Lcom/android/server/preload/OneplusAppPreload$PreloadHitStatistics;)Ljava/util/HashMap;
    .locals 1
...
.method public addOldRecord(ZLjava/lang/String;)V
    ...
    invoke-static {v5}, Lcom/android/server/preload/OneplusAppPreload;->access$000(Lcom/android/server/preload/OneplusAppPreload;)Lcom/android/server/preload/OneplusAppPreload$PreloadHitStatistics;
    ...
    iget-object v9, v1, Lcom/android/server/preload/OneplusAppPreload$PreloadHitStatistics;->this$0:Lcom/android/server/preload/OneplusAppPreload;

    invoke-direct {v8, v9, v3}, Lcom/android/server/preload/OneplusAppPreload$PackagePreloadResult;-><init>(Lcom/android/server/preload/OneplusAppPreload;Ljava/lang/String;)V
    ...
    new-instance v14, Lcom/android/server/preload/OneplusAppPreload$SingleRecord;
    ...
    invoke-direct/range {v5 .. v12}, Lcom/android/server/preload/OneplusAppPreload$SingleRecord;-><init>(JJJZ)V
    ...
    new-instance v8, Lcom/android/server/preload/OneplusAppPreload$SingleRecord;
    ...
    invoke-direct/range {v13 .. v20}, Lcom/android/server/preload/OneplusAppPreload$SingleRecord;-><init>(JJJZ)V
...
.method public addOverBfferRecord(Lcom/android/server/preload/OneplusAppPreload$PreloadCandidate;)V
    .locals 3
    ...
    iget-object v1, p0, Lcom/android/server/preload/OneplusAppPreload$PreloadHitStatistics;->this$0:Lcom/android/server/preload/OneplusAppPreload;

    invoke-static {p1}, Lcom/android/server/preload/OneplusAppPreload$PreloadCandidate;->access$1000(Lcom/android/server/preload/OneplusAppPreload$PreloadCandidate;)Ljava/lang/String;

    move-result-object v2

    invoke-direct {v0, v1, v2}, Lcom/android/server/preload/OneplusAppPreload$PackagePreloadResult;-><init>(Lcom/android/server/preload/OneplusAppPreload;Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Lcom/android/server/preload/OneplusAppPreload$PackagePreloadResult;->addOverBufferRecord()V
...
.method public addRecord(Lcom/android/server/preload/OneplusAppPreload$PreloadCandidate;)V
    ...
    sget-object v0, Lcom/android/server/preload/OneplusAppPreload$10;->$SwitchMap$com$android$server$preload$OneplusAppPreload$PreloadSource:[I
    ...
    invoke-static {v0, v1}, Lcom/android/server/preload/OneplusAppPreload;->access$2702(Lcom/android/server/preload/OneplusAppPreload;Lcom/android/server/preload/OneplusAppPreload$PreloadSource;)Lcom/android/server/preload/OneplusAppPreload$PreloadSource;
...
.method public hitPreload(Ljava/lang/String;Z)V
    ...
    iget-object v2, p0, Lcom/android/server/preload/OneplusAppPreload$PreloadHitStatistics;->this$0:Lcom/android/server/preload/OneplusAppPreload;

    invoke-static {v0}, Lcom/android/server/preload/OneplusAppPreload$PackagePreloadResult;->access$300(Lcom/android/server/preload/OneplusAppPreload$PackagePreloadResult;)Ljava/lang/String;
    ...
    invoke-static {v2, v3, v4, p2}, Lcom/android/server/preload/OneplusAppPreload;->access$400(Lcom/android/server/preload/OneplusAppPreload;Ljava/lang/String;Lcom/android/server/preload/OneplusAppPreload$SingleRecord;Z)V
...
.method public notifyProcessDie(Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "notifyProcessDie : "
    ...
    iget-object v3, p0, Lcom/android/server/preload/OneplusAppPreload$PreloadHitStatistics;->this$0:Lcom/android/server/preload/OneplusAppPreload;

    invoke-static {v3, p1, v2, v1}, Lcom/android/server/preload/OneplusAppPreload;->access$400(Lcom/android/server/preload/OneplusAppPreload;Ljava/lang/String;Lcom/android/server/preload/OneplusAppPreload$SingleRecord;Z)V
    ...
    invoke-static {v1, p1, v2, v3}, Lcom/android/server/preload/OneplusAppPreload;->access$400(Lcom/android/server/preload/OneplusAppPreload;Ljava/lang/String;Lcom/android/server/preload/OneplusAppPreload$SingleRecord;Z)V
