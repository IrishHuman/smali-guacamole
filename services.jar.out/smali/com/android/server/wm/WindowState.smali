...
.field mCarModeWindowWithDockBottom:I
...
.field mIsTransitActivityClose:Z
...
.method constructor <init>(Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/Session;Landroid/view/IWindow;Lcom/android/server/wm/WindowToken;Lcom/android/server/wm/WindowState;IILandroid/view/WindowManager$LayoutParams;IIZLcom/android/server/wm/WindowState$PowerManagerWrapper;)V
    ...
    iput-object v8, v1, Lcom/android/server/wm/WindowState;->mReplacementWindow:Lcom/android/server/wm/WindowState;
    ...
    iput-object v9, v1, Lcom/android/server/wm/WindowState;->mSurfacePosition:Landroid/graphics/Point;

    const-wide/16 v9, -0x1

    iput-wide v9, v1, Lcom/android/server/wm/WindowState;->mFrameNumber:J
    ...
    iput v6, v1, Lcom/android/server/wm/WindowState;->mCarModeWindowWithDockBottom:I

    iput-boolean v7, v1, Lcom/android/server/wm/WindowState;->mIsCarModeWindowReset:Z

    iput-boolean v7, v1, Lcom/android/server/wm/WindowState;->mIsTransitActivityClose:Z
    ...
    invoke-direct {v12, v1, v8}, Lcom/android/server/wm/WindowState$WindowId;-><init>(Lcom/android/server/wm/WindowState;Lcom/android/server/wm/WindowState$1;)V
    ...
    invoke-direct {v13, v1, v8}, Lcom/android/server/wm/WindowState$DeathRecipient;-><init>(Lcom/android/server/wm/WindowState;Lcom/android/server/wm/WindowState$1;)V
    ...
    iget-boolean v8, v3, Lcom/android/server/wm/WindowToken;->mRoundedCornerOverlay:Z
    ...
    iget-object v8, v7, Lcom/android/server/wm/AppWindowToken;->mInputApplicationHandle:Lcom/android/server/input/InputApplicationHandle;
    ...
    invoke-direct {v0, v8, v1, v2, v7}, Lcom/android/server/input/InputWindowHandle;-><init>(Lcom/android/server/input/InputApplicationHandle;Ljava/lang/Object;Landroid/view/IWindow;I)V

    iput-object v0, v1, Lcom/android/server/wm/WindowState;->mInputWindowHandle:Lcom/android/server/input/InputWindowHandle;

    move-object/from16 v7, p1

    iget-object v0, v7, Lcom/android/server/wm/WindowManagerService;->mPowerManagerInternal:Landroid/os/PowerManagerInternal;
    ...
    iput-boolean v8, v1, Lcom/android/server/wm/WindowState;->mLayoutAttached:Z

    iput-boolean v8, v1, Lcom/android/server/wm/WindowState;->mIsImWindow:Z

    iput-boolean v8, v1, Lcom/android/server/wm/WindowState;->mIsWallpaper:Z

    iput-boolean v8, v1, Lcom/android/server/wm/WindowState;->mIsFloatingLayer:Z

    iput v8, v1, Lcom/android/server/wm/WindowState;->mBaseLayer:I

    iput v8, v1, Lcom/android/server/wm/WindowState;->mSubLayer:I

    const/4 v8, 0x0

    iput-object v8, v1, Lcom/android/server/wm/WindowState;->mInputWindowHandle:Lcom/android/server/input/InputWindowHandle;

    iput-object v8, v1, Lcom/android/server/wm/WindowState;->mWinAnimator:Lcom/android/server/wm/WindowStateAnimator;
...
.method public computeFrameLw(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Lcom/android/server/wm/utils/WmDisplayCutout;Z)V
    ...
    invoke-static {v11, v12}, Lcom/android/server/CarModeDockHandler;->isCarModeWindowWithDock(Ljava/lang/String;Z)Z
    ...
    :cond_5
    iget-boolean v11, v0, Lcom/android/server/wm/WindowState;->mIsImWindow:Z

    if-eqz v11, :cond_6

    iget-object v11, v0, Lcom/android/server/wm/WindowState;->mService:Lcom/android/server/wm/WindowManagerService;

    iget-object v11, v11, Lcom/android/server/wm/WindowManagerService;->mFocusedApp:Lcom/android/server/wm/AppWindowToken;
    ...
    invoke-static {v12, v13}, Lcom/android/server/CarModeDockHandler;->isCarModeWindowWithDock(Ljava/lang/String;Z)Z
    ...
    iput-boolean v7, v0, Lcom/android/server/wm/WindowState;->mIsCarModeWindowReset:Z

    invoke-virtual/range {p0 .. p1}, Lcom/android/server/wm/WindowState;->resetFrameForCarModeWinWithDock(Landroid/graphics/Rect;)V

    invoke-virtual {v0, v2}, Lcom/android/server/wm/WindowState;->resetFrameForCarModeWinWithDock(Landroid/graphics/Rect;)V

    invoke-virtual {v0, v3}, Lcom/android/server/wm/WindowState;->resetFrameForCarModeWinWithDock(Landroid/graphics/Rect;)V

    invoke-virtual {v0, v4}, Lcom/android/server/wm/WindowState;->resetFrameForCarModeWinWithDock(Landroid/graphics/Rect;)V

    invoke-virtual {v0, v5}, Lcom/android/server/wm/WindowState;->resetFrameForCarModeWinWithDock(Landroid/graphics/Rect;)V

    invoke-virtual {v0, v6}, Lcom/android/server/wm/WindowState;->resetFrameForCarModeWinWithDock(Landroid/graphics/Rect;)V
    ...
    invoke-static {v9}, Lcom/android/server/SpecialIMCallingHandler;->checkIfNeedToHideFloatingWindow(Ljava/lang/String;)Z
    ...
    const-string v12, "We\'ve got special IM floating window of "
    ...
    :cond_8
    invoke-virtual/range {p0 .. p1}, Lcom/android/server/wm/WindowState;->resetFrameForHidingSpecialIMFloatingWindow(Landroid/graphics/Rect;)V

    invoke-virtual {v0, v2}, Lcom/android/server/wm/WindowState;->resetFrameForHidingSpecialIMFloatingWindow(Landroid/graphics/Rect;)V

    invoke-virtual {v0, v3}, Lcom/android/server/wm/WindowState;->resetFrameForHidingSpecialIMFloatingWindow(Landroid/graphics/Rect;)V

    invoke-virtual {v0, v4}, Lcom/android/server/wm/WindowState;->resetFrameForHidingSpecialIMFloatingWindow(Landroid/graphics/Rect;)V

    invoke-virtual {v0, v5}, Lcom/android/server/wm/WindowState;->resetFrameForHidingSpecialIMFloatingWindow(Landroid/graphics/Rect;)V

    invoke-virtual {v0, v6}, Lcom/android/server/wm/WindowState;->resetFrameForHidingSpecialIMFloatingWindow(Landroid/graphics/Rect;)V
...
.method public getWindowToken()Landroid/os/IBinder;
    ...
    const-string/jumbo v3, "getWindowToken: can\'t get window token:"
...
.method removeImmediately()V
    ...
    iget-object v0, v0, Lcom/android/server/wm/WindowManagerService;->wechatFloatingShowing:Lcom/android/server/wm/WindowState;
    ...
    iput-object v1, v0, Lcom/android/server/wm/WindowManagerService;->wechatFloatingShowing:Lcom/android/server/wm/WindowState;
...
.method reportResized()V
    ...
    :cond_3
    iget-boolean v3, v15, Lcom/android/server/wm/WindowState;->mEnforceSizeCompat:Z

    if-eqz v3, :cond_4

    iget-object v3, v15, Lcom/android/server/wm/WindowState;->mCompatFrame:Landroid/graphics/Rect;
...
.method resetFrame(Landroid/graphics/Rect;)V
    ...
    sget v2, Lcom/android/server/wm/WindowManagerService;->LIMITED_SCREEN_SIZE:I
...
.method resetFrameForCarModeWinWithDock(Landroid/graphics/Rect;)V
    .locals 2
    ...
    :cond_0
    iget v0, p0, Lcom/android/server/wm/WindowState;->mCarModeWindowWithDockBottom:I
    ...
    sget v1, Lcom/android/server/CarModeDockHandler;->sDockHeight:I

    sub-int/2addr v0, v1

    iput v0, p0, Lcom/android/server/wm/WindowState;->mCarModeWindowWithDockBottom:I
...
.method resetFrameForHidingSpecialIMFloatingWindow(Landroid/graphics/Rect;)V
    .locals 1
