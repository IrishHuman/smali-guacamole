...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/wm/DisplayContent;ZZLcom/android/server/wm/WindowManagerService;)V
    ...
    invoke-virtual {v12, v14, v3}, Landroid/view/SurfaceControl$Builder;->setSize(II)Landroid/view/SurfaceControl$Builder;
    ...
    :try_start_1
    invoke-virtual {v3, v12}, Landroid/view/SurfaceControl$Builder;->setSecure(Z)Landroid/view/SurfaceControl$Builder;
    ...
    invoke-virtual {v0, v3, v9}, Landroid/view/SurfaceControl$Transaction;->setOverrideScalingMode(Landroid/view/SurfaceControl;I)Landroid/view/SurfaceControl$Transaction;

    invoke-virtual {v0, v9}, Landroid/view/SurfaceControl$Transaction;->apply(Z)V
    ...
    iget v0, v1, Lcom/android/server/wm/ScreenRotationAnimation;->mWidth:I

    iget v2, v1, Lcom/android/server/wm/ScreenRotationAnimation;->mHeight:I

    invoke-static {v14, v9, v0, v2}, Landroid/view/SurfaceControl;->screenshot(Landroid/os/IBinder;Landroid/view/Surface;II)V
    ...
    invoke-static {v0, v2, v3, v4}, Landroid/view/SurfaceControl;->screenshot(Landroid/graphics/Rect;III)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v1, v0, v3, v2}, Lcom/android/server/wm/ScreenRotationAnimation;->getMostPopularColorBoundary(Landroid/graphics/Bitmap;II)I
    ...
    invoke-virtual {v13, v2, v3}, Landroid/view/SurfaceControl$Transaction;->setLayer(Landroid/view/SurfaceControl;I)Landroid/view/SurfaceControl$Transaction;
