...
.field private mDefaultScreenMode:I
...
.method public static synthetic lambda$new$8(Lcom/android/server/wm/DisplayContent;Lcom/android/server/wm/WindowState;)V
    ...
    iput-boolean v4, v9, Lcom/android/server/wm/DisplayContent$ApplySurfaceChangesTransactionState;->syswin:Z

    :cond_3
    iget-object v9, p0, Lcom/android/server/wm/DisplayContent;->mTmpApplySurfaceChangesTransactionState:Lcom/android/server/wm/DisplayContent$ApplySurfaceChangesTransactionState;

    iget v9, v9, Lcom/android/server/wm/DisplayContent$ApplySurfaceChangesTransactionState;->preferredRefreshRate:F
    ...
    iput v10, v9, Lcom/android/server/wm/DisplayContent$ApplySurfaceChangesTransactionState;->preferredRefreshRate:F
    ...
    sget-object v7, Lcom/android/server/wm/WindowManagerService;->mScreenModeManager:Lcom/android/server/wm/ScreenModeManager;
    ...
    invoke-virtual {v7, p1}, Lcom/android/server/wm/ScreenModeManager;->getScreenFlushMode(Lcom/android/server/wm/WindowState;)I

    move-result v9

    invoke-virtual {v7}, Lcom/android/server/wm/ScreenModeManager;->isFixedRefreshRate()Z
    ...
    iget v11, p0, Lcom/android/server/wm/DisplayContent;->mDefaultScreenMode:I

    if-ne v10, v11, :cond_b

    iget v10, p0, Lcom/android/server/wm/DisplayContent;->mDefaultScreenMode:I
    ...
    const-string v12, "ScreenMode: preferredModeId="
    ...
    iget-object v12, p1, Lcom/android/server/wm/WindowState;->mAttrs:Landroid/view/WindowManager$LayoutParams;
    ...
    iget-object v13, p1, Lcom/android/server/wm/WindowState;->mAttrs:Landroid/view/WindowManager$LayoutParams;
    ...
    iput v9, v7, Lcom/android/server/wm/ScreenModeManager;->mCurrentModeId:I
    ...
    iput v8, v7, Lcom/android/server/wm/DisplayContent$ApplySurfaceChangesTransactionState;->preferredModeId:I
...
.method public static synthetic lambda$waitForAllWindowsDrawn$24(Lcom/android/server/wm/DisplayContent;Lcom/android/server/policy/WindowManagerPolicy;Lcom/android/server/wm/WindowState;)V
    ...
    :cond_1
    invoke-virtual {p2}, Lcom/android/server/wm/WindowState;->inPreloadWindowingMode()Z
    ...
    const-string v3, "don\'t need to wait Preload window"
...
.method private updateBaseDisplayMetricsIfNeeded()V
    ...
    :goto_c
    invoke-virtual {p0, v2, v11, v12}, Lcom/android/server/wm/DisplayContent;->updateBaseDisplayMetrics(III)V
...
.method applySurfaceChangesTransaction(Z)Z
    ...
    invoke-virtual {v6}, Lcom/android/server/wm/DisplayContent$ApplySurfaceChangesTransactionState;->reset()V
    ...
    sget-object v6, Lcom/android/server/wm/WindowManagerService;->mScreenModeManager:Lcom/android/server/wm/ScreenModeManager;
    ...
    invoke-virtual {v6}, Lcom/android/server/wm/ScreenModeManager;->getDefaultModeId()I

    move-result v6

    iput v6, p0, Lcom/android/server/wm/DisplayContent;->mDefaultScreenMode:I

    iget-object v6, p0, Lcom/android/server/wm/DisplayContent;->mTmpApplySurfaceChangesTransactionState:Lcom/android/server/wm/DisplayContent$ApplySurfaceChangesTransactionState;

    iget v8, p0, Lcom/android/server/wm/DisplayContent;->mDefaultScreenMode:I

    iput v8, v6, Lcom/android/server/wm/DisplayContent$ApplySurfaceChangesTransactionState;->preferredModeId:I

    :cond_a
    iput-boolean p1, p0, Lcom/android/server/wm/DisplayContent;->mTmpRecoveringMemory:Z

    iget-object v6, p0, Lcom/android/server/wm/DisplayContent;->mApplySurfaceChangesTransaction:Ljava/util/function/Consumer;
    ...
    sget-object v3, Lcom/android/server/wm/WindowManagerService;->mScreenModeManager:Lcom/android/server/wm/ScreenModeManager;
    ...
    iget v5, v5, Lcom/android/server/wm/ScreenModeManager;->mCurrentModeId:I
    ...
    const-string v6, "ScreenMode: keep preferredModeId to curent "
    ...
    iget v6, v6, Lcom/android/server/wm/ScreenModeManager;->mCurrentModeId:I
    ...
    iput v5, v3, Lcom/android/server/wm/DisplayContent$ApplySurfaceChangesTransactionState;->preferredModeId:I
    ...
    const-string v6, "ScreenMode: set preferredModeId to "
...
.method updateDisplayInfo()V
    ...
    invoke-virtual {v0}, Lcom/android/server/wm/WindowManagerService;->updateSizeForResolutionChanged()V
