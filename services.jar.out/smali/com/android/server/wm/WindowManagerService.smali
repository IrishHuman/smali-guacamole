...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/wm/WindowManagerService$ConfigHandler;,
        Lcom/android/server/wm/WindowManagerService$LayerOptimizationConfigUpdater;,
...
.field private static final LAYER_OPTIMIZATION:Ljava/lang/String; = "ConfigLayerOptimization"

.field static final LAYOUT_REPEAT_THRESHOLD:I = 0x4

.field static LIMITED_SCREEN_SIZE:I = 0x0
...
.field static final OP_ENABLE_PARTIAL_COMPAT:Z
...
.field static mScreenModeManager:Lcom/android/server/wm/ScreenModeManager;
...
.field static sEnableLayerOptimization:Z
...
.field final mConfigHandler:Lcom/android/server/wm/WindowManagerService$ConfigHandler;
...
.field public mSkipAppAnimation:Z
...
.field public mTmpLeashs:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList<",
...
.field mTransitActivityCloseWindow:Lcom/android/server/wm/WindowState;
...
.field wechatFloatingShowing:Lcom/android/server/wm/WindowState;
...
.method static constructor <clinit>()V
    ...
    sput v2, Lcom/android/server/wm/WindowManagerService;->LIMITED_SCREEN_SIZE:I
    ...
    sget v3, Lcom/android/server/wm/WindowManagerService;->LIMITED_SCREEN_SIZE:I
    ...
    sput-boolean v2, Lcom/android/server/wm/WindowManagerService;->IS_GESTURE_BUTTON_ENABLED:Z

    new-instance v2, Lcom/android/server/wm/WindowManagerThreadPriorityBooster;

    invoke-direct {v2}, Lcom/android/server/wm/WindowManagerThreadPriorityBooster;-><init>()V

    sput-object v2, Lcom/android/server/wm/WindowManagerService;->sThreadPriorityBooster:Lcom/android/server/wm/WindowManagerThreadPriorityBooster;

    const-string/jumbo v2, "sys.enable.partial.compat"

    invoke-static {v2, v1}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v2

    sput-boolean v2, Lcom/android/server/wm/WindowManagerService;->OP_ENABLE_PARTIAL_COMPAT:Z

    sput-boolean v0, Lcom/android/server/wm/WindowManagerService;->DEBUG_POLICY:Z

    sput-boolean v1, Lcom/android/server/wm/WindowManagerService;->sEnableLayerOptimization:Z
...
.method private constructor <init>(Landroid/content/Context;Lcom/android/server/input/InputManagerService;ZZZLcom/android/server/policy/WindowManagerPolicy;)V
    ...
    iput-object v8, v6, Lcom/android/server/wm/WindowManagerService;->mTransitActivityCloseWindow:Lcom/android/server/wm/WindowState;
    ...
    iput-boolean v9, v6, Lcom/android/server/wm/WindowManagerService;->mSkipAppAnimation:Z

    iput-boolean v0, v6, Lcom/android/server/wm/WindowManagerService;->mKeyguardDone:Z
    ...
    iput-object v8, v6, Lcom/android/server/wm/WindowManagerService;->wechatFloatingShowing:Lcom/android/server/wm/WindowState;

    new-instance v1, Lcom/android/server/wm/WindowManagerService$ConfigHandler;

    invoke-direct {v1, v6, v8}, Lcom/android/server/wm/WindowManagerService$ConfigHandler;-><init>(Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/WindowManagerService$1;)V

    iput-object v1, v6, Lcom/android/server/wm/WindowManagerService;->mConfigHandler:Lcom/android/server/wm/WindowManagerService$ConfigHandler;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, v6, Lcom/android/server/wm/WindowManagerService;->mTmpLeashs:Ljava/util/ArrayList;
...
.method private doDump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;Z)V
    ...
    new-instance v4, Lcom/android/server/wm/-$$Lambda$WindowManagerService$GIr_NajK9flTCCZ1S4MvX_2FOUY;

    invoke-direct {v4, p2}, Lcom/android/server/wm/-$$Lambda$WindowManagerService$GIr_NajK9flTCCZ1S4MvX_2FOUY;-><init>(Ljava/io/PrintWriter;)V
...
.method private dumpWindows(Ljava/io/PrintWriter;Ljava/lang/String;[Ljava/lang/String;IZ)Z
    ...
    new-instance v6, Lcom/android/server/wm/-$$Lambda$WindowManagerService$xSA8-5DqM2yieCLniWyTBDi6whg;

    invoke-direct {v6, v3, v1, v0}, Lcom/android/server/wm/-$$Lambda$WindowManagerService$xSA8-5DqM2yieCLniWyTBDi6whg;-><init>(ZZLjava/util/ArrayList;)V
...
.method public static getDensityForResolution(I)I
    .locals 3
    ...
    sget-object v0, Lcom/android/server/wm/WindowManagerService;->mScreenModeManager:Lcom/android/server/wm/ScreenModeManager;

    if-eqz v0, :cond_1

    sget-object v0, Lcom/android/server/wm/WindowManagerService;->mScreenModeManager:Lcom/android/server/wm/ScreenModeManager;

    iget-boolean v0, v0, Lcom/android/server/wm/ScreenModeManager;->mIsResolutionAuto:Z
    ...
    invoke-static {p0, v0, v1}, Lcom/android/server/wm/ScreenModeManager;->densityForResolution(I[I[I)I
...
.method public static getWmsInstance()Lcom/android/server/wm/WindowManagerService;
    .locals 1
...
.method public static isDisplayCompat(Ljava/lang/String;I)Z
    ...
    sget-object v1, Lcom/android/server/wm/WindowManagerService;->mScreenModeManager:Lcom/android/server/wm/ScreenModeManager;

    if-eqz v1, :cond_3

    sget-object v1, Lcom/android/server/wm/WindowManagerService;->mScreenModeManager:Lcom/android/server/wm/ScreenModeManager;

    iget-boolean v1, v1, Lcom/android/server/wm/ScreenModeManager;->mIsResolutionAuto:Z
    ...
    sget-object v3, Lcom/android/server/AppOpsService;->mDisplayCompatFhdList:Ljava/util/ArrayList;

    invoke-virtual {v1, v3, p0}, Lcom/android/server/wm/ScreenModeManager;->checkContains(Ljava/util/ArrayList;Ljava/lang/String;)Z
    ...
    :cond_1
    sget-boolean v1, Lcom/android/server/wm/WindowManagerService;->OP_ENABLE_PARTIAL_COMPAT:Z
    ...
    sget-object v1, Lcom/android/server/wm/WindowManagerService;->mSystemAppList:Ljava/util/ArrayList;
    ...
    sget-object v3, Lcom/android/server/AppOpsService;->mDisplayCompat2kList:Ljava/util/ArrayList;
...
.method static synthetic lambda$doDump$8(Ljava/io/PrintWriter;Lcom/android/server/wm/WindowState;)V
    .locals 0
...
.method static synthetic lambda$dumpWindows$7(ZZLjava/util/ArrayList;Lcom/android/server/wm/WindowState;)V
    .locals 1
...
.method static synthetic lambda$isAnyWindowVisibleForUid$6(ILcom/android/server/wm/WindowState;)Z
    .locals 1
...
.method static synthetic lambda$isFloatWin$0(Ljava/lang/String;Lcom/android/server/wm/WindowState;)Z
    .locals 5
    ...
    iget v2, p1, Lcom/android/server/wm/WindowState;->mAppOp:I
...
.method static synthetic lambda$main$1(Landroid/content/Context;Lcom/android/server/input/InputManagerService;ZZZLcom/android/server/policy/WindowManagerPolicy;)V
    .locals 8
...
.method public static synthetic lambda$notifyKeyguardFlagsChanged$2(Lcom/android/server/wm/WindowManagerService;Ljava/lang/Runnable;)V
    .locals 2
...
.method static synthetic lambda$updateNonSystemOverlayWindowsVisibilityIfNeeded$9(ZLcom/android/server/wm/WindowState;)V
    .locals 0
...
.method public static main(Landroid/content/Context;Lcom/android/server/input/InputManagerService;ZZZLcom/android/server/policy/WindowManagerPolicy;)Lcom/android/server/wm/WindowManagerService;
    ...
    new-instance v8, Lcom/android/server/wm/-$$Lambda$WindowManagerService$3u-dRzVQGz9jSS5SIx-goKpzWEM;
    ...
    invoke-direct/range {v1 .. v7}, Lcom/android/server/wm/-$$Lambda$WindowManagerService$3u-dRzVQGz9jSS5SIx-goKpzWEM;-><init>(Landroid/content/Context;Lcom/android/server/input/InputManagerService;ZZZLcom/android/server/policy/WindowManagerPolicy;)V
...
.method private performEnableScreen()V
    ...
    new-instance v0, Lcom/android/server/wm/ScreenModeManager;

    iget-object v1, p0, Lcom/android/server/wm/WindowManagerService;->mContext:Landroid/content/Context;

    invoke-direct {v0, p0, v1}, Lcom/android/server/wm/ScreenModeManager;-><init>(Lcom/android/server/wm/WindowManagerService;Landroid/content/Context;)V

    sput-object v0, Lcom/android/server/wm/WindowManagerService;->mScreenModeManager:Lcom/android/server/wm/ScreenModeManager;

    sget-object v0, Lcom/android/server/wm/WindowManagerService;->mScreenModeManager:Lcom/android/server/wm/ScreenModeManager;

    invoke-virtual {v0}, Lcom/android/server/wm/ScreenModeManager;->init()V
    ...
    iget-object v0, p0, Lcom/android/server/wm/WindowManagerService;->mConfigHandler:Lcom/android/server/wm/WindowManagerService$ConfigHandler;
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/android/server/wm/WindowManagerService$ConfigHandler;->postDelayed(Ljava/lang/Runnable;J)Z
...
.method public addWindow(Lcom/android/server/wm/Session;Landroid/view/IWindow;ILandroid/view/WindowManager$LayoutParams;IILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/view/DisplayCutout$ParcelableWrapper;Landroid/view/InputChannel;)I
    ...
    invoke-static {v0}, Lcom/android/server/SpecialIMCallingHandler;->checkIfNeedToHideFloatingWindow(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_48

    iput-object v1, v13, Lcom/android/server/wm/WindowManagerService;->wechatFloatingShowing:Lcom/android/server/wm/WindowState;
...
.method public executeAppTransition()V
    ...
    :cond_0
    sget-boolean v1, Lcom/android/server/wm/WindowManagerService;->sEnableLayerOptimization:Z
    ...
    invoke-virtual {v5}, Lcom/android/server/wm/TaskStack;->getSurfaceControl()Landroid/view/SurfaceControl;
    ...
    iget-boolean v5, v5, Lcom/android/server/wm/TaskStack;->stackVisibility:Z
    ...
    const-string/jumbo v7, "opening showElement stack id == "
    ...
    iput-boolean v4, v5, Lcom/android/server/wm/TaskStack;->stackVisibility:Z

    invoke-virtual {v3}, Lcom/android/server/wm/AppWindowToken;->getStack()Lcom/android/server/wm/TaskStack;

    move-result-object v4

    invoke-virtual {v4}, Lcom/android/server/wm/TaskStack;->getSurfaceControl()Landroid/view/SurfaceControl;

    move-result-object v4

    invoke-virtual {v4}, Landroid/view/SurfaceControl;->showElement()V
    ...
    invoke-virtual {v2}, Lcom/android/server/wm/AppWindowToken;->getStack()Lcom/android/server/wm/TaskStack;
    ...
    invoke-virtual {v3}, Lcom/android/server/wm/TaskStack;->getSurfaceControl()Landroid/view/SurfaceControl;
    ...
    iget-boolean v3, v3, Lcom/android/server/wm/TaskStack;->stackVisibility:Z
    ...
    const-string v6, "closing showElement stack id == "
    ...
    iput-boolean v4, v3, Lcom/android/server/wm/TaskStack;->stackVisibility:Z
    ...
    invoke-virtual {v3}, Landroid/view/SurfaceControl;->showElement()V
...
.method public getWindowAnimationScaleLocked()F
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/WindowManagerService;->mSkipAppAnimation:Z
...
.method public getWindowDisplayFrame(Lcom/android/server/wm/Session;Landroid/view/IWindow;Landroid/graphics/Rect;)V
    ...
    :cond_0
    :try_start_1
    iget-boolean v2, v1, Lcom/android/server/wm/WindowState;->mEnforceSizeCompat:Z

    if-eqz v2, :cond_1

    new-instance v2, Landroid/graphics/Rect;

    iget-object v3, v1, Lcom/android/server/wm/WindowState;->mDisplayFrame:Landroid/graphics/Rect;
    ...
    iget-object v4, v1, Lcom/android/server/wm/WindowState;->mDisplayFrame:Landroid/graphics/Rect;
...
.method handleAnimatingStoppedAndTransitionLocked()I
    ...
    iget-object v3, p0, Lcom/android/server/wm/WindowManagerService;->mTransitActivityCloseWindow:Lcom/android/server/wm/WindowState;

    if-eqz v3, :cond_2

    iget-object v3, p0, Lcom/android/server/wm/WindowManagerService;->mTransitActivityCloseWindow:Lcom/android/server/wm/WindowState;

    iget-boolean v3, v3, Lcom/android/server/wm/WindowState;->mIsTransitActivityClose:Z
    ...
    const-string v5, "Reset mTransitActivityCloseWindow for: "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v5, p0, Lcom/android/server/wm/WindowManagerService;->mTransitActivityCloseWindow:Lcom/android/server/wm/WindowState;
    ...
    iput-boolean v4, v3, Lcom/android/server/wm/WindowState;->mIsTransitActivityClose:Z

    const/4 v3, 0x0

    iput-object v3, p0, Lcom/android/server/wm/WindowManagerService;->mTransitActivityCloseWindow:Lcom/android/server/wm/WindowState;
...
.method public hasWechatFloating()Z
    .locals 2
    ...
    iget-object v1, p0, Lcom/android/server/wm/WindowManagerService;->wechatFloatingShowing:Lcom/android/server/wm/WindowState;
...
.method public inSurfaceTransaction(Ljava/lang/Runnable;)V
    ...
    iget-object v1, p0, Lcom/android/server/wm/WindowManagerService;->mTmpLeashs:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Lcom/android/server/wm/WindowManagerService;->mTmpLeashs:Ljava/util/ArrayList;
...
.method public isActivityDisplayCompat(Ljava/lang/String;I)Z
    ...
    invoke-static {p1, p2}, Lcom/android/server/wm/WindowManagerService;->isDisplayCompat(Ljava/lang/String;I)Z
...
.method public isAnyWindowVisibleForUid(I)Z
    ...
    new-instance v2, Lcom/android/server/wm/-$$Lambda$WindowManagerService$oKJVzsKe5goVbjN6jqkQkJnSfyk;

    invoke-direct {v2, p1}, Lcom/android/server/wm/-$$Lambda$WindowManagerService$oKJVzsKe5goVbjN6jqkQkJnSfyk;-><init>(I)V
...
.method public isFloatWin(Ljava/lang/String;)Z
    .locals 6
    ...
    invoke-virtual {v2}, Lcom/android/server/wm/RootWindowContainer;->getDisplayContents()Lcom/android/server/wm/WindowList;
    ...
    new-instance v5, Lcom/android/server/wm/-$$Lambda$WindowManagerService$Ee13tZD6pqcPBokQCFR9GpwHtKc;

    invoke-direct {v5, p1}, Lcom/android/server/wm/-$$Lambda$WindowManagerService$Ee13tZD6pqcPBokQCFR9GpwHtKc;-><init>(Ljava/lang/String;)V

    invoke-virtual {v4, v5, v0}, Lcom/android/server/wm/DisplayContent;->forAllWindows(Lcom/android/internal/util/ToBooleanFunction;Z)Z
...
.method public isKeyguardDisabledAndNotShowing()Z
    ...
    invoke-interface {v0}, Lcom/android/server/policy/WindowManagerPolicy;->isKeyguardDisabledAndNotShowing()Z
...
.method notifyKeyguardFlagsChanged(Ljava/lang/Runnable;)V
    ...
    new-instance v0, Lcom/android/server/wm/-$$Lambda$WindowManagerService$cSaK87TtfkzmNMMVltLtr1qlm_U;

    invoke-direct {v0, p0, p1}, Lcom/android/server/wm/-$$Lambda$WindowManagerService$cSaK87TtfkzmNMMVltLtr1qlm_U;-><init>(Lcom/android/server/wm/WindowManagerService;Ljava/lang/Runnable;)V
...
.method public prepareAppTransition(IZIZ)V
    ...
    iget-object v2, p0, Lcom/android/server/wm/WindowManagerService;->mTransitActivityCloseWindow:Lcom/android/server/wm/WindowState;
    ...
    iput-boolean v3, v2, Lcom/android/server/wm/WindowState;->mIsTransitActivityClose:Z

    const/4 v2, 0x0

    iput-object v2, p0, Lcom/android/server/wm/WindowManagerService;->mTransitActivityCloseWindow:Lcom/android/server/wm/WindowState;
    ...
    iput-boolean v4, v2, Lcom/android/server/wm/WindowState;->mIsTransitActivityClose:Z
...
.method registerOnlineConfig()V
    ...
    iget-object v2, p0, Lcom/android/server/wm/WindowManagerService;->mConfigHandler:Lcom/android/server/wm/WindowManagerService$ConfigHandler;

    new-instance v3, Lcom/android/server/wm/WindowManagerService$LayerOptimizationConfigUpdater;

    invoke-direct {v3, p0}, Lcom/android/server/wm/WindowManagerService$LayerOptimizationConfigUpdater;-><init>(Lcom/android/server/wm/WindowManagerService;)V

    const-string v4, "ConfigLayerOptimization"

    invoke-direct {v0, v1, v2, v3, v4}, Lcom/oneplus/config/ConfigObserver;-><init>(Landroid/content/Context;Landroid/os/Handler;Lcom/oneplus/config/ConfigObserver$ConfigUpdater;Ljava/lang/String;)V

    iput-object v0, p0, Lcom/android/server/wm/WindowManagerService;->mConfigObserver:Lcom/oneplus/config/ConfigObserver;

    iget-object v0, p0, Lcom/android/server/wm/WindowManagerService;->mConfigObserver:Lcom/oneplus/config/ConfigObserver;

    invoke-virtual {v0}, Lcom/oneplus/config/ConfigObserver;->register()V

    iget-object v0, p0, Lcom/android/server/wm/WindowManagerService;->mConfigHandler:Lcom/android/server/wm/WindowManagerService$ConfigHandler;

    iget-object v1, p0, Lcom/android/server/wm/WindowManagerService;->mConfigHandler:Lcom/android/server/wm/WindowManagerService$ConfigHandler;

    const/4 v2, 0x0

    invoke-virtual {v1, v2}, Lcom/android/server/wm/WindowManagerService$ConfigHandler;->obtainMessage(I)Landroid/os/Message;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/android/server/wm/WindowManagerService$ConfigHandler;->sendMessage(Landroid/os/Message;)Z
...
.method public relayoutWindow(Lcom/android/server/wm/Session;Landroid/view/IWindow;ILandroid/view/WindowManager$LayoutParams;IIIIJLandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/view/DisplayCutout$ParcelableWrapper;Landroid/util/MergedConfiguration;Landroid/view/Surface;)I
    ...
    :cond_2
    :try_start_3
    sget-boolean v0, Lcom/android/server/wm/WindowManagerService;->sEnableLayerOptimization:Z
    :try_end_3
    ...
    iget-boolean v0, v0, Lcom/android/server/wm/TaskStack;->stackVisibility:Z
    ...
    const-string/jumbo v9, "relayoutWindow showElement stack id == "
    ...
    iput-boolean v9, v0, Lcom/android/server/wm/TaskStack;->stackVisibility:Z
    ...
    invoke-virtual {v0}, Landroid/view/SurfaceControl;->showElement()V
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_0
    ...
    iget-object v0, v13, Lcom/android/server/wm/WindowState;->mPendingForcedSeamlessRotate:Lcom/android/server/wm/ForcedSeamlessRotator;
    :try_end_7
    ...
    iget-object v9, v13, Lcom/android/server/wm/WindowState;->mToken:Lcom/android/server/wm/WindowToken;

    invoke-virtual {v0, v9, v13}, Lcom/android/server/wm/ForcedSeamlessRotator;->finish(Lcom/android/server/wm/WindowToken;Lcom/android/server/wm/WindowState;)V

    invoke-virtual {v13}, Lcom/android/server/wm/WindowState;->getFrameNumber()J

    move-result-wide v9

    iput-wide v9, v13, Lcom/android/server/wm/WindowState;->mFinishForcedSeamlessRotateFrameNumber:J

    const/4 v0, 0x0

    iput-object v0, v13, Lcom/android/server/wm/WindowState;->mPendingForcedSeamlessRotate:Lcom/android/server/wm/ForcedSeamlessRotator;
    ...
    iget-object v10, v1, Lcom/android/server/wm/WindowManagerService;->mPolicy:Lcom/android/server/policy/WindowManagerPolicy;

    invoke-interface {v10, v13, v3, v15}, Lcom/android/server/policy/WindowManagerPolicy;->adjustWindowParamsLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Landroid/view/WindowManager$LayoutParams;Z)V

    iget v10, v13, Lcom/android/server/wm/WindowState;->mSeq:I
    ...
    iget v0, v3, Landroid/view/WindowManager$LayoutParams;->subtreeSystemUiVisibility:I
    ...
    and-int/lit16 v10, v0, 0x4001

    if-eqz v10, :cond_a

    const/4 v10, 0x1

    iput-boolean v10, v13, Lcom/android/server/wm/WindowState;->mLayoutNeeded:Z

    :cond_a
    iget-object v10, v13, Lcom/android/server/wm/WindowState;->mAppToken:Lcom/android/server/wm/AppWindowToken;
    ...
    invoke-virtual {v10}, Lcom/android/server/wm/AppWindowToken;->checkKeyguardFlagsChanged()V
    ...
    iget-object v10, v13, Lcom/android/server/wm/WindowState;->mWinAnimator:Lcom/android/server/wm/WindowStateAnimator;

    invoke-virtual {v10}, Lcom/android/server/wm/WindowStateAnimator;->getShown()Z

    move-result v10

    invoke-virtual {v1, v13, v10}, Lcom/android/server/wm/WindowManagerService;->updateNonSystemOverlayWindowsVisibilityIfNeeded(Lcom/android/server/wm/WindowState;Z)V
    ...
    iget v14, v13, Lcom/android/server/wm/WindowState;->mRequestedHeight:I

    invoke-virtual {v13, v0, v14}, Lcom/android/server/wm/WindowState;->setWindowScale(II)V
    ...
    :try_start_13
    iget v15, v13, Lcom/android/server/wm/WindowState;->mViewVisibility:I
    :try_end_13
    ...
    :try_start_16
    iput-boolean v5, v13, Lcom/android/server/wm/WindowState;->mRelayoutCalled:Z

    iput-boolean v5, v13, Lcom/android/server/wm/WindowState;->mInRelayout:Z
    ...
    invoke-static {v10, v4, v5}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    :try_end_17
    ...
    invoke-direct {v1, v13, v12, v3, v0}, Lcom/android/server/wm/WindowManagerService;->tryStartExitingAnimation(Lcom/android/server/wm/WindowState;Lcom/android/server/wm/WindowStateAnimator;ZZ)Z
    ...
    invoke-virtual {v13, v11, v9, v14}, Lcom/android/server/wm/WindowState;->relayoutVisibleWindow(III)I
    ...
    :try_start_1c
    invoke-direct {v1, v10, v11, v13, v12}, Lcom/android/server/wm/WindowManagerService;->createSurfaceControl(Landroid/view/Surface;ILcom/android/server/wm/WindowState;Lcom/android/server/wm/WindowStateAnimator;)I
    ...
    const-string v15, "Exception thrown when creating surface for client "
    ...
    iput-boolean v15, v12, Lcom/android/server/wm/WindowStateAnimator;->mEnterAnimationPending:Z

    iput-boolean v15, v12, Lcom/android/server/wm/WindowStateAnimator;->mEnteringAnimation:Z
    :try_end_20
    ...
    const-string v15, "Releasing surface in: "
    ...
    :try_start_26
    invoke-virtual {v1, v15, v7}, Lcom/android/server/wm/WindowManagerService;->updateFocusedWindowLocked(IZ)Z
    ...
    :try_start_28
    invoke-virtual {v15, v3}, Lcom/android/server/wm/DisplayContent;->computeImeTarget(Z)Lcom/android/server/wm/WindowState;

    if-eqz v7, :cond_2d

    const/4 v3, 0x0

    invoke-virtual {v15, v3}, Lcom/android/server/wm/DisplayContent;->assignWindowLayers(Z)V
    ...
    iget-object v9, v13, Lcom/android/server/wm/WindowState;->mAttrs:Landroid/view/WindowManager$LayoutParams;
    ...
    const-string/jumbo v3, "relayoutWindow: performSurfacePlacement again if FLAG_DIM_BEHIND "
    ...
    :goto_1a
    iget-object v9, v1, Lcom/android/server/wm/WindowManagerService;->mWindowPlacerLocked:Lcom/android/server/wm/WindowSurfacePlacer;

    const/4 v10, 0x1

    invoke-virtual {v9, v10}, Lcom/android/server/wm/WindowSurfacePlacer;->performSurfacePlacement(Z)V
    ...
    iget-object v10, v15, Lcom/android/server/wm/DisplayContent;->mWallpaperController:Lcom/android/server/wm/WallpaperController;
    ...
    iget v15, v9, Landroid/view/DisplayInfo;->logicalHeight:I

    move-object/from16 v37, v9

    const/4 v9, 0x0

    invoke-virtual {v10, v13, v7, v15, v9}, Lcom/android/server/wm/WallpaperController;->updateWallpaperOffset(Lcom/android/server/wm/WindowState;IIZ)Z
    :try_end_2e
    ...
    :cond_33
    :try_start_31
    iget-boolean v7, v12, Lcom/android/server/wm/WindowStateAnimator;->mReportSurfaceResized:Z
    :try_end_31
    ...
    :try_start_32
    iput-boolean v7, v12, Lcom/android/server/wm/WindowStateAnimator;->mReportSurfaceResized:Z
    :try_end_32
    ...
    const-string v9, ", requestedHeight="

    invoke-virtual {v7, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v7, v4}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v9, ", viewVisibility="
    ...
    const-string v3, " mSysUiVis=0x"

    invoke-virtual {v0, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v3, v13, Lcom/android/server/wm/WindowState;->mSystemUiVisibility:I
    ...
    iget v0, v12, Lcom/android/server/wm/WindowStateAnimator;->mDrawState:I

    invoke-virtual {v7, v0}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    iget-boolean v0, v13, Lcom/android/server/wm/WindowState;->mEnforceSizeCompat:Z
...
.method public resolveConfigFromJSON(Lorg/json/JSONArray;)V
    ...
    const-string v1, "[OnlineConfig] layer_optimization jsonArray ==null"
    ...
    const-string v4, "config_layer_optimization"
    ...
    sput-boolean v4, Lcom/android/server/wm/WindowManagerService;->sEnableLayerOptimization:Z

    goto :goto_1

    :cond_1
    sput-boolean v0, Lcom/android/server/wm/WindowManagerService;->sEnableLayerOptimization:Z
    ...
    const-string v5, "config_finish_entering_after_exiting"
    ...
    sput-boolean v4, Lcom/android/server/wm/AnimatingAppWindowTokenRegistry;->OP_ENABLE_FINISH_ENTERING_AFTER_EXITING:Z

    sput-boolean v4, Lcom/android/server/wm/RemoteAnimationController;->OP_ENABLE_FINISH_ENTERING_AFTER_EXITING:Z
    ...
    sput-boolean v0, Lcom/android/server/wm/RemoteAnimationController;->OP_ENABLE_FINISH_ENTERING_AFTER_EXITING:Z
    ...
    const-string v1, "[OnlineConfig] layer_optimization updated complete !"
...
.method public setCurrentUser(I[I)V
    ...
    :goto_1
    sget-object v5, Lcom/android/server/wm/WindowManagerService;->mScreenModeManager:Lcom/android/server/wm/ScreenModeManager;

    if-eqz v5, :cond_2

    sget-object v5, Lcom/android/server/wm/WindowManagerService;->mScreenModeManager:Lcom/android/server/wm/ScreenModeManager;

    invoke-virtual {v5, v4}, Lcom/android/server/wm/ScreenModeManager;->getDensity(I)I
    ...
    const-string/jumbo v8, "set density for resolution: density "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v7, v4}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v8, ", consider resolution density "
    ...
    invoke-direct {p0, v1, v5}, Lcom/android/server/wm/WindowManagerService;->setForcedDisplayDensityLocked(Lcom/android/server/wm/DisplayContent;I)V
...
.method public setKeyguardDone(Z)V
    ...
    iput-boolean p1, p0, Lcom/android/server/wm/WindowManagerService;->mKeyguardDone:Z
...
.method public setScreenFlushMode(Landroid/os/IBinder;Ljava/lang/String;)V
    .locals 5
    ...
    iget-object v3, v1, Lcom/android/server/wm/AppWindowToken;->mPackageName:Ljava/lang/String;

    iput-object v3, v2, Lcom/android/server/wm/AppWindowToken;->mPackageName:Ljava/lang/String;

    iget-object v2, p0, Lcom/android/server/wm/WindowManagerService;->mFocusedApp:Lcom/android/server/wm/AppWindowToken;

    iput-object p2, v2, Lcom/android/server/wm/AppWindowToken;->mActivityName:Ljava/lang/String;

    sget-object v2, Lcom/android/server/wm/WindowManagerService;->mScreenModeManager:Lcom/android/server/wm/ScreenModeManager;

    iget-object v3, p0, Lcom/android/server/wm/WindowManagerService;->mFocusedApp:Lcom/android/server/wm/AppWindowToken;

    iget-object v4, p0, Lcom/android/server/wm/WindowManagerService;->mFocusedApp:Lcom/android/server/wm/AppWindowToken;

    iget v4, v4, Lcom/android/server/wm/AppWindowToken;->mTmpScreenFlushMode:I

    invoke-virtual {v2, v3, v4}, Lcom/android/server/wm/ScreenModeManager;->setScreenFlushModeLocked(Lcom/android/server/wm/AppWindowToken;I)V
...
.method public setScreenFlushMode(Lcom/android/server/wm/Session;Landroid/view/IWindow;I)V
    .locals 4
    ...
    invoke-virtual {v2, v3, p3}, Lcom/android/server/wm/ScreenModeManager;->setScreenFlushModeLocked(Lcom/android/server/wm/AppWindowToken;I)V
...
.method public systemReady()V
    ...
    invoke-virtual {p0}, Lcom/android/server/wm/WindowManagerService;->updateSizeForResolutionChanged()V
...
.method updateNonSystemOverlayWindowsVisibilityIfNeeded(Lcom/android/server/wm/WindowState;Z)V
    ...
    new-instance v3, Lcom/android/server/wm/-$$Lambda$WindowManagerService$F_wCcJFO8PAVJaPv4jkIVRlsCag;

    invoke-direct {v3, v1}, Lcom/android/server/wm/-$$Lambda$WindowManagerService$F_wCcJFO8PAVJaPv4jkIVRlsCag;-><init>(Z)V
...
.method updateSizeForResolutionChanged()V
    .locals 2
    ...
    sput v0, Lcom/android/server/wm/WindowManagerService;->LIMITED_SCREEN_SIZE:I

    sget v0, Lcom/android/server/wm/WindowManagerService;->MAX_SCREEN_SIZE:I

    sget v1, Lcom/android/server/wm/WindowManagerService;->LIMITED_SCREEN_SIZE:I
