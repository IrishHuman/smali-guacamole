...
.field stackVisibility:Z

.field tmpVisibility:Z
...
.method constructor <init>(Lcom/android/server/wm/WindowManagerService;ILcom/android/server/wm/StackWindowController;)V
    ...
    iput-boolean v0, p0, Lcom/android/server/wm/TaskStack;->stackVisibility:Z

    iput-boolean v0, p0, Lcom/android/server/wm/TaskStack;->tmpVisibility:Z
...
.method public static synthetic lambda$onAppTransitionDone$2(Lcom/android/server/wm/TaskStack;Lcom/android/server/wm/WindowState;)Z
    .locals 1
    ...
    iget-boolean v0, v0, Lcom/android/server/wm/AppWindowToken;->mAppStopped:Z
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;Z)V
    ...
    const-string/jumbo v1, "stackVisibility="

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v1, p0, Lcom/android/server/wm/TaskStack;->stackVisibility:Z
...
.method onAppTransitionDone()V
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/TaskStack;->stackVisibility:Z
    ...
    invoke-virtual {v0, p0}, Lcom/android/server/wm/WindowContainer;->getIndexOfChild(Lcom/android/server/wm/WindowContainer;)I
    ...
    iput-boolean v1, p0, Lcom/android/server/wm/TaskStack;->tmpVisibility:Z

    new-instance v1, Lcom/android/server/wm/-$$Lambda$TaskStack$2BiRRouiGY6xrQCQ-RXE6pCeDeA;

    invoke-direct {v1, p0}, Lcom/android/server/wm/-$$Lambda$TaskStack$2BiRRouiGY6xrQCQ-RXE6pCeDeA;-><init>(Lcom/android/server/wm/TaskStack;)V

    invoke-virtual {p0, v1, v3}, Lcom/android/server/wm/TaskStack;->forAllWindows(Lcom/android/internal/util/ToBooleanFunction;Z)Z

    iget-boolean v1, p0, Lcom/android/server/wm/TaskStack;->stackVisibility:Z

    iget-boolean v2, p0, Lcom/android/server/wm/TaskStack;->tmpVisibility:Z
    ...
    :cond_2
    iget-boolean v1, p0, Lcom/android/server/wm/TaskStack;->tmpVisibility:Z

    iput-boolean v1, p0, Lcom/android/server/wm/TaskStack;->stackVisibility:Z
    ...
    const-string/jumbo v3, "onAppTransitionDone hideElement stack id == "
    ...
    invoke-virtual {v1}, Landroid/view/SurfaceControl;->hideElement()V
