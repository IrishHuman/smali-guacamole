...
.method public constructor <init>(Lcom/android/server/WiredAccessoryManager$WiredAccessoryObserver;Ljava/lang/String;III)V
    ...
    invoke-direct {p0}, Lcom/android/server/WiredAccessoryManager$WiredAccessoryObserver$UEventInfo;->checkDevIndex()V
...
.method private checkDevIndex()V
    .locals 8
    ...
    const-string v4, "/sys/devices/platform/soc/171c0000.slim/tavil-slim-pgd/%s/extcon/extcon%d/name"

    const/4 v5, 0x2

    new-array v5, v5, [Ljava/lang/Object;

    iget-object v6, p0, Lcom/android/server/WiredAccessoryManager$WiredAccessoryObserver$UEventInfo;->mDevName:Ljava/lang/String;
    ...
    :cond_0
    iput v1, p0, Lcom/android/server/WiredAccessoryManager$WiredAccessoryObserver$UEventInfo;->mDevIndex:I
    ...
    const-string/jumbo v2, "not found headset node idx"
