...
.method static synthetic access$1300(Lcom/android/server/LocationManagerService;)Landroid/net/wifi/WifiManager;
    .locals 1
...
.method public delPendingRequest(Ljava/lang/String;I)V
    ...
    iget v3, v2, Lcom/android/server/LocationManagerService$PendingRequest;->mUid:I
    ...
    const-string v5, "delete PendingResuest : "
...
.method public restartPendingResuest(Ljava/lang/String;I)V
    ...
    const-string/jumbo v5, "restartPendingResuest : "
    ...
    iget-object v3, v2, Lcom/android/server/LocationManagerService$PendingRequest;->mRequest:Landroid/location/LocationRequest;

    iget-object v4, v2, Lcom/android/server/LocationManagerService$PendingRequest;->mlistener:Landroid/location/ILocationListener;

    iget-object v5, v2, Lcom/android/server/LocationManagerService$PendingRequest;->mPendingIntent:Landroid/app/PendingIntent;

    iget-object v6, v2, Lcom/android/server/LocationManagerService$PendingRequest;->mPackageNamae:Ljava/lang/String;

    invoke-virtual {p0, v3, v4, v5, v6}, Lcom/android/server/LocationManagerService;->requestLocationUpdates(Landroid/location/LocationRequest;Landroid/location/ILocationListener;Landroid/app/PendingIntent;Ljava/lang/String;)V
...
.method public systemRunning()V
    ...
    invoke-virtual {v2, v4, v3, v1}, Landroid/app/AppOpsManager;->startWatchingMode(ILjava/lang/String;Landroid/app/AppOpsManager$OnOpChangedListener;)V
    ...
    iget-object v5, p0, Lcom/android/server/LocationManagerService;->mActivityManager:Landroid/app/ActivityManager;

    const/16 v6, 0x7d

    invoke-virtual {v5, v3, v6}, Landroid/app/ActivityManager;->addOnUidImportanceListener(Landroid/app/ActivityManager$OnUidImportanceListener;I)V
    ...
    iput-object v5, p0, Lcom/android/server/LocationManagerService;->mUserManager:Landroid/os/UserManager;

    iget v5, p0, Lcom/android/server/LocationManagerService;->mCurrentUserId:I

    invoke-virtual {p0, v5}, Lcom/android/server/LocationManagerService;->updateUserProfiles(I)V
    ...
    invoke-direct {v2, p0, v6}, Lcom/android/server/LocationManagerService$6;-><init>(Lcom/android/server/LocationManagerService;Landroid/os/Handler;)V
    ...
    invoke-direct {v2, p0, v6}, Lcom/android/server/LocationManagerService$7;-><init>(Lcom/android/server/LocationManagerService;Landroid/os/Handler;)V
    ...
    invoke-virtual {v0, v1, v2, v5}, Lcom/android/internal/content/PackageMonitor;->register(Landroid/content/Context;Landroid/os/Looper;Z)V
    ...
    new-instance v7, Lcom/android/server/LocationManagerService$8;

    invoke-direct {v7, p0}, Lcom/android/server/LocationManagerService$8;-><init>(Lcom/android/server/LocationManagerService;)V
