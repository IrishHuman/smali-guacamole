...
.field private mOffScreenSensor:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Lcom/android/server/policy/DeviceKeyHandler;->mOffScreenSensor:Z

    new-instance v2, Lcom/android/server/policy/DeviceKeyHandler$2;

    invoke-direct {v2, p0}, Lcom/android/server/policy/DeviceKeyHandler$2;-><init>(Lcom/android/server/policy/DeviceKeyHandler;)V

    iput-object v2, p0, Lcom/android/server/policy/DeviceKeyHandler;->mPocketListener:Landroid/hardware/SensorEventListener;

    new-instance v2, Lcom/android/server/policy/DeviceKeyHandler$3;

    invoke-direct {v2, p0}, Lcom/android/server/policy/DeviceKeyHandler$3;-><init>(Lcom/android/server/policy/DeviceKeyHandler;)V

    iput-object v2, p0, Lcom/android/server/policy/DeviceKeyHandler;->mProximityListener:Landroid/hardware/SensorEventListener;

    new-instance v2, Lcom/android/server/policy/DeviceKeyHandler$5;

    invoke-direct {v2, p0}, Lcom/android/server/policy/DeviceKeyHandler$5;-><init>(Lcom/android/server/policy/DeviceKeyHandler;)V

    iput-object v2, p0, Lcom/android/server/policy/DeviceKeyHandler;->mTorchCallback:Landroid/hardware/camera2/CameraManager$TorchCallback;
    ...
    iput-object v2, p0, Lcom/android/server/policy/DeviceKeyHandler;->mPowerManager:Landroid/os/PowerManager;

    new-instance v2, Lcom/android/server/policy/DeviceKeyHandler$EventHandler;

    const/4 v3, 0x0

    invoke-direct {v2, p0, v3}, Lcom/android/server/policy/DeviceKeyHandler$EventHandler;-><init>(Lcom/android/server/policy/DeviceKeyHandler;Lcom/android/server/policy/DeviceKeyHandler$1;)V

    iput-object v2, p0, Lcom/android/server/policy/DeviceKeyHandler;->mEventHandler:Lcom/android/server/policy/DeviceKeyHandler$EventHandler;
    ...
    iput-object v2, p0, Lcom/android/server/policy/DeviceKeyHandler;->mSensorManager:Landroid/hardware/SensorManager;
    ...
    iput-boolean v1, p0, Lcom/android/server/policy/DeviceKeyHandler;->mOffScreenSensor:Z
...
.method static synthetic access$400(Lcom/android/server/policy/DeviceKeyHandler;)Z
    .locals 1

    iget-boolean v0, p0, Lcom/android/server/policy/DeviceKeyHandler;->mSleeping:Z

    return v0
.end method

.method static synthetic access$500(Lcom/android/server/policy/DeviceKeyHandler;)Landroid/os/Handler;
    .locals 1
...
.method static synthetic access$700(Lcom/android/server/policy/DeviceKeyHandler;)Ljava/lang/Object;
    .locals 1
...
.method private performPrioritySceneVibration()V
    .locals 1

    const/4 v0, 0x1

    invoke-direct {p0, v0}, Lcom/android/server/policy/DeviceKeyHandler;->performPrioritySceneVibration(Z)V

    return-void
.end method

.method private performPrioritySceneVibration(Z)V
    .locals 3

    iget-object v0, p0, Lcom/android/server/policy/DeviceKeyHandler;->mContext:Landroid/content/Context;

    iget-object v1, p0, Lcom/android/server/policy/DeviceKeyHandler;->mVibrator:Landroid/os/Vibrator;
    ...
    invoke-direct {p0, p1}, Lcom/android/server/policy/DeviceKeyHandler;->performVibration(Z)V
...
.method private processKeyEvent()V
    ...
    invoke-direct {p0}, Lcom/android/server/policy/DeviceKeyHandler;->performPrioritySceneVibration()V
    ...
    const-string v12, "android.policy:DOUBLE_TAP"

    invoke-virtual {v4, v10, v11, v12}, Landroid/os/PowerManager;->wakeUp(JLjava/lang/String;)V
    ...
    new-instance v6, Lcom/android/server/policy/DeviceKeyHandler$4;

    invoke-direct {v6, p0}, Lcom/android/server/policy/DeviceKeyHandler$4;-><init>(Lcom/android/server/policy/DeviceKeyHandler;)V
    ...
    invoke-direct {p0, v2}, Lcom/android/server/policy/DeviceKeyHandler;->performPrioritySceneVibration(Z)V
...
.method private startApp(Ljava/lang/String;IZ)Z
    ...
    const-string/jumbo v2, "launch_from"

    const-string/jumbo v3, "screen_off_gesture"
...
.method onScreenTurnedOff()V
    ...
    iget-boolean v0, p0, Lcom/android/server/policy/DeviceKeyHandler;->mOffScreenSensor:Z
...
.method onScreenTurningOn()V
    ...
    iget-boolean v1, p0, Lcom/android/server/policy/DeviceKeyHandler;->mSensorEnabled:Z

    if-eqz v1, :cond_0

    iget-boolean v1, p0, Lcom/android/server/policy/DeviceKeyHandler;->mOffScreenSensor:Z
    ...
    new-instance v1, Lcom/android/server/policy/DeviceKeyHandler$1;

    invoke-direct {v1, p0}, Lcom/android/server/policy/DeviceKeyHandler$1;-><init>(Lcom/android/server/policy/DeviceKeyHandler;)V
