...
.method static constructor <clinit>()V
    ...
    const-string v4, "com.oem.autotest"

    const-string v5, "com.oneplus.factorymode"

    const-string v6, "com.synaptics.forcebuttontest"

    const-string v7, "com.oneplus.aod"
    ...
    sput-object v2, Lcom/android/server/policy/PhoneWindowManager;->DISABLE_IMMERSIVE_MODE_CONFIRM_LIST:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    iput v1, p0, Lcom/android/server/policy/PhoneWindowManager;->mLastNavigationBar:I
    ...
    iput-object v2, p0, Lcom/android/server/policy/PhoneWindowManager;->mUpdateRotationTrueRunnable:Ljava/lang/Runnable;

    const/4 v2, 0x1

    iput-boolean v2, p0, Lcom/android/server/policy/PhoneWindowManager;->mLockSensorForAppLaunched:Z

    new-instance v3, Ljava/lang/Object;

    invoke-direct {v3}, Ljava/lang/Object;-><init>()V

    iput-object v3, p0, Lcom/android/server/policy/PhoneWindowManager;->mLock:Ljava/lang/Object;

    const/4 v3, 0x0

    iput-object v3, p0, Lcom/android/server/policy/PhoneWindowManager;->mPerfBoostDrag:Landroid/util/BoostFramework;

    iput-object v3, p0, Lcom/android/server/policy/PhoneWindowManager;->mPerfBoostFling:Landroid/util/BoostFramework;

    iput-object v3, p0, Lcom/android/server/policy/PhoneWindowManager;->mPerfBoostPrefling:Landroid/util/BoostFramework;

    new-instance v4, Ljava/lang/Object;

    invoke-direct {v4}, Ljava/lang/Object;-><init>()V

    iput-object v4, p0, Lcom/android/server/policy/PhoneWindowManager;->mServiceAquireLock:Ljava/lang/Object;
    ...
    iput-object v3, p0, Lcom/android/server/policy/PhoneWindowManager;->mStatusBar:Lcom/android/server/policy/WindowManagerPolicy$WindowState;
    ...
    iput-object v3, p0, Lcom/android/server/policy/PhoneWindowManager;->mNavigationBar:Lcom/android/server/policy/WindowManagerPolicy$WindowState;

    iput-boolean v0, p0, Lcom/android/server/policy/PhoneWindowManager;->mHasNavigationBar:Z

    iput-boolean v0, p0, Lcom/android/server/policy/PhoneWindowManager;->mHideNavigationBar:Z
    ...
    iput-object v3, p0, Lcom/android/server/policy/PhoneWindowManager;->mLastInputMethodWindow:Lcom/android/server/policy/WindowManagerPolicy$WindowState;

    iput-object v3, p0, Lcom/android/server/policy/PhoneWindowManager;->mLastInputMethodTargetWindow:Lcom/android/server/policy/WindowManagerPolicy$WindowState;
    ...
    iput-object v3, p0, Lcom/android/server/policy/PhoneWindowManager;->mInputConsumer:Lcom/android/server/policy/WindowManagerPolicy$InputConsumer;
    ...
    iput v1, p0, Lcom/android/server/policy/PhoneWindowManager;->mQuickPayWhich:I
    ...
    invoke-direct {v2, v4, v0}, Lcom/android/server/policy/LogDecelerateInterpolator;-><init>(II)V
    ...
    invoke-direct {v2, v0}, Landroid/util/MutableBoolean;-><init>(Z)V

    iput-object v2, p0, Lcom/android/server/policy/PhoneWindowManager;->mTmpBoolean:Landroid/util/MutableBoolean;

    iput-boolean v0, p0, Lcom/android/server/policy/PhoneWindowManager;->mWifiDisplayConnected:Z

    iput v1, p0, Lcom/android/server/policy/PhoneWindowManager;->mWifiDisplayCustomRotation:I

    iput-boolean v0, p0, Lcom/android/server/policy/PhoneWindowManager;->mPowerKeyAssistantEnable:Z
    ...
    invoke-direct {v1, p0}, Lcom/android/server/policy/PhoneWindowManager$ScreenshotRunnable;-><init>(Lcom/android/server/policy/PhoneWindowManager;)V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/server/policy/PhoneWindowManager$21;-><init>(Lcom/android/server/policy/PhoneWindowManager;Landroid/os/Looper;)V
...
.method static synthetic access$4700()Landroid/hardware/SensorManager;
    .locals 1
...
.method static synthetic access$4702(Landroid/hardware/SensorManager;)Landroid/hardware/SensorManager;
    .locals 0
...
.method static synthetic access$4800(Lcom/android/server/policy/PhoneWindowManager;Z)V
    .locals 0
...
.method private getVibrationEffect(I)Landroid/os/VibrationEffect;
    ...
    const-string/jumbo v2, "getVibrationEffect: effectId("
...
.method private getVibratorSceneEffectId(I)I
    .locals 4
    ...
    :sswitch_4
    iget-object v1, p0, Lcom/android/server/policy/PhoneWindowManager;->mPowerKeyWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    const-string/jumbo v3, "getVibratorSceneEffectId: effectId("
...
.method private layoutNavigationBar(Lcom/android/server/wm/DisplayFrames;ILandroid/graphics/Rect;ZZZZ)Z
    ...
    iget-object v5, v0, Lcom/android/server/policy/PhoneWindowManager;->mFocusedWindow:Lcom/android/server/policy/WindowManagerPolicy$WindowState;

    invoke-virtual {v0, v5}, Lcom/android/server/policy/PhoneWindowManager;->isHomeApp(Lcom/android/server/policy/WindowManagerPolicy$WindowState;)Z
...
.method private powerLongPressWithAssistant()V
    ...
    sget-object v0, Lcom/android/server/policy/PhoneWindowManager;->POWER_LONG_PRESS_WITH_GOOGLE_ASSISTANT_HINT:Ljava/lang/String;

    iget v2, p0, Lcom/android/server/policy/PhoneWindowManager;->mTmpDeviceId:I

    invoke-virtual {p0, v0, v2}, Lcom/android/server/policy/PhoneWindowManager;->launchAssistAction(Ljava/lang/String;I)V
    ...
    :cond_6
    sget-object v0, Lcom/android/server/policy/PhoneWindowManager;->POWER_LONG_PRESS_WITH_ASSISTANT_HINT:Ljava/lang/String;
...
.method private stopLongshot()V
    ...
    invoke-interface {v0, v1}, Lcom/oneplus/longshot/ILongScreenshotManager;->stopLongshot(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private updateSystemBarsLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;II)I
    ...
    sget-object v2, Lcom/android/server/policy/PhoneWindowManager;->DISABLE_IMMERSIVE_MODE_CONFIRM_LIST:Ljava/util/List;
    ...
    iget-object v7, v0, Lcom/android/server/policy/PhoneWindowManager;->mImmersiveModeConfirmation:Lcom/android/server/policy/ImmersiveModeConfirmation;
    ...
    invoke-static {v9}, Lcom/android/server/policy/PhoneWindowManager;->isNavBarEmpty(I)Z

    move-result v9

    invoke-virtual {v7, v5, v6, v8, v9}, Lcom/android/server/policy/ImmersiveModeConfirmation;->immersiveModeChangedLw(Ljava/lang/String;ZZZ)V
    ...
    iget v9, v0, Lcom/android/server/policy/PhoneWindowManager;->mNavigationBarPosition:I

    invoke-static {v5, v7, v8, v9}, Lcom/android/server/policy/PhoneWindowManager;->chooseNavigationColorWindowLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Lcom/android/server/policy/WindowManagerPolicy$WindowState;Lcom/android/server/policy/WindowManagerPolicy$WindowState;I)Lcom/android/server/policy/WindowManagerPolicy$WindowState;

    move-result-object v5

    iget-object v7, v0, Lcom/android/server/policy/PhoneWindowManager;->mTopFullscreenOpaqueWindowState:Lcom/android/server/policy/WindowManagerPolicy$WindowState;

    iget-object v8, v0, Lcom/android/server/policy/PhoneWindowManager;->mTopFullscreenOpaqueOrDimmingWindowState:Lcom/android/server/policy/WindowManagerPolicy$WindowState;

    iget-object v9, v0, Lcom/android/server/policy/PhoneWindowManager;->mWindowManagerFuncs:Lcom/android/server/policy/WindowManagerPolicy$WindowManagerFuncs;

    invoke-interface {v9}, Lcom/android/server/policy/WindowManagerPolicy$WindowManagerFuncs;->getInputMethodWindowLw()Lcom/android/server/policy/WindowManagerPolicy$WindowState;

    move-result-object v9

    invoke-static {v4, v7, v8, v9, v5}, Lcom/android/server/policy/PhoneWindowManager;->updateLightNavigationBarLw(ILcom/android/server/policy/WindowManagerPolicy$WindowState;Lcom/android/server/policy/WindowManagerPolicy$WindowState;Lcom/android/server/policy/WindowManagerPolicy$WindowState;Lcom/android/server/policy/WindowManagerPolicy$WindowState;)I
...
.method private updateSystemUiVisibilityLw()I
    ...
    invoke-direct/range {v0 .. v8}, Lcom/android/server/policy/PhoneWindowManager$24;-><init>(Lcom/android/server/policy/PhoneWindowManager;IIILandroid/graphics/Rect;Landroid/graphics/Rect;Lcom/android/server/policy/WindowManagerPolicy$WindowState;Z)V
...
.method public finishPostLayoutPolicyLw()I
    ...
    sget-boolean v8, Lcom/android/server/policy/PhoneWindowManager;->DEBUG_ONEPLUS:Z

    if-eqz v8, :cond_8

    const-string v8, "WindowManager"

    const-string v9, "QuickReply: mForceStatusBar to false"
    ...
    const-string v9, "QuickReply: statusBarExpanded to false"
    ...
    invoke-virtual {v8, v5, v9, v10}, Lcom/android/server/policy/StatusBarController;->updateVisibilityLw(ZII)I
    ...
    iget-object v8, p0, Lcom/android/server/policy/PhoneWindowManager;->mFocusedWindow:Lcom/android/server/policy/WindowManagerPolicy$WindowState;
...
.method public focusChangedLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Lcom/android/server/policy/WindowManagerPolicy$WindowState;)I
    ...
    invoke-static {v1}, Lcom/oneplus/longshot/ILongScreenshotManager$Stub;->asInterface(Landroid/os/IBinder;)Lcom/oneplus/longshot/ILongScreenshotManager;
    ...
    invoke-interface {v2}, Lcom/android/server/policy/WindowManagerPolicy$WindowState;->longshotStop()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :cond_4
    sget-boolean v1, Lcom/android/server/policy/PhoneWindowManager;->mIsCustomFP:Z

    if-eqz v1, :cond_6

    iget-boolean v1, p0, Lcom/android/server/policy/PhoneWindowManager;->mIsFingerprintEnabled:Z
    ...
    const-string v3, "FP_ACCELERATE: transition/occluded changed occluded="
    ...
    invoke-direct {p0, v1, v0}, Lcom/android/server/policy/PhoneWindowManager;->setKeyguardOccludedLw(ZZ)Z
...
.method public init(Landroid/content/Context;Landroid/view/IWindowManager;Lcom/android/server/policy/WindowManagerPolicy$WindowManagerFuncs;)V
    ...
    new-instance v3, Lcom/android/server/oneplus/gamevibrate/OPGameVibrateManager;

    invoke-direct {v3}, Lcom/android/server/oneplus/gamevibrate/OPGameVibrateManager;-><init>()V

    invoke-interface {v2, v3}, Lcom/android/server/policy/WindowManagerPolicy$WindowManagerFuncs;->registerPointerEventListener(Landroid/view/WindowManagerPolicyConstants$PointerEventListener;)V

    :cond_9
    const-string/jumbo v2, "persist.Pwm.SCREENSHOT_CHORD_DEBOUNCE_DELAY_MILLIS"
    ...
    const-string/jumbo v2, "persist.Pwm.SCREENSHOT_CHORD_DEBOUNCE_DELAY_MILLIS_Power"
    ...
    const-string/jumbo v2, "persist.Pwm.DOUBLE_CLICK_VOLUME_DEBOUNCE_DELAY_MILLIS"

    sget-wide v3, Lcom/android/server/policy/PhoneWindowManager;->DOUBLE_CLICK_VOLUME_DEBOUNCE_DELAY_MILLIS:J
...
.method public interceptKeyBeforeDispatching(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)J
    ...
    const-string v9, "[Accessibility] isAccessibilityShortcutAvailable"
    ...
    iget-boolean v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mScreenshotChordVolumeDownKeyConsumed:Z
    ...
    iget-boolean v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mA11yShortcutChordVolumeUpKeyConsumed:Z
    ...
    const-string v3, "[Accessibility] pass Accessibility check"

    invoke-static {v2, v3}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mRingerToggleChord:I
    ...
    iget-boolean v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mA11yShortcutChordVolumeUpKeyTriggered:Z

    if-eqz v2, :cond_12

    iget-boolean v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mScreenshotChordPowerKeyTriggered:Z
    ...
    sget-wide v12, Lcom/android/server/policy/PhoneWindowManager;->SCREENSHOT_CHORD_DEBOUNCE_DELAY_MILLIS:J
    ...
    :cond_14
    iget-boolean v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mPendingMetaAction:Z
    ...
    :cond_15
    iget-boolean v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mPendingCapsLockToggle:Z
    ...
    invoke-virtual {v13, v15}, Landroid/hardware/input/InputManagerInternal;->toggleCapsLock(I)V
    ...
    const-string v15, "Dropping shortcut key combination because the activity to which it is registered was not found: SEARCH+"
    ...
    invoke-static {v0, v12}, Landroid/view/KeyEvent;->metaStateHasModifiers(II)Z
    ...
    invoke-direct {v1, v9}, Lcom/android/server/policy/PhoneWindowManager;->showRecentApps(Z)V
    ...
    invoke-direct {v1, v12, v9}, Lcom/android/server/policy/PhoneWindowManager;->hideRecentApps(ZZ)V
    ...
    invoke-interface {v9, v12, v0}, Lcom/android/server/policy/WindowManagerPolicy$WindowManagerFuncs;->switchKeyboardLayout(II)V
    ...
    invoke-interface {v9, v0}, Lcom/android/server/policy/WindowManagerPolicy$WindowManagerFuncs;->switchInputMethod(Z)V
    ...
    :cond_53
    iget-boolean v9, v1, Lcom/android/server/policy/PhoneWindowManager;->mLanguageSwitchKeyPressed:Z
    ...
    iput-boolean v9, v1, Lcom/android/server/policy/PhoneWindowManager;->mLanguageSwitchKeyPressed:Z
    ...
    invoke-virtual {v0, v9, v4, v3}, Lcom/android/server/policy/GlobalKeyManager;->handleGlobalKey(Landroid/content/Context;ILandroid/view/KeyEvent;)Z
    ...
    check-cast v9, Lcom/android/internal/policy/IShortcutService;
    ...
    invoke-interface {v9, v12, v13}, Lcom/android/internal/policy/IShortcutService;->notifyShortcutKeyPressed(J)V
    :try_end_4
    ...
    invoke-static {v8, v9, v13, v12}, Landroid/provider/Settings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
...
.method public interceptKeyBeforeQueueing(Landroid/view/KeyEvent;I)I
    ...
    iput-wide v4, v1, Lcom/android/server/policy/PhoneWindowManager;->mDoubleClickVolumeKeyReleaseTime:J
...
.method public layoutWindowLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Lcom/android/server/policy/WindowManagerPolicy$WindowState;Lcom/android/server/wm/DisplayFrames;)V
    ...
    sget-object v21, Lcom/android/server/wm/utils/WmDisplayCutout;->NO_CUTOUT:Lcom/android/server/wm/utils/WmDisplayCutout;
    ...
    iget-object v9, v10, Lcom/android/server/wm/DisplayFrames;->mDisplayCutout:Lcom/android/server/wm/utils/WmDisplayCutout;
    ...
    invoke-direct {v12, v0, v1}, Lcom/android/server/policy/PhoneWindowManager;->offsetInputMethodWindowLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Lcom/android/server/wm/DisplayFrames;)V
    ...
    invoke-direct {v12, v0, v1}, Lcom/android/server/policy/PhoneWindowManager;->offsetVoiceInputWindowLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Lcom/android/server/wm/DisplayFrames;)V
...
.method public onLongshotStart()V
    ...
    const-string/jumbo v1, "longshotStart"
    ...
    invoke-interface {v0}, Lcom/android/server/policy/WindowManagerPolicy$WindowState;->longshotStart()V
    ...
    invoke-interface {v0, v1}, Lcom/oneplus/longshot/ILongScreenshotManager;->notifyWindowLayerChange(Landroid/os/IBinder;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public performHapticFeedbackLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;IZ)Z
    ...
    :goto_1
    invoke-direct {p0, p2}, Lcom/android/server/policy/PhoneWindowManager;->getVibratorSceneEffectId(I)I

    move-result v5

    iget-object v6, p0, Lcom/android/server/policy/PhoneWindowManager;->mContext:Landroid/content/Context;

    iget-object v7, p0, Lcom/android/server/policy/PhoneWindowManager;->mVibrator:Landroid/os/Vibrator;

    invoke-static {v6, v7, v5}, Lcom/oneplus/util/VibratorSceneUtils;->doVibrateWithSceneIfNeeded(Landroid/content/Context;Landroid/os/Vibrator;I)Z

    move-result v6

    if-nez v6, :cond_5

    iget-object v6, p0, Lcom/android/server/policy/PhoneWindowManager;->mVibrator:Landroid/os/Vibrator;

    sget-object v7, Lcom/android/server/policy/PhoneWindowManager;->VIBRATION_ATTRIBUTES:Landroid/media/AudioAttributes;

    invoke-virtual {v6, v1, v4, v3, v7}, Landroid/os/Vibrator;->vibrate(ILjava/lang/String;Landroid/os/VibrationEffect;Landroid/media/AudioAttributes;)V
...
.method public updateSettings()V
    ...
    iget-boolean v8, p0, Lcom/android/server/policy/PhoneWindowManager;->mHasNavigationBar:Z
