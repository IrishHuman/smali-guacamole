...
.field private static isBlock:Z
...
.field private gl:Lcom/android/server/OemSceneButtonController$GestureButtonBlockListener;
...
.field private osbc:Lcom/android/server/OemSceneButtonController;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v2, Lcom/android/server/policy/OemGestureButton;->isBlock:Z
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/policy/PhoneWindowManager;)V
    ...
    iput-object v2, v0, Lcom/android/server/policy/OemGestureButton;->gl:Lcom/android/server/OemSceneButtonController$GestureButtonBlockListener;

    iput-object v2, v0, Lcom/android/server/policy/OemGestureButton;->osbc:Lcom/android/server/OemSceneButtonController;

    new-instance v2, Lcom/android/server/policy/OemGestureButton$6;

    invoke-direct {v2, v0}, Lcom/android/server/policy/OemGestureButton$6;-><init>(Lcom/android/server/policy/OemGestureButton;)V

    iput-object v2, v0, Lcom/android/server/policy/OemGestureButton;->mTouchListener:Landroid/view/View$OnTouchListener;

    const-string v2, "OemGestureButton"

    const-string v3, "OemGestureButton init"

    invoke-static {v2, v3}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    move-object/from16 v2, p1

    iput-object v2, v0, Lcom/android/server/policy/OemGestureButton;->mContext:Landroid/content/Context;

    move-object/from16 v3, p2

    iput-object v3, v0, Lcom/android/server/policy/OemGestureButton;->mPwm:Lcom/android/server/policy/PhoneWindowManager;
    ...
    iput v5, v0, Lcom/android/server/policy/OemGestureButton;->mScreenHeight:I
    ...
    iput v5, v0, Lcom/android/server/policy/OemGestureButton;->mScreenWidth:I

    const/16 v5, 0x32

    iput v5, v0, Lcom/android/server/policy/OemGestureButton;->mSwipeStartThreshold:I

    const/16 v5, 0x40

    iput v5, v0, Lcom/android/server/policy/OemGestureButton;->mEffectHeight:I

    new-instance v5, Landroid/os/HandlerThread;

    const-string v6, "OemGestureButtonThread"
    ...
    new-instance v6, Lcom/android/server/policy/OemGestureButton$OemGestureButtonHandler;

    invoke-virtual {v5}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v8

    invoke-direct {v6, v0, v8}, Lcom/android/server/policy/OemGestureButton$OemGestureButtonHandler;-><init>(Lcom/android/server/policy/OemGestureButton;Landroid/os/Looper;)V

    iput-object v6, v0, Lcom/android/server/policy/OemGestureButton;->mOemGestureButtonHandler:Lcom/android/server/policy/OemGestureButton$OemGestureButtonHandler;

    new-instance v6, Landroid/os/HandlerThread;

    const-string v8, "OemGestureBtnRegionThread"

    invoke-direct {v6, v8, v7}, Landroid/os/HandlerThread;-><init>(Ljava/lang/String;I)V

    invoke-virtual {v6}, Landroid/os/HandlerThread;->start()V

    new-instance v8, Lcom/android/server/policy/OemGestureButton$OemGestureButtonHandler;

    invoke-virtual {v6}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v9

    invoke-direct {v8, v0, v9}, Lcom/android/server/policy/OemGestureButton$OemGestureButtonHandler;-><init>(Lcom/android/server/policy/OemGestureButton;Landroid/os/Looper;)V

    iput-object v8, v0, Lcom/android/server/policy/OemGestureButton;->mOemGestureBtnRegionHandler:Lcom/android/server/policy/OemGestureButton$OemGestureButtonHandler;

    new-instance v8, Landroid/os/HandlerThread;

    const-string v9, "OemGestureBtnAnimThread"

    invoke-direct {v8, v9, v7}, Landroid/os/HandlerThread;-><init>(Ljava/lang/String;I)V
    ...
    iput-object v8, v0, Lcom/android/server/policy/OemGestureButton;->mOemGestureButtonAnimHandler:Lcom/android/server/policy/OemGestureButton$OemGestureButtonHandler;
    ...
    iput-object v8, v0, Lcom/android/server/policy/OemGestureButton;->mWindowLayoutParams:Landroid/view/WindowManager$LayoutParams;

    iget-object v8, v0, Lcom/android/server/policy/OemGestureButton;->mWindowLayoutParams:Landroid/view/WindowManager$LayoutParams;
    ...
    iput v10, v8, Landroid/view/WindowManager$LayoutParams;->windowAnimations:I

    iget-object v8, v0, Lcom/android/server/policy/OemGestureButton;->mWindowLayoutParams:Landroid/view/WindowManager$LayoutParams;

    const-string v10, "GestureScreenshot"
    ...
    iget-object v8, v0, Lcom/android/server/policy/OemGestureButton;->mPwm:Lcom/android/server/policy/PhoneWindowManager;

    iget-object v8, v8, Lcom/android/server/policy/PhoneWindowManager;->mWindowManagerInternal:Lcom/android/server/wm/WindowManagerInternal;

    new-instance v10, Lcom/android/server/policy/OemGestureButton$1;

    invoke-direct {v10, v0}, Lcom/android/server/policy/OemGestureButton$1;-><init>(Lcom/android/server/policy/OemGestureButton;)V

    invoke-virtual {v8, v10}, Lcom/android/server/wm/WindowManagerInternal;->registerAppTransitionListener(Lcom/android/server/wm/WindowManagerInternal$AppTransitionListener;)V
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/server/policy/OemGestureButton;->tryToRegistGestureButtonBlockListener()V

    iget-object v1, v0, Lcom/android/server/policy/OemGestureButton;->gl:Lcom/android/server/OemSceneButtonController$GestureButtonBlockListener;

    if-nez v1, :cond_0

    iget-object v1, v0, Lcom/android/server/policy/OemGestureButton;->mOemGestureButtonHandler:Lcom/android/server/policy/OemGestureButton$OemGestureButtonHandler;

    const/4 v8, 0x3

    const-wide/16 v9, 0x1388

    invoke-virtual {v1, v8, v9, v10}, Lcom/android/server/policy/OemGestureButton$OemGestureButtonHandler;->sendEmptyMessageDelayed(IJ)Z
...
.method static synthetic access$1000(Lcom/android/server/policy/OemGestureButton;)I
    .locals 1
...
.method static synthetic access$1100(Lcom/android/server/policy/OemGestureButton;Landroid/widget/ImageView;)V
    .locals 0
...
.method static synthetic access$1200(Lcom/android/server/policy/OemGestureButton;I)V
    .locals 0
...
.method static synthetic access$1300(Lcom/android/server/policy/OemGestureButton;)I
    .locals 1
...
.method static synthetic access$1502(Lcom/android/server/policy/OemGestureButton;Z)Z
    .locals 0
...
.method static synthetic access$1600(Lcom/android/server/policy/OemGestureButton;)Z
    .locals 1
...
.method static synthetic access$1700(Lcom/android/server/policy/OemGestureButton;)V
    .locals 0
...
.method static synthetic access$1800(Lcom/android/server/policy/OemGestureButton;)I
    .locals 1
...
.method static synthetic access$1900(Lcom/android/server/policy/OemGestureButton;)F
    .locals 1
...
.method static synthetic access$1902(Lcom/android/server/policy/OemGestureButton;F)F
    .locals 0
...
.method static synthetic access$2000(Lcom/android/server/policy/OemGestureButton;)I
    .locals 1
...
.method static synthetic access$2100(Lcom/android/server/policy/OemGestureButton;)F
    .locals 1
...
.method static synthetic access$2102(Lcom/android/server/policy/OemGestureButton;F)F
    .locals 0
...
.method static synthetic access$2200(Lcom/android/server/policy/OemGestureButton;IIFF)V
    .locals 0
...
.method static synthetic access$2300(Lcom/android/server/policy/OemGestureButton;)V
    .locals 0
...
.method static synthetic access$2500(Lcom/android/server/policy/OemGestureButton;)F
    .locals 1
...
.method static synthetic access$2600(Lcom/android/server/policy/OemGestureButton;)Z
    .locals 1
...
.method static synthetic access$2700(Lcom/android/server/policy/OemGestureButton;Lcom/android/server/policy/WindowManagerPolicy$WindowState;)Z
    .locals 1
...
.method static synthetic access$2800(Lcom/android/server/policy/OemGestureButton;)Landroid/view/WindowManager;
    .locals 1
...
.method static synthetic access$2900(Lcom/android/server/policy/OemGestureButton;)V
    .locals 0
...
.method static synthetic access$3000(Lcom/android/server/policy/OemGestureButton;Landroid/widget/ImageView;)V
    .locals 0
...
.method static synthetic access$3100(Lcom/android/server/policy/OemGestureButton;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/server/policy/OemGestureButton;->registGListener()V
...
.method static synthetic access$400()Z
    ...
    sget-boolean v0, Lcom/android/server/policy/OemGestureButton;->isBlock:Z
...
.method static synthetic access$402(Z)Z
    ...
    sput-boolean p0, Lcom/android/server/policy/OemGestureButton;->isBlock:Z
...
.method static synthetic access$600(Lcom/android/server/policy/OemGestureButton;)Landroid/view/animation/Animation;
    .locals 1
...
.method static synthetic access$700(Lcom/android/server/policy/OemGestureButton;Landroid/view/MotionEvent;)V
    .locals 0
...
.method static synthetic access$800(Lcom/android/server/policy/OemGestureButton;)I
    .locals 1
...
.method static synthetic access$802(Lcom/android/server/policy/OemGestureButton;I)I
    .locals 0
...
.method static synthetic access$808(Lcom/android/server/policy/OemGestureButton;)I
    .locals 2
...
.method private handleTouch(Landroid/view/MotionEvent;)V
    ...
    :cond_0
    sget-boolean v2, Lcom/android/server/policy/OemGestureButton;->isBlock:Z
    ...
    new-instance v9, Lcom/android/server/policy/OemGestureButton$5;

    invoke-direct {v9, v0}, Lcom/android/server/policy/OemGestureButton$5;-><init>(Lcom/android/server/policy/OemGestureButton;)V
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/server/policy/OemGestureButton;->isStatusBarExpandedNotKeyguard()Z
    ...
    const-string v7, "Skip Gesture for StatusBar expanded, mPreparedKeycode="

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v7, v0, Lcom/android/server/policy/OemGestureButton;->mPreparedKeycode:I
...
.method private isStatusBarExpandedNotKeyguard()Z
    .locals 3
    ...
    invoke-virtual {v1}, Lcom/android/server/policy/PhoneWindowManager;->isKeyguardOccluded()Z
...
.method private registGListener()V
    .locals 4
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/policy/OemGestureButton$OemGestureButtonHandler;->hasMessages(I)Z
    ...
    :cond_0
    invoke-direct {p0}, Lcom/android/server/policy/OemGestureButton;->tryToRegistGestureButtonBlockListener()V

    iget-object v0, p0, Lcom/android/server/policy/OemGestureButton;->gl:Lcom/android/server/OemSceneButtonController$GestureButtonBlockListener;
...
.method private tryToRegistGestureButtonBlockListener()V
    .locals 2

    iget-object v0, p0, Lcom/android/server/policy/OemGestureButton;->mContext:Landroid/content/Context;

    invoke-static {v0}, Lcom/android/server/OemSceneButtonController;->getInstance(Landroid/content/Context;)Lcom/android/server/OemSceneButtonController;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/policy/OemGestureButton;->osbc:Lcom/android/server/OemSceneButtonController;

    iget-object v0, p0, Lcom/android/server/policy/OemGestureButton;->osbc:Lcom/android/server/OemSceneButtonController;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/server/policy/OemGestureButton;->osbc:Lcom/android/server/OemSceneButtonController;

    new-instance v1, Lcom/android/server/policy/OemGestureButton$4;

    invoke-direct {v1, p0}, Lcom/android/server/policy/OemGestureButton$4;-><init>(Lcom/android/server/policy/OemGestureButton;)V

    iput-object v1, p0, Lcom/android/server/policy/OemGestureButton;->gl:Lcom/android/server/OemSceneButtonController$GestureButtonBlockListener;

    invoke-virtual {v0, v1}, Lcom/android/server/OemSceneButtonController;->registerGestureButtonBlockListener(Lcom/android/server/OemSceneButtonController$GestureButtonBlockListener;)V
...
.method preloadWallapepr(Landroid/graphics/Bitmap;)V
    ...
    invoke-direct {v2, p0, v0}, Lcom/android/server/policy/OemGestureButton$7;-><init>(Lcom/android/server/policy/OemGestureButton;Landroid/graphics/Bitmap;)V
...
.method preloadWallapepr(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Landroid/view/WindowManager$LayoutParams;)V
    ...
    new-instance v2, Lcom/android/server/policy/OemGestureButton$8;

    invoke-direct {v2, p0}, Lcom/android/server/policy/OemGestureButton$8;-><init>(Lcom/android/server/policy/OemGestureButton;)V
