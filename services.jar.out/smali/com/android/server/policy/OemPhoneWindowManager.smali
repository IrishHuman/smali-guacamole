...
.field private static final KEY_SCANCODE_F13:I = 0xb7

.field private static final KEY_SCANCODE_F14:I = 0xb8

.field private static final KEY_SCANCODE_F15:I = 0xb9

.field private static final KEY_SCANCODE_F16:I = 0xba

.field private static final KEY_SCANCODE_F17:I = 0xbb

.field private static final KEY_SCANCODE_F18:I = 0xbc

.field private static final KEY_SCANCODE_F19:I = 0xbd

.field private static final KEY_SCANCODE_F20:I = 0xbe
...
.field private mTwoPointerDetectionRegistered:Z

.field private mTwoPointersDetectionListener:Lcom/android/server/policy/OemTwoPointersDetectionListener;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/policy/OemPhoneWindowManager;->mLock:Ljava/lang/Object;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/policy/OemPhoneWindowManager;->mTwoPointersDetectionListener:Lcom/android/server/policy/OemTwoPointersDetectionListener;
...
.method static synthetic access$1500(Lcom/android/server/policy/OemPhoneWindowManager;)Lcom/android/server/policy/OemTwoPointersDetectionListener;
    .locals 1

    iget-object v0, p0, Lcom/android/server/policy/OemPhoneWindowManager;->mTwoPointersDetectionListener:Lcom/android/server/policy/OemTwoPointersDetectionListener;
...
.method static synthetic access$1600(Lcom/android/server/policy/OemPhoneWindowManager;)Z
    ...
    iget-boolean v0, p0, Lcom/android/server/policy/OemPhoneWindowManager;->mTwoPointerDetectionRegistered:Z
...
.method static synthetic access$1602(Lcom/android/server/policy/OemPhoneWindowManager;Z)Z
    ...
    iput-boolean p1, p0, Lcom/android/server/policy/OemPhoneWindowManager;->mTwoPointerDetectionRegistered:Z

    return p1
.end method

.method static synthetic access$1700(Lcom/android/server/policy/OemPhoneWindowManager;)Lcom/android/server/policy/OemThreePointersGesturesListener;
    .locals 1
...
.method static synthetic access$1800(Lcom/android/server/policy/OemPhoneWindowManager;)Z
    .locals 1
...
.method static synthetic access$1900(Lcom/android/server/policy/OemPhoneWindowManager;)Lcom/android/server/policy/OemPhoneWindowManager$PolicyHandler;
    .locals 1
...
.method static synthetic access$2000(Lcom/android/server/policy/OemPhoneWindowManager;IZZ)V
    .locals 0
...
.method static synthetic access$2200(Lcom/android/server/policy/OemPhoneWindowManager;)V
    .locals 0
...
.method static synthetic access$2400(Lcom/android/server/policy/OemPhoneWindowManager;Lorg/json/JSONArray;)V
    .locals 0
...
.method static synthetic access$2600(Lcom/android/server/policy/OemPhoneWindowManager;ILandroid/view/KeyEvent;)V
    .locals 0
...
.method static synthetic access$2702(Lcom/android/server/policy/OemPhoneWindowManager;Z)Z
    .locals 0
...
.method static synthetic access$2800(Lcom/android/server/policy/OemPhoneWindowManager;)Z
    .locals 1
...
.method static synthetic access$2802(Lcom/android/server/policy/OemPhoneWindowManager;Z)Z
    .locals 0
...
.method static synthetic access$3000(Lcom/android/server/policy/OemPhoneWindowManager;)Ljava/util/ArrayList;
    .locals 1
...
.method static synthetic access$3100(Lcom/android/server/policy/OemPhoneWindowManager;)Landroid/view/WindowManager;
    .locals 1
...
.method private getDefaultBackHandlingCode(Z)I
    ...
    iget-object v0, p0, Lcom/android/server/policy/OemPhoneWindowManager;->mSceneModeController:Lcom/android/server/OemSceneModeController;

    if-nez v0, :cond_0

    iget-object v0, p0, Lcom/android/server/policy/OemPhoneWindowManager;->mContext:Landroid/content/Context;

    invoke-static {v0}, Lcom/android/server/OemSceneModeController;->getInstance(Landroid/content/Context;)Lcom/android/server/OemSceneModeController;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/policy/OemPhoneWindowManager;->mSceneModeController:Lcom/android/server/OemSceneModeController;
    ...
    invoke-virtual {v0}, Lcom/android/server/OemSceneModeController;->isGameModeUIShowing()Z

    move-result v0

    if-eqz v0, :cond_2

    sget-boolean v0, Lcom/android/server/policy/OemPhoneWindowManager;->DEBUG_ONEPLUS:Z

    if-eqz v0, :cond_1

    const-string v0, "OemPhoneWindowManager"

    const-string v1, "GameModeMsg ate back key up"
    ...
    invoke-virtual {v0}, Lcom/android/server/OemSceneModeController;->hideGameModeUI()V
...
.method private getProductLineTestFlag()[B
    ...
    const-string/jumbo v5, "getProductLineTestFlag IllegalArgumentException"
    ...
    const-string/jumbo v5, "getProductLineTestFlag FileNotFoundException"
    ...
    const-string/jumbo v5, "getProductLineTestFlag IOException"
    ...
    :goto_3
    const-string/jumbo v5, "getProductLineTestFlag IOException while close : "
    ...
    const-string/jumbo v4, "getProductLineTestFlag result[] = "
...
.method public focusChangedLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Lcom/android/server/policy/WindowManagerPolicy$WindowState;)I
    ...
    iget v0, p0, Lcom/android/server/policy/OemPhoneWindowManager;->mSensorRotation:I

    invoke-virtual {p0, v0}, Lcom/android/server/policy/OemPhoneWindowManager;->setMistouchPrevention(I)V

    goto :goto_4

    :cond_9
    iget v0, p0, Lcom/android/server/policy/OemPhoneWindowManager;->mScreenRotation:I
...
.method public init(Landroid/content/Context;Landroid/view/IWindowManager;Lcom/android/server/policy/WindowManagerPolicy$WindowManagerFuncs;)V
    ...
    :cond_b
    sget-boolean v0, Lcom/android/server/policy/OemTwoPointersDetectionListener;->IS_TWO_FINGER_DETECTION_SUPPORTED:Z

    if-eqz v0, :cond_c

    new-instance v0, Lcom/android/server/policy/OemTwoPointersDetectionListener;

    iget-object v2, p0, Lcom/android/server/policy/OemPhoneWindowManager;->mContext:Landroid/content/Context;

    invoke-direct {v0, v2}, Lcom/android/server/policy/OemTwoPointersDetectionListener;-><init>(Landroid/content/Context;)V
...
.method public interceptKeyBeforeDispatching(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)J
    ...
    :cond_35
    invoke-direct {v0, v6}, Lcom/android/server/policy/OemPhoneWindowManager;->getDefaultBackHandlingCode(Z)I
...
.method public interceptKeyBeforeQueueing(Landroid/view/KeyEvent;I)I
    ...
    const-string v8, " ++++++++++ interceptKeyBeforeQueueing(): event = "
    ...
    :cond_a
    iget-boolean v0, v1, Lcom/android/server/policy/OemPhoneWindowManager;->mSystemBooted:Z
    ...
    :try_start_0
    invoke-virtual {v6}, Lcom/android/server/oneplus/MotorManagerService;->setMotorDownArrived()V
    ...
    invoke-virtual {v6}, Lcom/android/server/oneplus/MotorManagerService;->setMotorDownLocked()V
    ...
    invoke-virtual {v6}, Lcom/android/server/oneplus/MotorManagerService;->setMotorDowning()V
    ...
    invoke-virtual {v6}, Lcom/android/server/oneplus/MotorManagerService;->setMotorUpArrived()V
    ...
    invoke-virtual {v6}, Lcom/android/server/oneplus/MotorManagerService;->setMotorUpLocked()V
    ...
    invoke-virtual {v6}, Lcom/android/server/oneplus/MotorManagerService;->setMotorUping()V
    ...
    invoke-virtual {v6}, Lcom/android/server/oneplus/MotorManagerService;->setMotorPush()V
    ...
    invoke-virtual {v6}, Lcom/android/server/oneplus/MotorManagerService;->setMotorPull()V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v8, "Exception in motor key event:"
    ...
    iput-boolean v7, v1, Lcom/android/server/policy/OemPhoneWindowManager;->mPowerKeyLongPressHandled:Z

    iget-object v7, v1, Lcom/android/server/policy/OemPhoneWindowManager;->mBgHandler:Landroid/os/Handler;
    ...
    iget-boolean v7, v1, Lcom/android/server/policy/OemPhoneWindowManager;->mPowerKeyLongPressHandled:Z
    ...
    iget-object v8, v1, Lcom/android/server/policy/OemPhoneWindowManager;->mBgHandler:Landroid/os/Handler;
    ...
    sget-object v7, Lcom/android/server/policy/OemPhoneWindowManager;->mBlockingKeySet:Landroid/util/SparseArray;
    ...
    sget-object v8, Lcom/android/server/OemSceneButtonController$Param;->ALL:Lcom/android/server/OemSceneButtonController$Param;

    invoke-virtual {v8}, Lcom/android/server/OemSceneButtonController$Param;->name()Ljava/lang/String;
    ...
    sget-boolean v6, Lcom/android/server/policy/OemPhoneWindowManager;->DEBUG_INPUT:Z

    if-eqz v6, :cond_1b

    const-string v6, "OemPhoneWindowManager"

    const-string v8, "blocking ALL, return"
    ...
    :cond_1c
    sget-object v8, Lcom/android/server/OemSceneButtonController$Param;->NOT_FROM_NAVBAR:Lcom/android/server/OemSceneButtonController$Param;
    ...
    const-string v8, "blocking NOT_FROM_NAVBAR, return"
    ...
    :cond_1e
    sget-object v8, Lcom/android/server/OemSceneButtonController$Param;->FROM_NAVBAR_AND_NOT_HAS_NAVIGATIONBAR:Lcom/android/server/OemSceneButtonController$Param;
    ...
    iget-boolean v8, v1, Lcom/android/server/policy/OemPhoneWindowManager;->mHasNavigationBar:Z
    ...
    const-string v8, "blocking FROM_NAVBAR_AND_NOT_HAS_NAVIGATIONBAR, return"
    ...
    :cond_20
    sget-object v8, Lcom/android/server/OemSceneButtonController$Param;->FROM_NAVBAR_AND_HAS_NAVIGATIONBAR:Lcom/android/server/OemSceneButtonController$Param;
    ...
    const-string v8, "blocking FROM_NAVBAR_AND_HAS_NAVIGATIONBAR, return"
    ...
    sget-object v7, Lcom/android/server/policy/OemPhoneWindowManager$13;->$SwitchMap$com$android$server$policy$OemPhoneWindowManager$KeyLockMode:[I
    ...
    const-string v7, " ++++++++++ interceptKeyBeforeQueueing(): cancelling event due to VOLUME_SWITCH key lock mode."
    ...
    :cond_25
    sget-boolean v7, Lcom/android/server/policy/OemPhoneWindowManager;->DEBUG_INPUT:Z

    if-eqz v7, :cond_26

    const-string v7, "OemPhoneWindowManager"

    const-string v8, " ++++++++++ interceptKeyBeforeQueueing(): mark flag FLAG_VOLUME_INTERCEPT due to VOLUME_SWITCH key lock mode."
    ...
    :cond_28
    iget-boolean v7, v1, Lcom/android/server/policy/OemPhoneWindowManager;->mHasNavigationBar:Z
    ...
    const-string v7, " ++++++++++ interceptKeyBeforeQueueing(): cancelling event due to BACK_SWITCH key lock mode."
    ...
    const-string v7, " ++++++++++ interceptKeyBeforeQueueing(): cancelling event due to FOOT key lock mode."
    ...
    const-string v7, " ++++++++++ interceptKeyBeforeQueueing(): cancelling event due to HOME key lock mode."
    ...
    const-string v7, " ++++++++++ interceptKeyBeforeQueueing(): return 1 due to POWER/POWER_HOME key lock mode."
    ...
    iget-boolean v6, v1, Lcom/android/server/policy/OemPhoneWindowManager;->mScreenshotChordVolumeDownKeyTriggered:Z
    ...
    iget-boolean v6, v1, Lcom/android/server/policy/OemPhoneWindowManager;->mA11yShortcutChordVolumeUpKeyTriggered:Z
    ...
    const-string v8, " ++++++++++ interceptKeyBeforeQueueing(): reset volume key:"
    ...
    iput-boolean v6, v1, Lcom/android/server/policy/OemPhoneWindowManager;->mA11yShortcutChordVolumeUpKeyTriggered:Z

    iput-boolean v6, v1, Lcom/android/server/policy/OemPhoneWindowManager;->mScreenshotChordVolumeDownKeyTriggered:Z
    ...
    const-string v8, " ++++++++++ interceptKeyBeforeQueueing(): dispatching event due to NORMAL key lock mode."
    ...
    :goto_12
    sget-boolean v7, Lcom/android/server/policy/OemPhoneWindowManager;->mFingerprintEnrolling:Z
    ...
    iget-boolean v7, v1, Lcom/android/server/policy/OemPhoneWindowManager;->mBackKeyConsumed:Z

    if-eqz v7, :cond_38

    const/4 v6, 0x0

    iput-boolean v6, v1, Lcom/android/server/policy/OemPhoneWindowManager;->mBackKeyConsumed:Z
    ...
    const-string v8, " ++++++++++ interceptKeyBeforeQueueing(): ignoring event because already consumed, event = "
    ...
    iget-boolean v8, v1, Lcom/android/server/policy/OemPhoneWindowManager;->mAppSwitchKeyConsumed:Z

    if-eqz v8, :cond_3a

    iput-boolean v7, v1, Lcom/android/server/policy/OemPhoneWindowManager;->mAppSwitchKeyConsumed:Z
    ...
    invoke-virtual {v1, v7, v9, v8}, Lcom/android/server/policy/OemPhoneWindowManager;->performHapticFeedbackLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;IZ)Z
    ...
    iget-object v8, v1, Lcom/android/server/policy/OemPhoneWindowManager;->mDeviceKeyHandler:Lcom/android/server/policy/DeviceKeyHandler;

    if-eqz v8, :cond_43

    iget-object v8, v1, Lcom/android/server/policy/OemPhoneWindowManager;->mDeviceKeyHandler:Lcom/android/server/policy/DeviceKeyHandler;

    iget-object v9, v1, Lcom/android/server/policy/OemPhoneWindowManager;->mKeyguardDelegate:Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;

    invoke-virtual {v8, v9}, Lcom/android/server/policy/DeviceKeyHandler;->setKeyguardDelegate(Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;)V

    iget-object v8, v1, Lcom/android/server/policy/OemPhoneWindowManager;->mDeviceKeyHandler:Lcom/android/server/policy/DeviceKeyHandler;

    invoke-virtual {v8, v2}, Lcom/android/server/policy/DeviceKeyHandler;->handleKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    iget-boolean v8, v1, Lcom/android/server/policy/OemPhoneWindowManager;->mFingerprintForShotEnabled:Z

    if-eqz v8, :cond_44

    iget-object v8, v1, Lcom/android/server/policy/OemPhoneWindowManager;->mFocusedWindow:Lcom/android/server/policy/WindowManagerPolicy$WindowState;

    if-eqz v8, :cond_44

    const-string v8, "com.oneplus.camera"

    iget-object v9, v1, Lcom/android/server/policy/OemPhoneWindowManager;->mFocusedWindow:Lcom/android/server/policy/WindowManagerPolicy$WindowState;
    ...
    invoke-direct {v1, v6}, Lcom/android/server/policy/OemPhoneWindowManager;->triggerVirtualKeypress(I)V
    ...
    :cond_44
    iget v8, v1, Lcom/android/server/policy/OemPhoneWindowManager;->mLongPressOnFingerprintBehavior:I

    if-ne v8, v6, :cond_46

    if-eqz v12, :cond_45

    iget v6, v1, Lcom/android/server/policy/OemPhoneWindowManager;->mCurrentUserId:I
    ...
    iget v9, v1, Lcom/android/server/policy/OemPhoneWindowManager;->mLongPressOnFingerprintBehavior:I
    ...
    iget v6, v1, Lcom/android/server/policy/OemPhoneWindowManager;->mLongPressOnFingerprintBehavior:I

    if-eqz v6, :cond_47

    const/4 v6, 0x0

    invoke-virtual {v1, v7, v6, v6}, Lcom/android/server/policy/OemPhoneWindowManager;->performHapticFeedbackLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;IZ)Z

    iget v7, v1, Lcom/android/server/policy/OemPhoneWindowManager;->mLongPressOnFingerprintBehavior:I

    invoke-direct {v1, v7, v2}, Lcom/android/server/policy/OemPhoneWindowManager;->performKeyAction(ILandroid/view/KeyEvent;)V
    ...
    iget-boolean v7, v1, Lcom/android/server/policy/OemPhoneWindowManager;->mQuickPayEnabled:Z
    ...
    invoke-direct {v1, v6, v2}, Lcom/android/server/policy/OemPhoneWindowManager;->performKeyAction(ILandroid/view/KeyEvent;)V
    ...
    iget v6, v1, Lcom/android/server/policy/OemPhoneWindowManager;->mQuickPayWhich:I
    ...
    iget-object v6, v1, Lcom/android/server/policy/OemPhoneWindowManager;->mFocusedWindow:Lcom/android/server/policy/WindowManagerPolicy$WindowState;
    ...
    iget-object v6, v1, Lcom/android/server/policy/OemPhoneWindowManager;->mQuickPayBtnView:Landroid/view/View;
    ...
    iget-boolean v6, v1, Lcom/android/server/policy/OemPhoneWindowManager;->mQuickPayBtnLaunched:Z
    ...
    invoke-virtual {v1, v7, v6}, Lcom/android/server/policy/OemPhoneWindowManager;->launchHomeFromHotKey(ZZ)V
    ...
    :goto_16
    invoke-virtual {v1, v6}, Lcom/android/server/policy/OemPhoneWindowManager;->clearQuickPaySwitch(Z)V
    ...
    :cond_4a
    :goto_17
    invoke-super {v1, v2, v3}, Lcom/android/server/policy/PhoneWindowManager;->interceptKeyBeforeQueueing(Landroid/view/KeyEvent;I)I
...
.method public onConfigurationChanged()V
    ...
    invoke-virtual {v0}, Lcom/android/server/policy/OemGestureButton;->updateScreenSize()V
...
.method public onKeyguardDone()V
    ...
    sget-object v0, Lcom/android/server/policy/OemPhoneWindowManager;->POWER_LONG_PRESS_WITH_ASSISTANT_HINT:Ljava/lang/String;
...
.method public screenTurningOn(Lcom/android/server/policy/WindowManagerPolicy$ScreenOnListener;)V
    ...
    invoke-virtual {v0}, Lcom/android/server/policy/DeviceKeyHandler;->onScreenTurningOn()V
...
.method setMistouchPrevention(I)V
    ...
    iget v0, p0, Lcom/android/server/policy/OemPhoneWindowManager;->mMistouchRotation:I
    ...
    :cond_0
    iput p1, p0, Lcom/android/server/policy/OemPhoneWindowManager;->mMistouchRotation:I
...
.method public setRotationLw(I)V
    ...
    iput p1, p0, Lcom/android/server/policy/OemPhoneWindowManager;->mScreenRotation:I

    invoke-virtual {p0, p1}, Lcom/android/server/policy/OemPhoneWindowManager;->setMistouchPrevention(I)V
...
.method setSensorMistouchPrevention(I)V
    .locals 2

    iput p1, p0, Lcom/android/server/policy/OemPhoneWindowManager;->mSensorRotation:I

    iget-object v0, p0, Lcom/android/server/policy/OemPhoneWindowManager;->mFocusedWindow:Lcom/android/server/policy/WindowManagerPolicy$WindowState;
...
.method public systemReady()V
    ...
    sget-object v4, Lcom/android/server/policy/OemPhoneWindowManager$KeyLockMode;->NORMAL:Lcom/android/server/policy/OemPhoneWindowManager$KeyLockMode;

    invoke-virtual {v4}, Lcom/android/server/policy/OemPhoneWindowManager$KeyLockMode;->ordinal()I
    ...
    const-string v4, "Restore the key lock mode to BACK_SWITCH because navigation bar is enabled."
    ...
    invoke-static {v1}, Lcom/android/server/policy/ScreenDecor;->isSupportRoundScreen(Landroid/content/Context;)Z
    ...
    invoke-direct {v1, v3, p0}, Lcom/android/server/policy/ScreenDecor;-><init>(Landroid/content/Context;Lcom/android/server/policy/WindowManagerPolicy;)V
    ...
    iput-boolean v0, p0, Lcom/android/server/policy/OemPhoneWindowManager;->mRotationMistouch:Z
