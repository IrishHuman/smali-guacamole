...
.method private static shutdownInner(Landroid/content/Context;Z)V
    ...
    invoke-virtual {v0}, Lcom/android/server/oneplus/MotorManagerService;->downMotorByPowerOff()V
...
.method public run()V
    ...
    const-string/jumbo v3, "oneplus.intent.action.OEM_SHUTDOWN"

    invoke-direct {v0, v3}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    sget-object v3, Lcom/android/server/power/ShutdownThread;->OEM_PACKAGE_MARKET:Ljava/lang/String;

    invoke-virtual {v0, v3}, Landroid/content/Intent;->setPackage(Ljava/lang/String;)Landroid/content/Intent;

    iget-object v13, v1, Lcom/android/server/power/ShutdownThread;->mContext:Landroid/content/Context;

    sget-object v15, Landroid/os/UserHandle;->ALL:Landroid/os/UserHandle;

    const/16 v16, 0x0

    iget-object v3, v1, Lcom/android/server/power/ShutdownThread;->mHandler:Landroid/os/Handler;
    ...
    invoke-virtual/range {v13 .. v21}, Landroid/content/Context;->sendOrderedBroadcastAsUser(Landroid/content/Intent;Landroid/os/UserHandle;Ljava/lang/String;Landroid/content/BroadcastReceiver;Landroid/os/Handler;ILjava/lang/String;Landroid/os/Bundle;)V
