...
.field private mFirstNewColorBalanceManager:Z
...
.field private mIsNetRestricted:Z
...
.field private mRestrictWakeLocks:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap<",
            "Ljava/lang/String;",
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Lcom/android/server/power/PowerManagerService;->mFirstNewColorBalanceManager:Z
    ...
    iput-object v3, p0, Lcom/android/server/power/PowerManagerService;->mSuspendBlockers:Ljava/util/ArrayList;

    new-instance v3, Ljava/util/ArrayList;

    invoke-direct {v3}, Ljava/util/ArrayList;-><init>()V

    iput-object v3, p0, Lcom/android/server/power/PowerManagerService;->mWakeLocks:Ljava/util/ArrayList;
    ...
    iput-object v1, p0, Lcom/android/server/power/PowerManagerService;->mDeviceIdleSySWhitelist:[I

    new-array v1, v0, [I

    iput-object v1, p0, Lcom/android/server/power/PowerManagerService;->mDeepSleepWhitelist:[I
    ...
    iput-object v1, p0, Lcom/android/server/power/PowerManagerService;->packagenameFromScreenActivity:Ljava/lang/String;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, Lcom/android/server/power/PowerManagerService;->mLongWLBlackMap:Ljava/util/HashMap;
    ...
    iput-boolean v0, p0, Lcom/android/server/power/PowerManagerService;->mBlockFingerprintSleep:Z
    ...
    iput-boolean v0, p0, Lcom/android/server/power/PowerManagerService;->useProximityForceSuspend:Z
    ...
    invoke-direct {v1, v3}, Lcom/oneplus/display/ColorBalanceManager;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Lcom/android/server/power/PowerManagerService;->mCBM:Lcom/oneplus/display/ColorBalanceManager;

    iput v0, p0, Lcom/android/server/power/PowerManagerService;->mDeviceIdleState:I

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, Lcom/android/server/power/PowerManagerService;->mExclusiveWakeLocks:Ljava/util/HashMap;

    iput-boolean v0, p0, Lcom/android/server/power/PowerManagerService;->mIsExclusiveEnabled:Z

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, Lcom/android/server/power/PowerManagerService;->mRestrictWakeLocks:Ljava/util/HashMap;

    iput-boolean v0, p0, Lcom/android/server/power/PowerManagerService;->mIsNetRestricted:Z

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, Lcom/android/server/power/PowerManagerService;->mKillWakeLocks:Ljava/util/HashMap;

    const-string v1, "com.google.android.googlequicksearchbox"

    const-string v3, "AudioIn"

    invoke-virtual {p0, v1, v3}, Lcom/android/server/power/PowerManagerService;->addKillWakeLockInternal(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-boolean v2, p0, Lcom/android/server/power/PowerManagerService;->mHalInteractiveModeEnabled:Z
    ...
    invoke-static {v2}, Lcom/android/server/power/PowerManagerService;->nativeSetInteractive(Z)V

    invoke-static {v2, v0}, Lcom/android/server/power/PowerManagerService;->nativeSetFeature(II)V
...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/power/BatterySaverPolicy;)V
    ...
    invoke-direct {v0, p0, v2}, Lcom/android/server/power/PowerManagerService$PowerManagerHandler;-><init>(Lcom/android/server/power/PowerManagerService;Landroid/os/Looper;)V
    ...
    invoke-direct {v0, p0, v2}, Lcom/android/server/power/PowerManagerService$Constants;-><init>(Lcom/android/server/power/PowerManagerService;Landroid/os/Handler;)V
    ...
    invoke-direct {v0, v2}, Lcom/android/internal/hardware/AmbientDisplayConfiguration;-><init>(Landroid/content/Context;)V
...
.method static synthetic access$5000(Lcom/android/server/power/PowerManagerService;)Ljava/lang/String;
    .locals 1
...
.method static synthetic access$5300(Lcom/android/server/power/PowerManagerService;)Lcom/android/server/power/batterysaver/BatterySaverController;
    .locals 1
...
.method static synthetic access$5400(Lcom/android/server/power/PowerManagerService;)Lcom/android/server/power/BatterySaverPolicy;
    .locals 1
...
.method static synthetic access$6200(Lcom/android/server/power/PowerManagerService;Ljava/io/FileDescriptor;)V
    .locals 0
...
.method static synthetic access$6700(Lcom/android/server/power/PowerManagerService;J)V
    .locals 0
...
.method static synthetic access$6800(Lcom/android/server/power/PowerManagerService;Z)V
    .locals 0
...
.method static synthetic access$6900(Lcom/android/server/power/PowerManagerService;)Ljava/util/HashMap;
    .locals 1

    iget-object v0, p0, Lcom/android/server/power/PowerManagerService;->mRestrictWakeLocks:Ljava/util/HashMap;
...
.method private setWakeLockDisabledStateLocked(Lcom/android/server/power/PowerManagerService$WakeLock;)Z
    ...
    :cond_f
    :goto_3
    iget-boolean v4, p0, Lcom/android/server/power/PowerManagerService;->mIsExclusiveEnabled:Z

    if-eqz v4, :cond_10

    if-nez v0, :cond_10

    invoke-virtual {p0, p1}, Lcom/android/server/power/PowerManagerService;->isExclusiveWakeLock(Lcom/android/server/power/PowerManagerService$WakeLock;)Z
    ...
    sget-boolean v4, Lcom/android/server/power/PowerManagerService;->DEBUG_ONEPLUS:Z
    ...
    const-string v6, ", is disabled by OnePlusPowerController(E)"
    ...
    :cond_10
    iget-boolean v4, p0, Lcom/android/server/power/PowerManagerService;->mIsNetRestricted:Z

    if-eqz v4, :cond_11

    if-nez v0, :cond_11

    invoke-virtual {p0, p1}, Lcom/android/server/power/PowerManagerService;->isNetRestrictWakeLock(Lcom/android/server/power/PowerManagerService$WakeLock;)Z
    ...
    const-string v6, ", is disabled by OnePlusPowerController(N)"
...
.method private wakeUpNoUpdateLocked(JLjava/lang/String;ILjava/lang/String;I)Z
    ...
    :pswitch_0
    iget-boolean v0, v7, Lcom/android/server/power/PowerManagerService;->mFirstNewColorBalanceManager:Z

    if-nez v0, :cond_9

    new-instance v0, Lcom/oneplus/display/ColorBalanceManager;

    iget-object v2, v7, Lcom/android/server/power/PowerManagerService;->mContext:Landroid/content/Context;

    invoke-direct {v0, v2}, Lcom/oneplus/display/ColorBalanceManager;-><init>(Landroid/content/Context;)V

    iput-object v0, v7, Lcom/android/server/power/PowerManagerService;->mCBM:Lcom/oneplus/display/ColorBalanceManager;

    iput-boolean v13, v7, Lcom/android/server/power/PowerManagerService;->mFirstNewColorBalanceManager:Z

    const-string v0, "PowerManagerService"

    const-string v2, "ColorBalanceManager is null"
    ...
    iget-object v0, v7, Lcom/android/server/power/PowerManagerService;->mCBM:Lcom/oneplus/display/ColorBalanceManager;
    ...
    invoke-virtual {v0, v2}, Lcom/oneplus/display/ColorBalanceManager;->sendMsg(I)V

    const-string v0, "PowerManagerService"

    const-string/jumbo v2, "sendMsg to ColorBalanceService to no enter fingerprintmode"
    ...
    iput-object v10, v7, Lcom/android/server/power/PowerManagerService;->mWakingUpReason:Ljava/lang/String;
...
# virtual methods
.method addExclusiveWakeLockInternal(Ljava/lang/String;Ljava/lang/String;Z)V
    .locals 9
    ...
    const-string v6, "RestrictWakeLocks"

    goto :goto_3

    :cond_4
    const-string v6, "ExclusiveWakeLocks: packageName = "
...
.method clearExclusiveWakeLockInternal(Z)V
    .locals 1
...
.method disableExclusiveWakeLocksInternal(Z)V
    .locals 4
    ...
    iput-boolean v1, p0, Lcom/android/server/power/PowerManagerService;->mIsNetRestricted:Z

    goto :goto_0

    :cond_1
    iput-boolean v1, p0, Lcom/android/server/power/PowerManagerService;->mIsExclusiveEnabled:Z
...
.method enableExclusiveWakeLocksInternal(Z)V
    .locals 4
...
.method flushExclusiveWakeLockInternal()V
    .locals 3
...
.method isNetRestrictWakeLock(Lcom/android/server/power/PowerManagerService$WakeLock;)Z
    .locals 3

    iget-boolean v0, p0, Lcom/android/server/power/PowerManagerService;->mIsNetRestricted:Z
...
.method public systemReady(Lcom/android/internal/app/IAppOpsService;)V
    ...
    new-instance v4, Lcom/android/server/power/PowerManagerService$DozeBlackConfigUpdater;

    invoke-direct {v4, p0}, Lcom/android/server/power/PowerManagerService$DozeBlackConfigUpdater;-><init>(Lcom/android/server/power/PowerManagerService;)V

    sget-object v5, Lcom/android/server/power/PowerManagerService;->PACKAGEMANAGERMENT_CONFIG_NAME:Ljava/lang/String;

    invoke-direct {v0, v1, v2, v4, v5}, Lcom/oneplus/config/ConfigObserver;-><init>(Landroid/content/Context;Landroid/os/Handler;Lcom/oneplus/config/ConfigObserver$ConfigUpdater;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, v4, v5}, Lcom/android/server/power/PowerManagerService$PowerManagerHandler;->sendMessageDelayed(Landroid/os/Message;J)Z
