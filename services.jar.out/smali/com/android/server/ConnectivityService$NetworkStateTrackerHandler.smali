...
.method private maybeHandleAsyncChannelMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v0, p1}, Lcom/android/server/ConnectivityService;->access$1500(Lcom/android/server/ConnectivityService;Landroid/os/Message;)V
...
.method private maybeHandleNetworkAgentMessage(Landroid/os/Message;)V
    ...
    invoke-static {}, Lcom/android/server/ConnectivityService;->access$1600()Z

    move-result v3

    if-eqz v3, :cond_0

    const-string v3, "%s from unknown NetworkAgent"

    new-array v2, v2, [Ljava/lang/Object;

    iget v4, p1, Landroid/os/Message;->what:I

    invoke-static {v4}, Lcom/android/server/ConnectivityService;->access$1700(I)Ljava/lang/String;
    ...
    invoke-static {v1, v0, v2}, Lcom/android/server/ConnectivityService;->access$2100(Lcom/android/server/ConnectivityService;Lcom/android/server/connectivity/NetworkAgentInfo;I)V
    ...
    invoke-static {v2, v3, v0, v1}, Lcom/android/server/ConnectivityService;->access$1900(Lcom/android/server/ConnectivityService;ILcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/NetworkCapabilities;)V
    ...
    const-string v3, "ERROR: already-connected network explicitly selected."

    invoke-static {v3}, Lcom/android/server/ConnectivityService;->access$1100(Ljava/lang/String;)V
    ...
    :cond_8
    invoke-static {v3, v1}, Lcom/android/server/ConnectivityService;->access$2302(Lcom/android/server/ConnectivityService;Z)Z
...
.method private maybeHandleNetworkMonitorMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v0, v1}, Lcom/android/server/ConnectivityService;->access$2500(Lcom/android/server/ConnectivityService;I)Lcom/android/server/connectivity/NetworkAgentInfo;
    ...
    invoke-static {v1, v0, v2}, Lcom/android/server/ConnectivityService;->access$3300(Lcom/android/server/ConnectivityService;Lcom/android/server/connectivity/NetworkAgentInfo;Lcom/android/server/connectivity/DnsManager$PrivateDnsConfig;)V
    ...
    invoke-static {v4, v0}, Lcom/android/server/ConnectivityService;->access$2500(Lcom/android/server/ConnectivityService;I)Lcom/android/server/connectivity/NetworkAgentInfo;
    ...
    invoke-static {v2, v11}, Lcom/android/server/ConnectivityService;->access$3100(Lcom/android/server/ConnectivityService;Lcom/android/server/connectivity/NetworkAgentInfo;)V
    ...
    invoke-static {v2, v4, v11, v5}, Lcom/android/server/ConnectivityService;->access$1900(Lcom/android/server/ConnectivityService;ILcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/NetworkCapabilities;)V
    ...
    invoke-static {v2}, Lcom/android/server/ConnectivityService;->access$3200(Lcom/android/server/ConnectivityService;)Lcom/android/server/connectivity/NetworkNotificationManager;
    ...
    invoke-static {v2}, Lcom/android/server/ConnectivityService;->access$1100(Ljava/lang/String;)V
    ...
    invoke-static {v9, v8, v0, v10}, Lcom/android/server/ConnectivityService;->access$1900(Lcom/android/server/ConnectivityService;ILcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/NetworkCapabilities;)V
    ...
    invoke-static {v9, v0}, Lcom/android/server/ConnectivityService;->access$2600(Lcom/android/server/ConnectivityService;Lcom/android/server/connectivity/NetworkAgentInfo;)V
    ...
    invoke-static {v9, v0}, Lcom/android/server/ConnectivityService;->access$2700(Lcom/android/server/ConnectivityService;Lcom/android/server/connectivity/NetworkAgentInfo;)V

    :cond_f
    iget-object v8, p0, Lcom/android/server/ConnectivityService$NetworkStateTrackerHandler;->this$0:Lcom/android/server/ConnectivityService;

    invoke-static {v8, v0}, Lcom/android/server/ConnectivityService;->access$2800(Lcom/android/server/ConnectivityService;Lcom/android/server/connectivity/NetworkAgentInfo;)V
