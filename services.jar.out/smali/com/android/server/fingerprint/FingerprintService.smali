...
.field private mDtm:Lcom/android/server/display/DisplayTransformManager;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Lcom/android/server/fingerprint/FingerprintService;->mIsGrayScaleDisableByFingerPrint:Z

    sput-boolean v1, Lcom/android/server/fingerprint/FingerprintService;->mIsColorCalibrationDisableByFingerPrint:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v2, p0, Lcom/android/server/fingerprint/FingerprintService;->mCurrentParam:I
    ...
    iput-boolean v3, p0, Lcom/android/server/fingerprint/FingerprintService;->mIsCustomFingerprint:Z

    iput v2, p0, Lcom/android/server/fingerprint/FingerprintService;->mGrayModeSetting:I

    iput-boolean v1, p0, Lcom/android/server/fingerprint/FingerprintService;->mTempDisableGrayMode:Z

    const-wide/32 v3, 0xea60

    iput-wide v3, p0, Lcom/android/server/fingerprint/FingerprintService;->FAIL_ATTEMPT_COUNTING_DURATION:J

    const-wide/16 v3, 0xa

    iput-wide v3, p0, Lcom/android/server/fingerprint/FingerprintService;->FAIL_ATTEMPT_MAX_AMOUNT:J

    const-wide/32 v3, 0x1b7740

    iput-wide v3, p0, Lcom/android/server/fingerprint/FingerprintService;->ATTACK_DEFENDING_DURATION:J

    const-wide/16 v3, 0x0

    iput-wide v3, p0, Lcom/android/server/fingerprint/FingerprintService;->mTimeStampStartCounting:J

    iput-wide v3, p0, Lcom/android/server/fingerprint/FingerprintService;->mTimeStampRaisingCriteria:J

    iput-boolean v1, p0, Lcom/android/server/fingerprint/FingerprintService;->mAttackDefending:Z

    const-string v3, "fps_color_correction"

    iput-object v3, p0, Lcom/android/server/fingerprint/FingerprintService;->KEY_COLOR_CORRECTION:Ljava/lang/String;

    iput-boolean v1, p0, Lcom/android/server/fingerprint/FingerprintService;->mTempDisableColorCorrection:Z

    new-instance v3, Ljava/util/HashMap;

    invoke-direct {v3}, Ljava/util/HashMap;-><init>()V

    iput-object v3, p0, Lcom/android/server/fingerprint/FingerprintService;->mPerformanceMap:Ljava/util/HashMap;

    new-instance v3, Ljava/util/HashMap;

    invoke-direct {v3}, Ljava/util/HashMap;-><init>()V

    iput-object v3, p0, Lcom/android/server/fingerprint/FingerprintService;->mCryptoPerformanceMap:Ljava/util/HashMap;

    new-instance v3, Lcom/android/server/fingerprint/FingerprintService$1;

    invoke-direct {v3, p0}, Lcom/android/server/fingerprint/FingerprintService$1;-><init>(Lcom/android/server/fingerprint/FingerprintService;)V

    iput-object v3, p0, Lcom/android/server/fingerprint/FingerprintService;->mHandler:Landroid/os/Handler;

    new-instance v3, Lcom/android/server/fingerprint/FingerprintService$2;

    invoke-direct {v3, p0}, Lcom/android/server/fingerprint/FingerprintService$2;-><init>(Lcom/android/server/fingerprint/FingerprintService;)V

    iput-object v3, p0, Lcom/android/server/fingerprint/FingerprintService;->mLockoutReceiver:Landroid/content/BroadcastReceiver;

    new-instance v3, Lcom/android/server/fingerprint/FingerprintService$3;

    invoke-direct {v3, p0}, Lcom/android/server/fingerprint/FingerprintService$3;-><init>(Lcom/android/server/fingerprint/FingerprintService;)V

    iput-object v3, p0, Lcom/android/server/fingerprint/FingerprintService;->mResetFailedAttemptsForCurrentUserRunnable:Ljava/lang/Runnable;
    ...
    iput-object v3, p0, Lcom/android/server/fingerprint/FingerprintService;->mResetClientState:Ljava/lang/Runnable;

    new-instance v3, Lcom/android/server/fingerprint/FingerprintService$5;

    invoke-direct {v3, p0}, Lcom/android/server/fingerprint/FingerprintService$5;-><init>(Lcom/android/server/fingerprint/FingerprintService;)V

    iput-object v3, p0, Lcom/android/server/fingerprint/FingerprintService;->mTaskStackListener:Landroid/app/TaskStackListener;
    ...
    iput-object v3, p0, Lcom/android/server/fingerprint/FingerprintService;->mDaemonCallback:Landroid/hardware/biometrics/fingerprint/V2_1/IBiometricsFingerprintClientCallback;

    new-instance v3, Lcom/android/server/fingerprint/FingerprintService$14;

    iget-object v4, p0, Lcom/android/server/fingerprint/FingerprintService;->mHandler:Landroid/os/Handler;

    invoke-direct {v3, p0, v4}, Lcom/android/server/fingerprint/FingerprintService$14;-><init>(Lcom/android/server/fingerprint/FingerprintService;Landroid/os/Handler;)V

    iput-object v3, p0, Lcom/android/server/fingerprint/FingerprintService;->mGrayModebserver:Landroid/database/ContentObserver;
    ...
    iput-object v3, p0, Lcom/android/server/fingerprint/FingerprintService;->mKeyguardPackage:Ljava/lang/String;
    ...
    iput-object v3, p0, Lcom/android/server/fingerprint/FingerprintService;->mAppOps:Landroid/app/AppOpsManager;
    ...
    iput-object v3, p0, Lcom/android/server/fingerprint/FingerprintService;->mPowerManager:Landroid/os/PowerManager;
    ...
    iput-object v3, p0, Lcom/android/server/fingerprint/FingerprintService;->mAlarmManager:Landroid/app/AlarmManager;
    ...
    iget-boolean v4, p0, Lcom/android/server/fingerprint/FingerprintService;->mIsCustomFingerprint:Z
    ...
    iget-object v5, p0, Lcom/android/server/fingerprint/FingerprintService;->mLockoutReceiver:Landroid/content/BroadcastReceiver;

    const-string v6, "android.permission.RESET_FINGERPRINT_LOCKOUT"
    ...
    iput-object v4, p0, Lcom/android/server/fingerprint/FingerprintService;->mUserManager:Landroid/os/UserManager;

    new-instance v4, Landroid/util/SparseBooleanArray;

    invoke-direct {v4}, Landroid/util/SparseBooleanArray;-><init>()V

    iput-object v4, p0, Lcom/android/server/fingerprint/FingerprintService;->mTimedLockoutCleared:Landroid/util/SparseBooleanArray;

    new-instance v4, Landroid/util/SparseIntArray;

    invoke-direct {v4}, Landroid/util/SparseIntArray;-><init>()V

    iput-object v4, p0, Lcom/android/server/fingerprint/FingerprintService;->mFailedAttempts:Landroid/util/SparseIntArray;
    ...
    iput-object v4, p0, Lcom/android/server/fingerprint/FingerprintService;->mStatusBarService:Lcom/android/internal/statusbar/IStatusBarService;
    ...
    iput-object v4, p0, Lcom/android/server/fingerprint/FingerprintService;->mActivityManager:Landroid/app/IActivityManager;

    iget-object v4, p0, Lcom/android/server/fingerprint/FingerprintService;->mContext:Landroid/content/Context;

    const-string/jumbo v5, "opdiagnose"

    invoke-virtual {v4, v5}, Landroid/content/Context;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Landroid/os/OPDiagnoseManager;

    iput-object v4, p0, Lcom/android/server/fingerprint/FingerprintService;->mDiagnoseManager:Landroid/os/OPDiagnoseManager;
    ...
    iput v4, p0, Lcom/android/server/fingerprint/FingerprintService;->mBlockX:I
    ...
    iput v4, p0, Lcom/android/server/fingerprint/FingerprintService;->mBlockY:I

    iget v4, p0, Lcom/android/server/fingerprint/FingerprintService;->mBlockX:I
    ...
    iput v4, p0, Lcom/android/server/fingerprint/FingerprintService;->mBlockXEnd:I

    iget v4, p0, Lcom/android/server/fingerprint/FingerprintService;->mBlockY:I
    ...
    iput v4, p0, Lcom/android/server/fingerprint/FingerprintService;->mBlockYEnd:I

    iget-boolean v4, p0, Lcom/android/server/fingerprint/FingerprintService;->mIsCustomFingerprint:Z

    if-eqz v4, :cond_1

    new-instance v4, Lcom/oneplus/onlineconfig/FingerprintConfig;

    invoke-direct {v4, p1}, Lcom/oneplus/onlineconfig/FingerprintConfig;-><init>(Landroid/content/Context;)V

    iput-object v4, p0, Lcom/android/server/fingerprint/FingerprintService;->mFingerprintConfig:Lcom/oneplus/onlineconfig/FingerprintConfig;

    iget-object v4, p0, Lcom/android/server/fingerprint/FingerprintService;->mGrayModebserver:Landroid/database/ContentObserver;
    ...
    iget-object v6, p0, Lcom/android/server/fingerprint/FingerprintService;->mGrayModebserver:Landroid/database/ContentObserver;
    ...
    iput-object v4, p0, Lcom/android/server/fingerprint/FingerprintService;->mDtm:Lcom/android/server/display/DisplayTransformManager;
    ...
    const-string v7, "fps_color_correction"

    invoke-static {v6, v7, v1, v4}, Landroid/provider/Settings$Secure;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    const-string v8, "Current color correction: "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v7, v5}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v8, ", temporary color correction: "
    ...
    invoke-static {v6, v7, v2, v4}, Landroid/provider/Settings$Secure;->putIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)Z
    ...
    const-string v6, "fps_color_correction"

    invoke-static {v2, v6, v1, v4}, Landroid/provider/Settings$Secure;->putIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)Z
...
.method static synthetic access$1000(Lcom/android/server/fingerprint/FingerprintService;)Landroid/app/TaskStackListener;
    .locals 1
...
.method static synthetic access$1100(Lcom/android/server/fingerprint/FingerprintService;)V
    ...
    invoke-direct {p0}, Lcom/android/server/fingerprint/FingerprintService;->restoreGrayModeState()V
...
.method static synthetic access$1200(Lcom/android/server/fingerprint/FingerprintService;)V
    ...
    invoke-direct {p0}, Lcom/android/server/fingerprint/FingerprintService;->restoreColorCorrectionState()V
...
.method static synthetic access$1300(Lcom/android/server/fingerprint/FingerprintService;)Z
    ...
    iget-boolean v0, p0, Lcom/android/server/fingerprint/FingerprintService;->mAttackDefending:Z
...
.method static synthetic access$1400(Lcom/android/server/fingerprint/FingerprintService;)V
    ...
    invoke-direct {p0}, Lcom/android/server/fingerprint/FingerprintService;->handleFailAttemptForAttack()V

    return-void
.end method

.method static synthetic access$1500(Lcom/android/server/fingerprint/FingerprintService;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/server/fingerprint/FingerprintService;->checkDefendRemaining()V

    return-void
.end method

.method static synthetic access$1600(Lcom/android/server/fingerprint/FingerprintService;)Landroid/util/SparseIntArray;
    .locals 1
...
.method static synthetic access$1700(Lcom/android/server/fingerprint/FingerprintService;)Landroid/util/SparseBooleanArray;
    .locals 1
...
.method static synthetic access$1800(Lcom/android/server/fingerprint/FingerprintService;)I
    .locals 1
...
.method static synthetic access$1900(Lcom/android/server/fingerprint/FingerprintService;)Lcom/android/server/fingerprint/FingerprintService$PerformanceStats;
    .locals 1
...
.method static synthetic access$1902(Lcom/android/server/fingerprint/FingerprintService;Lcom/android/server/fingerprint/FingerprintService$PerformanceStats;)Lcom/android/server/fingerprint/FingerprintService$PerformanceStats;
    .locals 0
...
.method static synthetic access$2000(Lcom/android/server/fingerprint/FingerprintService;I)V
    .locals 0
...
.method static synthetic access$2100(Lcom/android/server/fingerprint/FingerprintService;)Landroid/os/PowerManager;
    .locals 1
...
.method static synthetic access$2200(Lcom/android/server/fingerprint/FingerprintService;)J
    .locals 2
...
.method static synthetic access$2400(Lcom/android/server/fingerprint/FingerprintService;)Landroid/os/Handler;
    .locals 1
...
.method static synthetic access$2600(Lcom/android/server/fingerprint/FingerprintService;)Landroid/content/Context;
    .locals 1
...
.method static synthetic access$2700(Lcom/android/server/fingerprint/FingerprintService;Landroid/os/IBinder;[BILandroid/hardware/fingerprint/IFingerprintServiceReceiver;IZLjava/lang/String;)V
    .locals 0
...
.method static synthetic access$2800(Lcom/android/server/fingerprint/FingerprintService;Ljava/lang/String;ZIII)Z
    .locals 1
...
.method static synthetic access$3500(Lcom/android/server/fingerprint/FingerprintService;Ljava/lang/String;)Z
    .locals 1
...
.method static synthetic access$3600(Lcom/android/server/fingerprint/FingerprintService;)Lcom/android/server/fingerprint/FingerprintUtils;
    .locals 1
...
.method static synthetic access$3700(Lcom/android/server/fingerprint/FingerprintService;Ljava/io/FileDescriptor;)V
    .locals 0
...
.method static synthetic access$3800(Lcom/android/server/fingerprint/FingerprintService;Ljava/io/PrintWriter;)V
    .locals 0
...
.method static synthetic access$3900(Lcom/android/server/fingerprint/FingerprintService;)Ljava/lang/Runnable;
    .locals 1
...
.method static synthetic access$4000(Lcom/android/server/fingerprint/FingerprintService;Lcom/android/server/fingerprint/FingerprintService$FingerprintServiceLockoutResetMonitor;)V
    .locals 0
...
.method static synthetic access$4100(Lcom/android/server/fingerprint/FingerprintService;)Ljava/util/concurrent/CopyOnWriteArrayList;
    .locals 1
...
.method static synthetic access$4200(Lcom/android/server/fingerprint/FingerprintService;)Ljava/lang/String;
    .locals 1
...
.method static synthetic access$4300(Lcom/android/server/fingerprint/FingerprintService;II)Z
    .locals 1
...
.method static synthetic access$4500(Lcom/android/server/fingerprint/FingerprintService;)I
    .locals 1

    iget v0, p0, Lcom/android/server/fingerprint/FingerprintService;->mGrayModeSetting:I

    return v0
.end method

.method static synthetic access$4502(Lcom/android/server/fingerprint/FingerprintService;I)I
    .locals 0

    iput p1, p0, Lcom/android/server/fingerprint/FingerprintService;->mGrayModeSetting:I

    return p1
.end method

.method static synthetic access$4600(Lcom/android/server/fingerprint/FingerprintService;)Z
    .locals 1

    iget-boolean v0, p0, Lcom/android/server/fingerprint/FingerprintService;->mTempDisableGrayMode:Z

    return v0
.end method

.method static synthetic access$4602(Lcom/android/server/fingerprint/FingerprintService;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/android/server/fingerprint/FingerprintService;->mTempDisableGrayMode:Z
...
.method static synthetic access$800(Lcom/android/server/fingerprint/FingerprintService;Z)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/fingerprint/FingerprintService;->disableGrayMode(Z)V
...
.method static synthetic access$900(Lcom/android/server/fingerprint/FingerprintService;)V
    ...
    invoke-direct {p0}, Lcom/android/server/fingerprint/FingerprintService;->disableColorCorrection()V
...
.method private allowUseCustomFingerprint(Ljava/lang/String;)Z
    ...
    const-string v3, "allowUseCustomFingerprint: "
...
.method private checkDefendRemaining()V
    ...
    iget-wide v2, p0, Lcom/android/server/fingerprint/FingerprintService;->mTimeStampRaisingCriteria:J
    ...
    const-string v5, "cancel defending"
    ...
    invoke-direct {p0, v4}, Lcom/android/server/fingerprint/FingerprintService;->setParam(I)V

    const-wide/16 v5, 0x0

    iput-wide v5, p0, Lcom/android/server/fingerprint/FingerprintService;->mTimeStampRaisingCriteria:J

    iput-boolean v4, p0, Lcom/android/server/fingerprint/FingerprintService;->mAttackDefending:Z
...
.method private disableColorCorrection()V
    .locals 6
    ...
    :cond_0
    iget-boolean v0, p0, Lcom/android/server/fingerprint/FingerprintService;->mTempDisableColorCorrection:Z
...
.method private disableGrayMode(Z)V
    .locals 5
    ...
    iget-boolean v2, p0, Lcom/android/server/fingerprint/FingerprintService;->mTempDisableGrayMode:Z
    ...
    iget v2, p0, Lcom/android/server/fingerprint/FingerprintService;->mGrayModeSetting:I
    ...
    sput-boolean v0, Lcom/android/server/fingerprint/FingerprintService;->mIsGrayScaleDisableByFingerPrint:Z

    iput-boolean v0, p0, Lcom/android/server/fingerprint/FingerprintService;->mTempDisableGrayMode:Z
    ...
    invoke-static {v0}, Lcom/android/server/fingerprint/FingerprintService;->computeSaturationMatrix(F)[F

    move-result-object v0

    :try_start_0
    iget-object v1, p0, Lcom/android/server/fingerprint/FingerprintService;->mDtm:Lcom/android/server/display/DisplayTransformManager;
...
.method private dumpInternal(Ljava/io/PrintWriter;)V
    ...
    iget v11, v7, Lcom/android/server/fingerprint/FingerprintService$PerformanceStats;->permanentLockout:I
    ...
    iget v11, v8, Lcom/android/server/fingerprint/FingerprintService$PerformanceStats;->accept:I
    ...
    iget v11, v8, Lcom/android/server/fingerprint/FingerprintService$PerformanceStats;->reject:I
    ...
    iget v11, v8, Lcom/android/server/fingerprint/FingerprintService$PerformanceStats;->acquire:I
    ...
    iget v11, v8, Lcom/android/server/fingerprint/FingerprintService$PerformanceStats;->lockout:I
    ...
    const-string/jumbo v3, "mTempDisableColorCorrection:"

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v3, p0, Lcom/android/server/fingerprint/FingerprintService;->mTempDisableColorCorrection:Z
    ...
    const-string v4, "CurrentColorCorrection:"
    ...
    const-string v4, "TempoaryColorCorrection:"
    ...
    const-string/jumbo v2, "mTempDisableGrayMode:"
    ...
    const-string/jumbo v2, "mGrayModeSetting:"
    ...
    const-string/jumbo v2, "mIsGrayScaleDisableByFingerPrint:"

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    sget-boolean v2, Lcom/android/server/fingerprint/FingerprintService;->mIsGrayScaleDisableByFingerPrint:Z
...
.method private forceSendEvent(II)V
    ...
    invoke-interface {v3, p1, p2, v1, v1}, Landroid/hardware/fingerprint/IFingerprintClientActiveCallback;->onFingerprintEventCallback(IIII)V
    :try_end_0
    ...
    iget-object v4, p0, Lcom/android/server/fingerprint/FingerprintService;->mClientActiveCallbacks:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method private handleFailAttemptForAttack()V
    ...
    iget v0, p0, Lcom/android/server/fingerprint/FingerprintService;->mFailedAttemptsForAttack:I
    ...
    iput-wide v2, p0, Lcom/android/server/fingerprint/FingerprintService;->mTimeStampStartCounting:J
    ...
    iget-wide v4, p0, Lcom/android/server/fingerprint/FingerprintService;->mTimeStampStartCounting:J
    ...
    const-string/jumbo v12, "handleFailAttemptForAttack: difference="
    ...
    const-string/jumbo v11, "under attack, raise criteria now"
    ...
    iput-wide v11, p0, Lcom/android/server/fingerprint/FingerprintService;->mTimeStampRaisingCriteria:J

    const-wide/16 v11, 0x0

    iput-wide v11, p0, Lcom/android/server/fingerprint/FingerprintService;->mTimeStampStartCounting:J

    iput v7, p0, Lcom/android/server/fingerprint/FingerprintService;->mFailedAttemptsForAttack:I

    const-string/jumbo v7, "lock_unlock_failed"

    const-string v9, "finger"

    const-string v11, "2"

    invoke-static {v7, v9, v11}, Lcom/oneplus/onlineconfig/MdmLogger;->log(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v11, "over time re-condisering if under attack"
    ...
    :cond_8
    :goto_3
    iget v2, p0, Lcom/android/server/fingerprint/FingerprintService;->mFailedAttemptsForAttack:I

    add-int/2addr v2, v1

    iput v2, p0, Lcom/android/server/fingerprint/FingerprintService;->mFailedAttemptsForAttack:I
    ...
    const-string/jumbo v3, "handleFailAttemptForAttack: "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v3, p0, Lcom/android/server/fingerprint/FingerprintService;->mFailedAttemptsForAttack:I
...
.method private restoreColorCorrectionState()V
    .locals 5
    ...
    iput-boolean v0, p0, Lcom/android/server/fingerprint/FingerprintService;->mTempDisableColorCorrection:Z

    sput-boolean v0, Lcom/android/server/fingerprint/FingerprintService;->mIsColorCalibrationDisableByFingerPrint:Z
...
.method private restoreGrayModeState()V
    .locals 5
...
.method private startEnrollment(Landroid/os/IBinder;[BILandroid/hardware/fingerprint/IFingerprintServiceReceiver;IZLjava/lang/String;)V
    ...
    invoke-direct {v13, v1}, Lcom/android/server/fingerprint/FingerprintService;->disableGrayMode(Z)V

    invoke-direct/range {p0 .. p0}, Lcom/android/server/fingerprint/FingerprintService;->disableColorCorrection()V
...
.method protected handleAcquired(JII)V
    ...
    invoke-direct {p0, p3, p4}, Lcom/android/server/fingerprint/FingerprintService;->forceSendEvent(II)V
...
.method protected handleRemoved(JIII)V
    ...
    const-string v2, "force reset aod clock type as default due to no remained fingerprint"
    ...
    invoke-static {v1, v2, v3, p4}, Landroid/provider/Settings$Secure;->putIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)Z
