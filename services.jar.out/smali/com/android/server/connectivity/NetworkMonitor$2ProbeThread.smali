...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/android/server/connectivity/NetworkMonitor;->sendParallelHttpChinaH2Probes(Landroid/net/ProxyInfo;Ljava/net/URL;Ljava/net/URL;Ljava/net/URL;Ljava/net/URL;)Landroid/net/captiveportal/CaptivePortalProbeResult;
.end annotation
...
# direct methods
.method public constructor <init>(Lcom/android/server/connectivity/NetworkMonitor;ILandroid/net/ProxyInfo;Ljava/net/URL;Ljava/net/URL;Ljava/net/URL;Ljava/net/URL;Ljava/util/concurrent/CountDownLatch;)V
    .locals 0
    ...
    iput-object p7, p0, Lcom/android/server/connectivity/NetworkMonitor$2ProbeThread;->val$httpsGoogleChinaUrl:Ljava/net/URL;

    iput-object p8, p0, Lcom/android/server/connectivity/NetworkMonitor$2ProbeThread;->val$latch:Ljava/util/concurrent/CountDownLatch;
    ...
    iput p3, p0, Lcom/android/server/connectivity/NetworkMonitor$2ProbeThread;->GOOGLE_HTTPS:I
...
.method public run()V
    ...
    iget-object v3, p0, Lcom/android/server/connectivity/NetworkMonitor$2ProbeThread;->val$httpsGoogleChinaUrl:Ljava/net/URL;

    invoke-static {v0, v1, v3, v2}, Lcom/android/server/connectivity/NetworkMonitor;->access$5500(Lcom/android/server/connectivity/NetworkMonitor;Landroid/net/ProxyInfo;Ljava/net/URL;I)Landroid/net/captiveportal/CaptivePortalProbeResult;
