...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/ProcessRecord;IILjava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/content/pm/ActivityInfo;Landroid/content/res/Configuration;Lcom/android/server/am/ActivityRecord;Ljava/lang/String;IZZLcom/android/server/am/ActivityStackSupervisor;Landroid/app/ActivityOptions;Lcom/android/server/am/ActivityRecord;)V
    ...
    iput-boolean v12, v6, Lcom/android/server/am/ActivityRecord;->isWeChatVideo:Z
    ...
    invoke-static {v0}, Lcom/android/server/am/CarModeHideStarting;->isWeChatVideo(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_15

    invoke-static {}, Lcom/android/server/am/CarModeHideStarting;->fetchOnlineWechatComponent()V

    iput-boolean v7, v6, Lcom/android/server/am/ActivityRecord;->isWeChatVideo:Z
    ...
    const-string v2, "DisplayCompat: enabled on r="
...
.method private supportsResizeableMultiWindow()Z
    ...
    iget-boolean v0, v0, Lcom/android/server/am/ActivityStack;->forceFreeformForHideStarting:Z
...
.method ensureActivityConfiguration(IZZ)Z
    ...
    invoke-direct {p0, v2, v7}, Lcom/android/server/am/ActivityRecord;->scheduleActivityMovedToDisplay(ILandroid/content/res/Configuration;)V
    ...
    invoke-virtual {v0, p0, v1, v8}, Lcom/android/server/am/ActivityStack;->destroyActivityLocked(Lcom/android/server/am/ActivityRecord;ZLjava/lang/String;)Z
...
.method public onWindowsVisible()V
    ...
    invoke-virtual {v3, v1}, Lcom/android/server/am/TaskRecord;->setLoadFinished(Z)V
