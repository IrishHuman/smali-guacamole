...
# instance fields
.field forceFreeformForHideStarting:Z
...
.method constructor <init>(Lcom/android/server/am/ActivityDisplay;ILcom/android/server/am/ActivityStackSupervisor;IIZ)V
    ...
    iput-boolean v1, p0, Lcom/android/server/am/ActivityStack;->forceFreeformForHideStarting:Z
...
.method private adjustFocusToNextFocusableStack(Ljava/lang/String;Z)Z
    ...
    const-string v4, "Don\'t get preload stack to be focus"
...
.method private resumeTopActivityInnerLocked(Lcom/android/server/am/ActivityRecord;Landroid/app/ActivityOptions;)Z
    ...
    invoke-virtual {v0, v3}, Lcom/android/server/am/ActivityManagerService$MainHandler;->sendMessage(Landroid/os/Message;)Z
    ...
    invoke-virtual {v0, v10, v11}, Lcom/android/server/preload/OneplusAppPreload;->onEvent(ILandroid/content/ContentValues;)V
    ...
    const-string/jumbo v10, "no-history finish of "

    invoke-virtual {v4, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v10, v7, Lcom/android/server/am/ActivityStack;->mLastNoHistoryActivity:Lcom/android/server/am/ActivityRecord;

    invoke-virtual {v4, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    const-string v10, " on new resume"
    ...
    const-string v3, "AppLocker: blocking resume "
    ...
    iget-object v3, v12, Lcom/android/server/am/ActivityRecord;->app:Lcom/android/server/am/ProcessRecord;
    ...
    iget-object v2, v2, Lcom/android/server/am/ActivityManagerService;->mConfirmIntent:Landroid/content/Intent;

    invoke-direct {v0, v2}, Landroid/content/Intent;-><init>(Landroid/content/Intent;)V

    const-string v2, "OP_APP_LOCKER_BLOCKING_UID"

    iget-object v3, v12, Lcom/android/server/am/ActivityRecord;->appInfo:Landroid/content/pm/ApplicationInfo;
    ...
    iget-object v3, v12, Lcom/android/server/am/ActivityRecord;->intent:Landroid/content/Intent;
    ...
    const-string/jumbo v3, "resumeTopActivityInnerLocked->AppLocker"
    ...
    iget v3, v3, Lcom/android/server/am/ActivityManagerService;->mRequestHashCode:I

    invoke-virtual {v2, v3}, Lcom/android/server/am/ActivityStarter;->setRequestCode(I)Lcom/android/server/am/ActivityStarter;

    move-result-object v2

    iget-object v3, v7, Lcom/android/server/am/ActivityStack;->mService:Lcom/android/server/am/ActivityManagerService;

    iget-object v3, v3, Lcom/android/server/am/ActivityManagerService;->mConfirmResolveInfo:Landroid/content/pm/ResolveInfo;

    iget-object v3, v3, Landroid/content/pm/ResolveInfo;->activityInfo:Landroid/content/pm/ActivityInfo;

    invoke-virtual {v2, v3}, Lcom/android/server/am/ActivityStarter;->setActivityInfo(Landroid/content/pm/ActivityInfo;)Lcom/android/server/am/ActivityStarter;
    ...
    iget-object v6, v12, Lcom/android/server/am/ActivityRecord;->resultWho:Ljava/lang/String;
    ...
    invoke-virtual/range {v26 .. v38}, Lcom/android/server/am/ActivityManagerService;->oemStartActivityAsCaller(Landroid/app/IApplicationThread;Ljava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/os/IBinder;Ljava/lang/String;IILandroid/app/ProfilerInfo;Landroid/os/Bundle;ZI)I
    :try_end_0
    ...
    sget-boolean v1, Lcom/android/server/am/ActivityManagerDebugConfig;->DEBUG_TRANSITION:Z
    ...
    invoke-virtual {v1, v2, v4}, Lcom/android/server/wm/WindowManagerService;->prepareAppTransition(IZ)V
    ...
    invoke-virtual {v8, v1}, Lcom/android/server/am/ActivityRecord;->setVisibility(Z)V
    ...
    invoke-virtual {v2, v1, v4}, Lcom/android/server/wm/WindowManagerService;->prepareAppTransition(IZ)V
    ...
    invoke-virtual {v3, v1, v2}, Lcom/android/server/wm/WindowManagerService;->prepareAppTransition(IZ)V
    ...
    iput-boolean v1, v0, Lcom/android/server/am/TaskRecord;->inPreload:Z
    ...
    iget-boolean v2, v12, Lcom/android/server/am/ActivityRecord;->stopped:Z
    ...
    iget-boolean v2, v12, Lcom/android/server/am/ActivityRecord;->visible:Z
    ...
    :try_start_7
    invoke-virtual {v0, v4, v5, v6}, Lcom/android/server/am/ActivityManagerService;->updateLruProcessLocked(Lcom/android/server/am/ProcessRecord;ZLcom/android/server/am/ProcessRecord;)V
    ...
    invoke-virtual {v4, v12, v5, v9, v6}, Lcom/android/server/am/ActivityStackSupervisor;->ensureVisibilityAndConfig(Lcom/android/server/am/ActivityRecord;IZZ)Z
    ...
    :goto_16
    :try_start_c
    iget-object v4, v12, Lcom/android/server/am/ActivityRecord;->newIntents:Ljava/util/ArrayList;
    :try_end_c
    ...
    :goto_17
    :try_start_e
    iget-boolean v4, v12, Lcom/android/server/am/ActivityRecord;->stopped:Z

    invoke-virtual {v12, v4}, Lcom/android/server/am/ActivityRecord;->notifyAppResumed(Z)V
    ...
    iput-boolean v4, v12, Lcom/android/server/am/ActivityRecord;->sleeping:Z

    iget-object v4, v7, Lcom/android/server/am/ActivityStack;->mService:Lcom/android/server/am/ActivityManagerService;

    invoke-virtual {v4}, Lcom/android/server/am/ActivityManagerService;->getAppWarningsLocked()Lcom/android/server/am/AppWarnings;

    move-result-object v4

    invoke-virtual {v4, v12}, Lcom/android/server/am/AppWarnings;->onResumeActivity(Lcom/android/server/am/ActivityRecord;)V

    iget-object v4, v7, Lcom/android/server/am/ActivityStack;->mService:Lcom/android/server/am/ActivityManagerService;

    invoke-virtual {v4, v12}, Lcom/android/server/am/ActivityManagerService;->showAskCompatModeDialogLocked(Lcom/android/server/am/ActivityRecord;)V

    iget-object v4, v12, Lcom/android/server/am/ActivityRecord;->app:Lcom/android/server/am/ProcessRecord;

    const/4 v6, 0x1

    iput-boolean v6, v4, Lcom/android/server/am/ProcessRecord;->pendingUiClean:Z
    ...
    invoke-virtual {v4, v6}, Lcom/android/server/am/ProcessRecord;->forceProcessStateUpTo(I)V
    ...
    invoke-virtual {v4, v0}, Lcom/android/server/am/ClientLifecycleManager;->scheduleTransaction(Landroid/app/servertransaction/ClientTransaction;)V
    ...
    invoke-virtual {v12, v3, v4}, Lcom/android/server/am/ActivityRecord;->setState(Lcom/android/server/am/ActivityStack$ActivityState;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v4, v5}, Lcom/android/server/am/ActivityRecord;->setState(Lcom/android/server/am/ActivityStack$ActivityState;Ljava/lang/String;)V
    ...
    iget-boolean v4, v12, Lcom/android/server/am/ActivityRecord;->hasBeenLaunched:Z

    if-nez v4, :cond_54

    const/4 v4, 0x1

    iput-boolean v4, v12, Lcom/android/server/am/ActivityRecord;->hasBeenLaunched:Z
    ...
    invoke-virtual {v12, v5, v4, v4}, Lcom/android/server/am/ActivityRecord;->showStartingWindow(Lcom/android/server/am/ActivityRecord;ZZ)V
    ...
    invoke-virtual {v4, v12, v6, v5}, Lcom/android/server/am/ActivityStackSupervisor;->startSpecificActivityLocked(Lcom/android/server/am/ActivityRecord;ZZ)V
...
.method final activityDestroyedLocked(Lcom/android/server/am/ActivityRecord;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/am/CarModeHideStarting;->needRestFreeform(Lcom/android/server/am/ActivityRecord;)Z
    ...
    invoke-virtual {v0}, Lcom/android/server/wm/WindowManagerService;->hasWechatFloating()Z
...
.method addToStopping(Lcom/android/server/am/ActivityRecord;ZZ)V
    ...
    const-string v2, "adding to waiting visible activity="
    ...
    const-string/jumbo v2, "meituan activity record: "
...
.method final finishActivityLocked(Lcom/android/server/am/ActivityRecord;ILandroid/content/Intent;Ljava/lang/String;ZZ)Z
    ...
    invoke-virtual {v0, v2}, Lcom/android/server/am/CarModeHideStarting;->needRestFreeform(Lcom/android/server/am/ActivityRecord;)Z
    ...
    invoke-virtual {v0, v4}, Lcom/android/server/am/CarModeHideStarting;->resetCarModeHideStartingStack(Lcom/android/server/am/ActivityStack;)V
...
.method public makeInvisible(Lcom/android/server/am/ActivityRecord;)V
    ...
    sget-object v4, Lcom/android/server/am/ActivityStack$2;->$SwitchMap$com$android$server$am$ActivityStack$ActivityState:[I
...
.method moveToBack(Ljava/lang/String;Lcom/android/server/am/TaskRecord;)V
    ...
    invoke-virtual {v0}, Lcom/android/server/am/ActivityStack;->getChildCount()I
    ...
    invoke-virtual {v1, p1, v2}, Lcom/android/server/am/ActivityStackSupervisor;->setFocusStackUnchecked(Ljava/lang/String;Lcom/android/server/am/ActivityStack;)V
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/server/am/ActivityManagerService;->startHomeActivityLocked(ILjava/lang/String;)Z
...
.method setWindowingMode(IZZZZ)V
    ...
    iget-boolean v10, v1, Lcom/android/server/am/ActivityStack;->forceFreeformForHideStarting:Z
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/am/ActivityStack;->isActivityTypeRecents()Z
    ...
    :cond_9
    iget-boolean v0, v1, Lcom/android/server/am/ActivityStack;->mUpdateBoundsDeferred:Z
    ...
    const-string/jumbo v3, "setWindowingMode continueUpdateBounds for "
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/am/ActivityStack;->continueUpdateBounds()V
    ...
    invoke-virtual {v11}, Lcom/android/server/am/ActivityRecord;->isNonResizableOrForcedResizable()Z
    ...
    iget-object v0, v11, Lcom/android/server/am/ActivityRecord;->appInfo:Landroid/content/pm/ApplicationInfo;
