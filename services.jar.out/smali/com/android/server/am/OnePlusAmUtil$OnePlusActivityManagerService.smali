...
.method public appDiedLocked(Lcom/android/server/am/ProcessRecord;ILandroid/app/IApplicationThread;Z)V
    ...
    iget-object v1, p0, Lcom/android/server/am/OnePlusAmUtil$OnePlusActivityManagerService;->mOHPD:Lcom/android/server/am/OnePlusHighPowerDetector;

    invoke-virtual {v1}, Lcom/android/server/am/OnePlusHighPowerDetector;->cancelBgDetectNotificationIfNeeded()V
    ...
    invoke-static {}, Lcom/android/server/CarModeDockHandler;->handleResetCarModeFlags()V
...
.method public finishBooting()V
    ...
    invoke-static {}, Lcom/android/server/am/OnePlusPerfController;->getInstance()Lcom/android/server/am/OnePlusPerfController;

    move-result-object v0

    iget-object v1, p0, Lcom/android/server/am/OnePlusAmUtil$OnePlusActivityManagerService;->mContext:Landroid/content/Context;

    invoke-virtual {v0, v1}, Lcom/android/server/am/OnePlusPerfController;->init(Landroid/content/Context;)V

    return-void
.end method

.method final forceStopPackageLocked(Ljava/lang/String;IZZZZZILjava/lang/String;)V
    .locals 3
...
.method public systemReady(Ljava/lang/Runnable;Landroid/util/TimingsTraceLog;)V
    ...
    iget-object v3, p0, Lcom/android/server/am/OnePlusAmUtil$OnePlusActivityManagerService;->mBatteryStatsService:Lcom/android/server/am/BatteryStatsService;

    iget-object v4, p0, Lcom/android/server/am/OnePlusAmUtil$OnePlusActivityManagerService;->mRestartProcessManager:Lcom/android/server/am/RestartProcessManager;

    invoke-static {v1, v2, v3, v4}, Lcom/android/server/am/OnePlusHighPowerDetector;->getInstance(Lcom/android/server/am/ActivityManagerService;Landroid/content/Context;Lcom/android/server/am/BatteryStatsService;Lcom/android/server/am/RestartProcessManager;)Lcom/android/server/am/OnePlusHighPowerDetector;

    move-result-object v1

    iput-object v1, p0, Lcom/android/server/am/OnePlusAmUtil$OnePlusActivityManagerService;->mOHPD:Lcom/android/server/am/OnePlusHighPowerDetector;

    :cond_6
    iget-boolean v1, p0, Lcom/android/server/am/OnePlusAmUtil$OnePlusActivityManagerService;->mNetBoostFeature:Z

    if-eqz v1, :cond_7

    iget-object v1, p0, Lcom/android/server/am/OnePlusAmUtil$OnePlusActivityManagerService;->mAms:Lcom/android/server/am/ActivityManagerService;

    invoke-static {v1}, Lcom/android/server/am/OnePlusNetCgroupSetManager;->getInstance(Lcom/android/server/am/ActivityManagerService;)Lcom/android/server/am/OnePlusNetCgroupSetManager;

    move-result-object v1

    iput-object v1, p0, Lcom/android/server/am/OnePlusAmUtil$OnePlusActivityManagerService;->mOnePlusNetCgroupSetManager:Lcom/android/server/am/OnePlusNetCgroupSetManager;

    iget-object v1, p0, Lcom/android/server/am/OnePlusAmUtil$OnePlusActivityManagerService;->mAms:Lcom/android/server/am/ActivityManagerService;

    invoke-static {v1}, Lcom/android/server/am/OemSceneWiFiBoostController;->getInstance(Lcom/android/server/am/ActivityManagerService;)Lcom/android/server/am/OemSceneWiFiBoostController;

    move-result-object v1

    iput-object v1, p0, Lcom/android/server/am/OnePlusAmUtil$OnePlusActivityManagerService;->mOemSceneWiFiBoostController:Lcom/android/server/am/OemSceneWiFiBoostController;
    ...
    invoke-static {v1}, Lcom/android/server/am/OnePlusDuallteManager;->getInstance(Lcom/android/server/am/ActivityManagerService;)Lcom/android/server/am/OnePlusDuallteManager;
    ...
    invoke-virtual {v1, v2}, Lcom/oneplus/oiface/OifaceManager;->initOnlineConfig(Landroid/content/Context;)V
    ...
    invoke-virtual {v1, v2}, Lcom/android/server/am/OnePlusTemperatureMonitor;->initEnv(Landroid/content/Context;)V
    ...
    invoke-static {v1, v2, v3}, Lcom/android/server/am/OnePlusPowerConsumptionStatistic;->getInstance(Landroid/content/Context;Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/BatteryStatsService;)Lcom/android/server/am/OnePlusPowerConsumptionStatistic;

    invoke-static {}, Lcom/android/server/am/OemSceneStereoController;->initEnv()V
    ...
    invoke-static {v1}, Lcom/android/server/OemSceneFloatWindowController;->initEnv(Lcom/android/server/am/OnePlusAmUtil$OnePlusActivityManagerService;)V

    sget-boolean v1, Lserver/oneplus/scene/OemSceneXLinearVibrationMotorController;->IN_USING:Z

    if-eqz v1, :cond_9

    :try_start_1
    new-instance v1, Lcom/android/server/am/HapticEffect;

    invoke-direct {v1, v0, v0}, Lcom/android/server/am/HapticEffect;-><init>(II)V
    ...
    invoke-static {v0}, Lserver/oneplus/scene/OemSceneXLinearVibrationMotorController;->setHapticEffect(Lcom/android/server/am/HapticEffect;)V
    :try_end_1
