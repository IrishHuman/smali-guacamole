...
.method static synthetic access$8100(Lcom/android/server/am/OnePlusPowerConsumptionStatistic$PowerConsumption;Lcom/android/internal/os/BatterySipper;)V
    .locals 0
...
.method static synthetic access$8200(Lcom/android/server/am/OnePlusPowerConsumptionStatistic$PowerConsumption;)Z
    .locals 1
...
.method static synthetic access$8400(Lcom/android/server/am/OnePlusPowerConsumptionStatistic$PowerConsumption;Lcom/android/internal/os/BatterySipper;Lcom/android/server/am/OnePlusPowerConsumptionStatistic$PowerConsumption;)V
    .locals 0
...
.method static synthetic access$8500(Lcom/android/server/am/OnePlusPowerConsumptionStatistic$PowerConsumption;Lcom/android/server/am/OnePlusPowerConsumptionStatistic$PowerConsumption;)Z
    .locals 1
...
.method static synthetic access$9400(Lcom/android/server/am/OnePlusPowerConsumptionStatistic$PowerConsumption;IZ)Ljava/lang/String;
    .locals 1
...
.method private initDrainType()V
    ...
    invoke-static {v0, v1}, Lcom/android/server/am/OnePlusPowerConsumptionStatistic;->access$8900(Lcom/android/server/am/OnePlusPowerConsumptionStatistic;I)Ljava/lang/String;
...
.method private initPkgNameByUid()Z
    ...
    invoke-static {v0}, Lcom/android/server/am/OnePlusPowerConsumptionStatistic;->access$2100(Lcom/android/server/am/OnePlusPowerConsumptionStatistic;)Landroid/content/Context;
    ...
    invoke-static {v0}, Lcom/android/server/am/OnePlusPowerConsumptionStatistic;->access$9000(Lcom/android/server/am/OnePlusPowerConsumptionStatistic;)Lcom/android/server/pm/PackageManagerService;

    move-result-object v0

    iget-object v2, p0, Lcom/android/server/am/OnePlusPowerConsumptionStatistic$PowerConsumption;->pkgName:Ljava/lang/String;

    invoke-virtual {v0, v2}, Lcom/android/server/pm/PackageManagerService;->getPakcageInfo(Ljava/lang/String;)Landroid/content/pm/PackageParser$Package;

    move-result-object v0

    if-eqz v0, :cond_2

    iget-object v2, v0, Landroid/content/pm/PackageParser$Package;->mVersionName:Ljava/lang/String;

    iput-object v2, p0, Lcom/android/server/am/OnePlusPowerConsumptionStatistic$PowerConsumption;->versionName:Ljava/lang/String;

    iget v2, v0, Landroid/content/pm/PackageParser$Package;->mVersionCode:I

    iput v2, p0, Lcom/android/server/am/OnePlusPowerConsumptionStatistic$PowerConsumption;->versionCode:I
...
.method private toMDM(IZ)Ljava/lang/String;
    ...
    invoke-static {v1, v2}, Lcom/android/server/am/OnePlusPowerConsumptionStatistic;->access$9100(D)Ljava/lang/String;
