...
.method public compatibilityInfoForPackageLocked(Landroid/content/pm/ApplicationInfo;)Landroid/content/res/CompatibilityInfo;
    ...
    invoke-static {v0, v1}, Lcom/android/server/wm/WindowManagerService;->isDisplayCompat(Ljava/lang/String;I)Z
    ...
    invoke-static {v0}, Lcom/android/server/wm/WindowManagerService;->getDensityForResolution(I)I
    ...
    iput v0, p1, Landroid/content/pm/ApplicationInfo;->privateFlags:I
    ...
    const-string v3, "DisplayCompat: compatibilityInfoForPackageLocked for "
    ...
    iput v1, p1, Landroid/content/pm/ApplicationInfo;->overrideDensity:I
    ...
    const-string v3, "DisplayCompat: compatibilityInfoForPackageLocked reset compat for "
    ...
    :cond_2
    invoke-direct {v2, p1, v3, v4, v1}, Landroid/content/res/CompatibilityInfo;-><init>(Landroid/content/pm/ApplicationInfo;IIZ)V
