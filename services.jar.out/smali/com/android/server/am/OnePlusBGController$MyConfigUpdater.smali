...
.method public resolveConfigFromJSON(Lorg/json/JSONArray;)V
    ...
    const-string v2, "Preload_Criteria"
    ...
    const-string v3, "Preload_Criteria"
    ...
    const-string v3, "[OnlineConfig] Preload_Criteria: "
    ...
    invoke-static {v2, v3}, Lcom/android/server/am/OnePlusBGController;->access$2202(Lcom/android/server/am/OnePlusBGController;F)F
    ...
    invoke-static {v3}, Lcom/android/server/am/OnePlusBGController;->access$2200(Lcom/android/server/am/OnePlusBGController;)F
    ...
    invoke-static {v2, v3}, Lcom/android/server/am/OnePlusBGController;->access$2302(Lcom/android/server/am/OnePlusBGController;F)F
    ...
    invoke-static {v3}, Lcom/android/server/am/OnePlusBGController;->access$2300(Lcom/android/server/am/OnePlusBGController;)F
    ...
    invoke-static {v2, v3}, Lcom/android/server/am/OnePlusBGController;->access$2402(Lcom/android/server/am/OnePlusBGController;F)F
    ...
    invoke-static {v3}, Lcom/android/server/am/OnePlusBGController;->access$2400(Lcom/android/server/am/OnePlusBGController;)F
    ...
    invoke-static {v2, v3}, Lcom/android/server/am/OnePlusBGController;->access$2502(Lcom/android/server/am/OnePlusBGController;F)F
    ...
    invoke-static {v3}, Lcom/android/server/am/OnePlusBGController;->access$2500(Lcom/android/server/am/OnePlusBGController;)F
    ...
    const-string v3, "Bg_GMSCriteria"
    ...
    invoke-static {v2, v3}, Lcom/android/server/am/OnePlusBGController;->access$2602(Lcom/android/server/am/OnePlusBGController;F)F

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "[OnlineConfig] Bg_GMSCriteria: "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v3, p0, Lcom/android/server/am/OnePlusBGController$MyConfigUpdater;->this$0:Lcom/android/server/am/OnePlusBGController;

    invoke-static {v3}, Lcom/android/server/am/OnePlusBGController;->access$2600(Lcom/android/server/am/OnePlusBGController;)F
    ...
    invoke-static {v3}, Lcom/android/server/am/OnePlusBGController;->access$2700(Lcom/android/server/am/OnePlusBGController;)Ljava/util/HashSet;
    ...
    invoke-static {v4}, Lcom/android/server/am/OnePlusBGController;->access$2700(Lcom/android/server/am/OnePlusBGController;)Ljava/util/HashSet;
