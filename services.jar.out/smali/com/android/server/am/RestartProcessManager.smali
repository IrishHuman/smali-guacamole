...
.field private static final NUM_CLUSTERS:I = 0x5

.field private static final NUM_CLUSTERS_GENERAL:I = 0x1

.field private static final NUM_CLUSTERS_HIGH:I = 0x3

.field private static final NUM_CLUSTERS_LOW:I = 0x1
...
.field private mCurrentMaxDayRecord:I
...
.field public mHasReadAllPackages:Z

.field private mHasWarmUp:Z
...
.field public mInitPkgsFromSystemReady:Z

.field public mInitPkgsFromUnlock:Z

.field private mLastRankTime:J

.field private mLastRunningPackage:Ljava/lang/String;

.field private mLastWriteRecordTime:J
...
.field private mStartWarmUpTime:J

.field private mUpdatingPackage:Ljava/lang/String;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/am/RestartProcessManager;->sWritingRecord:Z

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    sput-object v1, Lcom/android/server/am/RestartProcessManager;->sAllPackagesInfo:Ljava/util/HashMap;
    ...
    sput-wide v2, Lcom/android/server/am/RestartProcessManager;->WRITE_RECORD_DURATION:J

    sput-wide v2, Lcom/android/server/am/RestartProcessManager;->RANK_DURAION:J

    const/16 v2, 0x1e

    sput v2, Lcom/android/server/am/RestartProcessManager;->RECORD_LIMIT:I
...
.method public constructor <init>(Ljava/io/File;)V
    ...
    iput-boolean v0, p0, Lcom/android/server/am/RestartProcessManager;->mInitPkgsFromUnlock:Z

    iput-boolean v0, p0, Lcom/android/server/am/RestartProcessManager;->mInitPkgsFromSystemReady:Z

    iput-boolean v0, p0, Lcom/android/server/am/RestartProcessManager;->mHasReadAllPackages:Z

    iput-boolean v0, p0, Lcom/android/server/am/RestartProcessManager;->mHasWarmUp:Z

    const-wide/16 v1, 0x0

    iput-wide v1, p0, Lcom/android/server/am/RestartProcessManager;->mStartWarmUpTime:J

    const-string v3, ""

    iput-object v3, p0, Lcom/android/server/am/RestartProcessManager;->mLastRunningPackage:Ljava/lang/String;

    const-string v3, ""

    iput-object v3, p0, Lcom/android/server/am/RestartProcessManager;->mUpdatingPackage:Ljava/lang/String;

    iput v0, p0, Lcom/android/server/am/RestartProcessManager;->mCurrentMaxDayRecord:I

    iput-wide v1, p0, Lcom/android/server/am/RestartProcessManager;->mLastRankTime:J

    iput-wide v1, p0, Lcom/android/server/am/RestartProcessManager;->mLastWriteRecordTime:J
...
.method static synthetic access$002(Lcom/android/server/am/RestartProcessManager;J)J
    .locals 0

    iput-wide p1, p0, Lcom/android/server/am/RestartProcessManager;->mLastWriteRecordTime:J
...
.method static synthetic access$300(Lcom/android/server/am/RestartProcessManager;)Z
    .locals 1

    iget-boolean v0, p0, Lcom/android/server/am/RestartProcessManager;->mHasWarmUp:Z

    return v0
.end method

.method static synthetic access$302(Lcom/android/server/am/RestartProcessManager;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/android/server/am/RestartProcessManager;->mHasWarmUp:Z
...
.method static synthetic access$3200(Lcom/android/server/am/RestartProcessManager;)I
    .locals 1

    iget v0, p0, Lcom/android/server/am/RestartProcessManager;->mCurrentMaxDayRecord:I

    return v0
.end method

.method static synthetic access$3202(Lcom/android/server/am/RestartProcessManager;I)I
    .locals 0

    iput p1, p0, Lcom/android/server/am/RestartProcessManager;->mCurrentMaxDayRecord:I

    return p1
.end method

.method static synthetic access$3302(Lcom/android/server/am/RestartProcessManager;Ljava/lang/String;)Ljava/lang/String;
    .locals 0

    iput-object p1, p0, Lcom/android/server/am/RestartProcessManager;->mLastRunningPackage:Ljava/lang/String;
...
.method static synthetic access$400(Lcom/android/server/am/RestartProcessManager;)J
    .locals 2

    iget-wide v0, p0, Lcom/android/server/am/RestartProcessManager;->mStartWarmUpTime:J

    return-wide v0
.end method

.method static synthetic access$402(Lcom/android/server/am/RestartProcessManager;J)J
    .locals 0

    iput-wide p1, p0, Lcom/android/server/am/RestartProcessManager;->mStartWarmUpTime:J
...
.method private doCleanData(J)V
    ...
    iput-wide v0, p0, Lcom/android/server/am/RestartProcessManager;->mLastRankTime:J

    iput-wide v0, p0, Lcom/android/server/am/RestartProcessManager;->mLastWriteRecordTime:J
...
.method private getAllPackagesByUsage(Z)Ljava/util/HashMap;
    ...
    iput-wide v4, v1, Lcom/android/server/am/RestartProcessManager;->mLastRankTime:J

    goto :goto_0

    :cond_3
    iget-boolean v0, v1, Lcom/android/server/am/RestartProcessManager;->mHasReadAllPackages:Z

    if-eqz v0, :cond_d

    iget-boolean v0, v1, Lcom/android/server/am/RestartProcessManager;->mInitPkgsFromUnlock:Z

    if-eqz v0, :cond_d

    iget-boolean v0, v1, Lcom/android/server/am/RestartProcessManager;->mInitPkgsFromSystemReady:Z

    if-eqz v0, :cond_d

    iget-wide v4, v1, Lcom/android/server/am/RestartProcessManager;->mLastRankTime:J
    ...
    iget-object v11, v1, Lcom/android/server/am/RestartProcessManager;->mClusters:Ljava/util/ArrayList;
    ...
    invoke-virtual {v11}, Lcom/android/server/am/RestartProcessManager$Cluster;->dump()V
...
.method private initEssentials()V
    ...
    iput-wide v0, p0, Lcom/android/server/am/RestartProcessManager;->mStartWarmUpTime:J
...
.method private rankAllPkgs()V
    ...
    :goto_2
    iget v10, v1, Lcom/android/server/am/RestartProcessManager;->mCurrentMaxDayRecord:I
    :try_end_3
    ...
    iget v8, v1, Lcom/android/server/am/RestartProcessManager;->mCurrentMaxDayRecord:I
    ...
    iget v15, v1, Lcom/android/server/am/RestartProcessManager;->mCurrentMaxDayRecord:I
    ...
    :goto_9
    iget v13, v1, Lcom/android/server/am/RestartProcessManager;->mCurrentMaxDayRecord:I
...
.method private readFileContent(Ljava/io/File;)V
    ...
    iget-boolean v4, p0, Lcom/android/server/am/RestartProcessManager;->mHasWarmUp:Z
    ...
    iget-wide v5, p0, Lcom/android/server/am/RestartProcessManager;->mStartWarmUpTime:J
    ...
    iput-boolean v5, p0, Lcom/android/server/am/RestartProcessManager;->mHasWarmUp:Z
    ...
    iget-boolean v7, p0, Lcom/android/server/am/RestartProcessManager;->mHasWarmUp:Z
    ...
    iput-wide v5, p0, Lcom/android/server/am/RestartProcessManager;->mStartWarmUpTime:J
    ...
    iget-wide v7, p0, Lcom/android/server/am/RestartProcessManager;->mStartWarmUpTime:J
    ...
    invoke-direct {v5, p0, v2, v7, v6}, Lcom/android/server/am/RestartProcessManager$PackageRankInfo;-><init>(Lcom/android/server/am/RestartProcessManager;Ljava/lang/String;ZZ)V
...
.method private readOldRecord()V
    ...
    iput-boolean v2, p0, Lcom/android/server/am/RestartProcessManager;->mHasReadAllPackages:Z
...
.method public addNewPackages(Ljava/lang/String;)V
    ...
    invoke-direct {v0, p0, p1, v1, v2}, Lcom/android/server/am/RestartProcessManager$PackageRankInfo;-><init>(Lcom/android/server/am/RestartProcessManager;Ljava/lang/String;ZZ)V
...
.method public cleanAllData(J)V
    ...
    iget-boolean v0, p0, Lcom/android/server/am/RestartProcessManager;->mInitPkgsFromSystemReady:Z
...
.method public hasWarmUp()Z
    ...
    iget-wide v2, p0, Lcom/android/server/am/RestartProcessManager;->mStartWarmUpTime:J
...
.method public initialAllPackage(Ljava/util/ArrayList;)V
    ...
    invoke-direct {v4, p0, v1, v2, v2}, Lcom/android/server/am/RestartProcessManager$PackageRankInfo;-><init>(Lcom/android/server/am/RestartProcessManager;Ljava/lang/String;ZZ)V
...
.method public removePackage(Ljava/lang/String;)V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/server/am/RestartProcessManager;->mUpdatingPackage:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/android/server/am/RestartProcessManager;->mUpdatingPackage:Ljava/lang/String;
...
.method public setUpdatingPackage(Ljava/lang/String;)V
    ...
    :try_start_0
    iput-object p1, p0, Lcom/android/server/am/RestartProcessManager;->mUpdatingPackage:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/server/am/RestartProcessManager;->mUpdatingPackage:Ljava/lang/String;
...
.method public updateLaunchTime(Ljava/lang/String;J)V
    ...
    const-string v3, "LastRunningPackage (null) : "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v3, p0, Lcom/android/server/am/RestartProcessManager;->mLastRunningPackage:Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/server/am/RestartProcessManager;->mLastRunningPackage:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/server/am/RestartProcessManager;->mLastRunningPackage:Ljava/lang/String;
...
.method public writeRecord(Z)V
    ...
    iget-wide v2, p0, Lcom/android/server/am/RestartProcessManager;->mLastWriteRecordTime:J
