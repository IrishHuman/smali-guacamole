...
.method private putStacksToSleepLocked(ZZ)Z
    ...
    const-string/jumbo v6, "goToSleep: avoid IndexOutOfBoundsException,stack Index: "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v5, v3}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v6, " display child count: "
...
.method acquireAppLaunchPerfLock(Lcom/android/server/am/ActivityRecord;)V
    ...
    invoke-virtual {v0, v3, v4, v2, v1}, Landroid/util/BoostFramework;->perfHint(ILjava/lang/String;II)I

    sput-boolean v1, Lcom/android/server/am/ActivityStackSupervisor;->mPerfSendTapHint:Z
    ...
    invoke-virtual {v0, v3, v4, v2, v5}, Landroid/util/BoostFramework;->perfHint(ILjava/lang/String;II)I
    ...
    invoke-virtual {v0, v4, v6}, Landroid/util/BoostFramework;->perfGetFeedback(ILjava/lang/String;)I
    ...
    sput-boolean v1, Lcom/android/server/am/ActivityStackSupervisor;->mIsPerfBoostAcquired:Z
    ...
    iget-object v7, p1, Lcom/android/server/am/ActivityRecord;->appInfo:Landroid/content/pm/ApplicationInfo;
    ...
    invoke-virtual {v0, v2, v4, v5}, Landroid/util/BoostFramework;->perfIOPrefetchStart(ILjava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {v2, v3, v4, v0, v1}, Landroid/util/BoostFramework;->perfHint(ILjava/lang/String;II)I
    ...
    invoke-virtual {v4, v3, v5, v2, v1}, Landroid/util/BoostFramework;->perfHint(ILjava/lang/String;II)I
    ...
    invoke-virtual {v2, v3}, Lcom/android/server/am/OnePlusPerfManager;->acuqirePerfForStartSpeed(Ljava/lang/String;)Z
...
.method attachAppLaunchLock(Lcom/android/server/am/ProcessRecord;I)V
    .locals 9
    ...
    invoke-static {}, Lcom/android/server/am/OnePlusRamBoostManager;->isIopPreloadEnabled()Z
    ...
    iget-object v1, p0, Lcom/android/server/am/ActivityStackSupervisor;->mTmpActivityList:Ljava/util/ArrayList;

    invoke-virtual {v0, v1}, Lcom/android/server/am/ActivityStack;->getAllRunningVisibleActivitiesLocked(Ljava/util/ArrayList;)V
    ...
    iget-object v3, v1, Lcom/android/server/am/ActivityRecord;->processName:Ljava/lang/String;
    ...
    invoke-virtual {v2, v3, v4, v5}, Lcom/android/server/am/OnePlusRamBoostManager;->notifyIOPrefetchStart(ILjava/lang/String;Ljava/lang/String;)V
...
.method cleanUpRemovedTaskLocked(Lcom/android/server/am/TaskRecord;ZZ)V
    ...
    invoke-virtual {v0, v12, v13, v14}, Lcom/android/server/am/OnePlusAppBootManager;->canKillProcessService(Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method ensureActivitiesVisibleLocked(Lcom/android/server/am/ActivityRecord;IZZ)V
    ...
    const-string v5, "avoid IndexOutOfBoundsException, stack Index: "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v4, v2}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v5, " display child count: "
...
.method getLaunchStack(Lcom/android/server/am/ActivityRecord;Landroid/app/ActivityOptions;Lcom/android/server/am/TaskRecord;ZI)Lcom/android/server/am/ActivityStack;
    ...
    iget-boolean v3, v14, Lcom/android/server/am/ActivityStack;->forceFreeformForHideStarting:Z
...
.method protected getPreloadStack()Lcom/android/server/am/ActivityStack;
    ...
    const-string/jumbo v3, "getPreloadStack is null , stack id : "
...
.method public pauseTask(IZ)V
    ...
    invoke-virtual {v2, v6}, Lcom/android/server/am/ActivityStack;->makeInvisible(Lcom/android/server/am/ActivityRecord;)V

    goto :goto_1

    :cond_8
    const-string v7, "AppPreload"

    const-string/jumbo v8, "resumedActivity is null when pause"
