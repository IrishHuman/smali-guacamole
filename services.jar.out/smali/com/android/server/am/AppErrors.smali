...
.field private static sBadProcessCount:I

.field private static sBadProcessTimeout:J
...
.field private final mCheckKilledResetTimes:Lcom/android/internal/app/ProcessMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/android/internal/app/ProcessMap<",
            "Ljava/lang/Long;",
...
.field private final mCheckKilledTotalCounts:Lcom/android/internal/app/ProcessMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/android/internal/app/ProcessMap<",
            "Ljava/lang/Integer;",
...
.method static constructor <clinit>()V
    ...
    sput-wide v0, Lcom/android/server/am/AppErrors;->sBadProcessTimeout:J

    const/16 v0, 0x14

    sput v0, Lcom/android/server/am/AppErrors;->sBadProcessCount:I
...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/am/ActivityManagerService;)V
    ...
    iput-object v0, p0, Lcom/android/server/am/AppErrors;->mCheckKilledResetTimes:Lcom/android/internal/app/ProcessMap;

    new-instance v0, Lcom/android/internal/app/ProcessMap;

    invoke-direct {v0}, Lcom/android/internal/app/ProcessMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/am/AppErrors;->mCheckKilledTotalCounts:Lcom/android/internal/app/ProcessMap;
...
# virtual methods
.method addToBad(Lcom/android/server/am/ProcessRecord;JLjava/lang/String;Ljava/lang/String;)V
    .locals 13
    ...
    invoke-direct/range {v6 .. v11}, Lcom/android/server/am/AppErrors$BadProcessInfo;-><init>(JLjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v0, v4, v5, v12}, Lcom/android/internal/app/ProcessMap;->put(Ljava/lang/String;ILjava/lang/Object;)Ljava/lang/Object;
...
.method final appNotResponding(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;ZLjava/lang/String;)V
    ...
    invoke-virtual {v0, v4}, Lcom/android/server/preload/AbnormalMonitor;->appAnr(Ljava/lang/String;)V
    ...
    invoke-static {v5, v10, v0, v2, v6}, Lcom/android/server/am/ActivityManagerService;->dumpStackTraces(ZLjava/util/ArrayList;Lcom/android/internal/os/ProcessCpuTracker;Landroid/util/SparseArray;Ljava/util/ArrayList;)Ljava/io/File;
...
.method configBadProcess(JI)V
    ...
    const-string v2, "configBadProcess: timeout="
    ...
    sput-wide p1, Lcom/android/server/am/AppErrors;->sBadProcessTimeout:J

    sput p3, Lcom/android/server/am/AppErrors;->sBadProcessCount:I
...
.method handleAppKilledLocked(Lcom/android/server/am/ProcessRecord;)Z
    ...
    iget-object v0, p0, Lcom/android/server/am/AppErrors;->mCheckKilledResetTimes:Lcom/android/internal/app/ProcessMap;
    ...
    iget-object v1, p0, Lcom/android/server/am/AppErrors;->mCheckKilledTotalCounts:Lcom/android/internal/app/ProcessMap;
    ...
    iget-object v1, p0, Lcom/android/server/am/AppErrors;->mCheckKilledResetTimes:Lcom/android/internal/app/ProcessMap;
    ...
    sget-wide v3, Lcom/android/server/am/AppErrors;->sBadProcessTimeout:J
    ...
    sget v2, Lcom/android/server/am/AppErrors;->sBadProcessCount:I
    ...
    invoke-virtual/range {v1 .. v6}, Lcom/android/server/am/AppErrors;->addToBad(Lcom/android/server/am/ProcessRecord;JLjava/lang/String;Ljava/lang/String;)V
