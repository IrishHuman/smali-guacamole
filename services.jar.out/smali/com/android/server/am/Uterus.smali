...
.field private final mSupervisorLock:Ljava/lang/Object;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/am/Uterus;->mSupervisorLock:Ljava/lang/Object;
    ...
    const-string v4, "Uterus: memTotal="
    ...
    const-string v4, "Uterus: set limit 0"
    ...
    :cond_0
    const-string/jumbo v3, "persist.sys.embryo.limit"

    invoke-static {v3, v2}, Landroid/os/SystemProperties;->getInt(Ljava/lang/String;I)I

    move-result v3

    sput v3, Lcom/android/server/am/Uterus;->MAX:I

    new-instance v3, Landroid/os/HandlerThread;

    const-string v4, "EmbryoManager"

    invoke-direct {v3, v4}, Landroid/os/HandlerThread;-><init>(Ljava/lang/String;)V

    iput-object v3, p0, Lcom/android/server/am/Uterus;->mThread:Landroid/os/HandlerThread;

    iget-object v3, p0, Lcom/android/server/am/Uterus;->mThread:Landroid/os/HandlerThread;

    invoke-virtual {v3}, Landroid/os/HandlerThread;->start()V

    new-instance v3, Landroid/os/Handler;

    iget-object v4, p0, Lcom/android/server/am/Uterus;->mThread:Landroid/os/HandlerThread;
    ...
    iput-object v3, p0, Lcom/android/server/am/Uterus;->mHandler:Landroid/os/Handler;
...
.method public goingToSleep()V
    ...
    iget-object v0, p0, Lcom/android/server/am/Uterus;->mSupervisorLock:Ljava/lang/Object;
...
.method public killEmbryoProcesses(Z)V
    ...
    const-string/jumbo v2, "killEmbryoProcesses: compat="
    ...
    invoke-virtual {v3}, Lcom/android/server/am/EmbryoSupervisor;->getInfo()Landroid/content/pm/ApplicationInfo;
    ...
    iget v7, v4, Landroid/content/pm/ApplicationInfo;->privateFlags:I
    ...
    sget-boolean v6, Lcom/android/server/am/Uterus;->DEBUG_ONEPLUS:Z

    if-eqz v6, :cond_3

    const-string v6, "Embryo_Uterus"

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v8, "kill embryo:"
    ...
    :cond_3
    invoke-virtual {v3}, Lcom/android/server/am/EmbryoSupervisor;->isWaitingForFork()Z

    move-result v6

    if-eqz v6, :cond_4

    invoke-virtual {v3}, Lcom/android/server/am/EmbryoSupervisor;->setAbortion()V

    goto :goto_2

    :cond_4
    invoke-virtual {v3}, Lcom/android/server/am/EmbryoSupervisor;->destroy()V
...
.method public resume(Ljava/lang/String;ZI)V
    ...
    iget-object v1, p0, Lcom/android/server/am/Uterus;->mSupervisorLock:Ljava/lang/Object;
    ...
    iput-object v2, p0, Lcom/android/server/am/Uterus;->mCurrentSupervisor:Lcom/android/server/am/EmbryoSupervisor;
    ...
    invoke-virtual {v2}, Lcom/android/server/am/EmbryoSupervisor;->start()V
    ...
    iget-object v4, p0, Lcom/android/server/am/Uterus;->mCurrentSupervisor:Lcom/android/server/am/EmbryoSupervisor;
