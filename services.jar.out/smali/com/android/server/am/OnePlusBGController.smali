...
.field public static final GMS_PKGNAME:Ljava/lang/String; = "com.google.android.gms"
...
.field private static mAmsHanlder:Landroid/os/Handler;
...
.field private static mPreloadUidSet:Ljava/util/HashSet;
...
.field private static sGMS_Uid:I
...
.field private mBg_GMSCriteria:F
...
.field private mNetWorkType:Lcom/android/server/am/OnePlusBGController$NET_TYPE;

.field private mPreload_Criteria:F
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/android/server/am/OnePlusBGController;->sGMS_Uid:I
    ...
    sput-object v0, Lcom/android/server/am/OnePlusBGController;->mPreloadUidSet:Ljava/util/HashSet;
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/BatteryStatsService;Lcom/android/server/am/RestartProcessManager;)V
    ...
    iput-object v1, p0, Lcom/android/server/am/OnePlusBGController;->mNetWorkType:Lcom/android/server/am/OnePlusBGController$NET_TYPE;
    ...
    iput v1, p0, Lcom/android/server/am/OnePlusBGController;->mPreload_Criteria:F
    ...
    iput v2, p0, Lcom/android/server/am/OnePlusBGController;->mBg_HighCriteria_For_Notorious:F

    const/high16 v2, 0x40a00000    # 5.0f

    iput v2, p0, Lcom/android/server/am/OnePlusBGController;->mBg_GeneCriteria:F

    const/high16 v2, 0x40800000    # 4.0f

    iput v2, p0, Lcom/android/server/am/OnePlusBGController;->mBg_GeneCriteria_For_Notorious:F
    ...
    iput v1, p0, Lcom/android/server/am/OnePlusBGController;->mBg_GMSCriteria:F

    iput v2, p0, Lcom/android/server/am/OnePlusBGController;->mBg_ReliefBonusmAh:F
    ...
    sput-object p2, Lcom/android/server/am/OnePlusBGController;->mAmsHanlder:Landroid/os/Handler;
    ...
    iput-object v1, p0, Lcom/android/server/am/OnePlusBGController;->mSensorManager:Landroid/hardware/SensorManager;
    ...
    sput-object v1, Lcom/android/server/am/OnePlusBGController;->mAudioManager:Landroid/media/AudioManager;

    new-instance v1, Lcom/android/server/am/OnePlusBGController$BatteryReceiver;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Lcom/android/server/am/OnePlusBGController$BatteryReceiver;-><init>(Lcom/android/server/am/OnePlusBGController;Lcom/android/server/am/OnePlusBGController$1;)V

    iput-object v1, p0, Lcom/android/server/am/OnePlusBGController;->mBatteryReceiver:Lcom/android/server/am/OnePlusBGController$BatteryReceiver;

    new-instance v1, Lcom/android/server/am/OnePlusBGController$MyConfigUpdater;

    invoke-direct {v1, p0, v2}, Lcom/android/server/am/OnePlusBGController$MyConfigUpdater;-><init>(Lcom/android/server/am/OnePlusBGController;Lcom/android/server/am/OnePlusBGController$1;)V

    iput-object v1, p0, Lcom/android/server/am/OnePlusBGController;->mConfigUpdater:Lcom/android/server/am/OnePlusBGController$MyConfigUpdater;

    new-instance v1, Lcom/android/server/am/OnePlusBGController$BGCAbnInfo;

    invoke-direct {v1}, Lcom/android/server/am/OnePlusBGController$BGCAbnInfo;-><init>()V

    iput-object v1, p0, Lcom/android/server/am/OnePlusBGController;->mReport_obj:Lcom/android/server/am/OnePlusBGController$BGCAbnInfo;
    ...
    const-string v0, "OP_FEATURE_RESRTICT_PKG_BASE_ON_NETWORK enabled, update mNetWorkType to DOMESTIC"

    invoke-static {v0}, Lcom/android/server/am/OnePlusBGController;->myLog(Ljava/lang/String;)V

    sget-object v0, Lcom/android/server/am/OnePlusBGController$NET_TYPE;->DOMESTIC:Lcom/android/server/am/OnePlusBGController$NET_TYPE;

    iput-object v0, p0, Lcom/android/server/am/OnePlusBGController;->mNetWorkType:Lcom/android/server/am/OnePlusBGController$NET_TYPE;
...
.method private CheckAbnBgmAh()V
    ...
    invoke-static {v8}, Lcom/android/server/am/OnePlusBGController$UidSippermAhInfo;->access$3400(Lcom/android/server/am/OnePlusBGController$UidSippermAhInfo;)Z

    move-result v15

    sget-object v13, Lcom/android/server/am/OnePlusBGController$APP_BUCKET_RANKING;->UNKNOWN:Lcom/android/server/am/OnePlusBGController$APP_BUCKET_RANKING;
    ...
    sget-object v13, Lcom/android/server/am/OnePlusBGController$APP_BUCKET_RANKING;->HIGH:Lcom/android/server/am/OnePlusBGController$APP_BUCKET_RANKING;

    if-eqz v12, :cond_2

    :cond_1
    iget v14, v0, Lcom/android/server/am/OnePlusBGController;->mBg_HighCriteria:F
    ...
    iget v14, v0, Lcom/android/server/am/OnePlusBGController;->mBg_HighCriteria_For_Notorious:F
    ...
    sget-object v13, Lcom/android/server/am/OnePlusBGController$APP_BUCKET_RANKING;->GENERAL:Lcom/android/server/am/OnePlusBGController$APP_BUCKET_RANKING;

    if-eqz v12, :cond_5

    :cond_4
    iget v14, v0, Lcom/android/server/am/OnePlusBGController;->mBg_GeneCriteria:F
    ...
    iget v14, v0, Lcom/android/server/am/OnePlusBGController;->mBg_GeneCriteria_For_Notorious:F
    ...
    sget-object v13, Lcom/android/server/am/OnePlusBGController$APP_BUCKET_RANKING;->LOW:Lcom/android/server/am/OnePlusBGController$APP_BUCKET_RANKING;

    if-eqz v12, :cond_8

    :cond_7
    iget v14, v0, Lcom/android/server/am/OnePlusBGController;->mBg_LowCriteria:F
    ...
    iget v14, v0, Lcom/android/server/am/OnePlusBGController;->mBg_LowCriteria_For_Notorious:F
    ...
    invoke-virtual {v8}, Lcom/android/server/am/OnePlusBGController$UidSippermAhInfo;->getDayOfPreloadmAh()D

    move-result-wide v18

    iget v4, v0, Lcom/android/server/am/OnePlusBGController;->mPreload_Criteria:F
    ...
    :goto_5
    iget v4, v0, Lcom/android/server/am/OnePlusBGController;->INIT_INVALID_CRITERIA:F

    cmpl-float v4, v13, v4

    if-eqz v4, :cond_d

    invoke-virtual {v8, v14}, Lcom/android/server/am/OnePlusBGController$UidSippermAhInfo;->updateBucketRanking(Lcom/android/server/am/OnePlusBGController$APP_BUCKET_RANKING;)V

    if-eqz v12, :cond_b

    iget v4, v0, Lcom/android/server/am/OnePlusBGController;->mBg_ReliefBonusmAh:F
    ...
    iget v6, v0, Lcom/android/server/am/OnePlusBGController;->mBg_GMSCriteria:F
    ...
    const-string/jumbo v5, "oops, can\'t find which category of uid :"
    ...
    invoke-virtual {v14}, Lcom/android/server/am/OnePlusBGController$APP_BUCKET_RANKING;->toString()Ljava/lang/String;

    move-result-object v11

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v11, ", cri="

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v10, v13}, Ljava/lang/StringBuilder;->append(F)Ljava/lang/StringBuilder;

    const-string v11, ", Noto="
    ...
    const-string v11, ", Relief="

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v10, v5}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v11, ", RfBgt="

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v11, v0, Lcom/android/server/am/OnePlusBGController;->mBg_ReliefBonusmAh:F

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(F)Ljava/lang/StringBuilder;

    const-string v11, ", DPremAh="
    ...
    invoke-static {v10}, Lcom/android/server/am/OnePlusBGController;->myLog(Ljava/lang/String;)V
    ...
    iget v11, v0, Lcom/android/server/am/OnePlusBGController;->mPreload_Criteria:F
    ...
    sget-object v11, Lcom/android/server/am/OnePlusBGController$DRAIN_TYPE;->PRELOAD:Lcom/android/server/am/OnePlusBGController$DRAIN_TYPE;
    ...
    :cond_11
    sget-object v11, Lcom/android/server/am/OnePlusBGController$DRAIN_TYPE;->UNKNOWN:Lcom/android/server/am/OnePlusBGController$DRAIN_TYPE;
    ...
    invoke-virtual/range {v10 .. v26}, Lcom/android/server/am/OnePlusBGController$BGCAbnInfo;->insert(Ljava/lang/String;IDDDDLcom/android/server/am/OnePlusBGController$APP_BUCKET_RANKING;Lcom/android/server/am/OnePlusBGController$DRAIN_TYPE;ZZZZ)V
    ...
    sget-boolean v10, Lcom/android/server/am/OnePlusBGController;->DEBUG_BGC:Z
    ...
    invoke-virtual {v13}, Lcom/android/server/am/OnePlusBGController$APP_BUCKET_RANKING;->toString()Ljava/lang/String;
    ...
    sget-boolean v3, Lcom/android/server/am/OnePlusBGController;->DEBUG_ONEPLUS:Z

    if-eqz v3, :cond_15

    iget-object v3, v0, Lcom/android/server/am/OnePlusBGController;->mReport_obj:Lcom/android/server/am/OnePlusBGController$BGCAbnInfo;

    invoke-virtual {v3}, Lcom/android/server/am/OnePlusBGController$BGCAbnInfo;->dump()V

    :cond_15
    sget-object v3, Lcom/android/server/am/OnePlusBGController;->mAmsHanlder:Landroid/os/Handler;

    const v4, 0x101d4

    iget-object v5, v0, Lcom/android/server/am/OnePlusBGController;->mReport_obj:Lcom/android/server/am/OnePlusBGController$BGCAbnInfo;
    ...
    sget-object v4, Lcom/android/server/am/OnePlusBGController;->mAmsHanlder:Landroid/os/Handler;
    ...
    const-string v5, "@@@@[CheckAbnBgmAh] in "
...
.method static synthetic access$1000(Lcom/android/server/am/OnePlusBGController;)Landroid/util/SparseArray;
    .locals 1
...
.method static synthetic access$1200(Lcom/android/server/am/OnePlusBGController;)Lcom/android/server/am/BatteryStatsService;
    .locals 1
...
.method static synthetic access$1300(Lcom/android/server/am/OnePlusBGController;I)V
    .locals 0
...
.method static synthetic access$1400(Lcom/android/server/am/OnePlusBGController;)V
    .locals 0
...
.method static synthetic access$1500(Lcom/android/server/am/OnePlusBGController;)V
    .locals 0
...
.method static synthetic access$1800(Lcom/android/server/am/OnePlusBGController;)F
    ...
    iget v0, p0, Lcom/android/server/am/OnePlusBGController;->mPreload_Criteria:F
...
.method static synthetic access$1802(Lcom/android/server/am/OnePlusBGController;F)F
    ...
    iput p1, p0, Lcom/android/server/am/OnePlusBGController;->mPreload_Criteria:F
...
.method static synthetic access$2200(Lcom/android/server/am/OnePlusBGController;)F
    .locals 1
...
.method static synthetic access$2202(Lcom/android/server/am/OnePlusBGController;F)F
    .locals 0
...
.method static synthetic access$2300(Lcom/android/server/am/OnePlusBGController;)F
    .locals 1
...
.method static synthetic access$2302(Lcom/android/server/am/OnePlusBGController;F)F
    .locals 0
...
.method static synthetic access$2400(Lcom/android/server/am/OnePlusBGController;)F
    .locals 1
...
.method static synthetic access$2402(Lcom/android/server/am/OnePlusBGController;F)F
    .locals 0
...
.method static synthetic access$2500(Lcom/android/server/am/OnePlusBGController;)F
    .locals 1
...
.method static synthetic access$2502(Lcom/android/server/am/OnePlusBGController;F)F
    .locals 0
...
.method static synthetic access$2600(Lcom/android/server/am/OnePlusBGController;)F
    .locals 1

    iget v0, p0, Lcom/android/server/am/OnePlusBGController;->mBg_GMSCriteria:F

    return v0
.end method

.method static synthetic access$2602(Lcom/android/server/am/OnePlusBGController;F)F
    .locals 0

    iput p1, p0, Lcom/android/server/am/OnePlusBGController;->mBg_GMSCriteria:F

    return p1
.end method

.method static synthetic access$2700(Lcom/android/server/am/OnePlusBGController;)Ljava/util/HashSet;
    .locals 1
...
.method static synthetic access$2800(Lcom/android/server/am/OnePlusBGController;)Z
    .locals 1
...
.method static synthetic access$2802(Lcom/android/server/am/OnePlusBGController;Z)Z
    .locals 0
...
.method static synthetic access$2900(Lcom/android/server/am/OnePlusBGController;IJII)V
    .locals 0
...
.method static synthetic access$300()I
    ...
    sget v0, Lcom/android/server/am/OnePlusBGController;->sGMS_Uid:I

    return v0
.end method

.method static synthetic access$3000(Lcom/android/server/am/OnePlusBGController;ZI)Z
    .locals 1
...
.method static synthetic access$3200(Lcom/android/server/am/OnePlusBGController;IJLcom/android/server/am/OnePlusBGController$UidStat;Lcom/android/server/am/OnePlusBGController$PROC_TYPE;)V
    .locals 0
...
.method static synthetic access$3300(Lcom/android/server/am/OnePlusBGController;IZ)Z
    .locals 1
...
.method static synthetic access$3500()Landroid/media/AudioManager;
    .locals 1
...
.method static synthetic access$3600()Landroid/os/Handler;
    ...
    sget-object v0, Lcom/android/server/am/OnePlusBGController;->mAmsHanlder:Landroid/os/Handler;
...
.method static synthetic access$3800(Lcom/android/server/am/OnePlusBGController;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/server/am/OnePlusBGController;->initGMSUid()V

    return-void
.end method

.method static synthetic access$3900(Lcom/android/server/am/OnePlusBGController;)V
    .locals 0
...
.method static synthetic access$4000(Lcom/android/server/am/OnePlusBGController;)Z
    .locals 1
...
.method static synthetic access$4100(Lcom/android/server/am/OnePlusBGController;)Lcom/android/internal/os/BatteryStatsHelper;
    .locals 1
...
.method static synthetic access$4200(Lcom/android/server/am/OnePlusBGController;Ljava/util/List;)V
    .locals 0
...
.method static synthetic access$4300(Lcom/android/server/am/OnePlusBGController;Ljava/lang/String;Ljava/util/List;Z)V
    .locals 0
...
.method static synthetic access$4400(Lcom/android/server/am/OnePlusBGController;)Z
    .locals 1
...
.method static synthetic access$4402(Lcom/android/server/am/OnePlusBGController;Z)Z
    .locals 0
...
.method static synthetic access$4500(Lcom/android/server/am/OnePlusBGController;)V
    .locals 0
...
.method static synthetic access$700(Lcom/android/server/am/OnePlusBGController;)V
    .locals 0
...
.method static synthetic access$800(Lcom/android/server/am/OnePlusBGController;)V
    ...
    invoke-direct {p0}, Lcom/android/server/am/OnePlusBGController;->dumpCriteria()V
...
.method static synthetic access$900()Ljava/util/HashSet;
    ...
    sget-object v0, Lcom/android/server/am/OnePlusBGController;->mPreloadUidSet:Ljava/util/HashSet;
...
.method private convertUidSippermAhStatsToList()V
    ...
    invoke-virtual {v2}, Lcom/android/server/am/OnePlusBGController$UidSippermAhInfo;->getDayOfPreloadmAh()D
...
.method private dumpCriteria()V
    ...
    iget v1, p0, Lcom/android/server/am/OnePlusBGController;->mBg_HighCriteria_For_Notorious:F
    ...
    iget v1, p0, Lcom/android/server/am/OnePlusBGController;->mBg_GeneCriteria_For_Notorious:F
    ...
    iget v1, p0, Lcom/android/server/am/OnePlusBGController;->mBg_LowCriteria_For_Notorious:F
    ...
    iget v1, p0, Lcom/android/server/am/OnePlusBGController;->mPreload_Criteria:F
    ...
    iget v1, p0, Lcom/android/server/am/OnePlusBGController;->mBg_GMSCriteria:F
    ...
    iget v1, p0, Lcom/android/server/am/OnePlusBGController;->mBg_ReliefBonusmAh:F
...
.method private initGMSUid()V
    ...
    sput v1, Lcom/android/server/am/OnePlusBGController;->sGMS_Uid:I
    ...
    const-string v3, "Get GMS Uid = "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    sget v3, Lcom/android/server/am/OnePlusBGController;->sGMS_Uid:I
    ...
    const-string v2, "Can\'t get GMS Uid"
    ...
    const-string v3, "get NameNotFoundException error:"
...
.method private sendMessageDelayed(IJ)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/am/OnePlusBGController$MyHandler;->obtainMessage(I)Landroid/os/Message;
...
.method private updateUidSippermAhStatsByFgBgChange(ILcom/android/server/am/OnePlusBGController$PROC_TYPE;D)V
    ...
    sget-object v4, Lcom/android/server/am/OnePlusBGController$PROC_TYPE;->B_RECONFIRM:Lcom/android/server/am/OnePlusBGController$PROC_TYPE;
    ...
    invoke-direct {p0, p1, v1}, Lcom/android/server/am/OnePlusBGController;->checkTrafficUidLocked(IZ)Z

    move-result v1

    const/4 v6, 0x0

    iget-object v7, p0, Lcom/android/server/am/OnePlusBGController;->mAms:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-object v7, v7, Lcom/android/server/wm/WindowManagerService;->mOpWms:Lcom/android/server/wm/OnePlusWmUtil$OnePlusWindowManagerService;

    invoke-virtual {v7}, Lcom/android/server/wm/OnePlusWmUtil$OnePlusWindowManagerService;->getSysAlertWindowUids()Ljava/util/List;
    ...
    sget-object v1, Lcom/android/server/am/OnePlusBGController$4;->$SwitchMap$com$android$server$am$OnePlusBGController$NET_TYPE:[I

    iget-object v4, p0, Lcom/android/server/am/OnePlusBGController;->mNetWorkType:Lcom/android/server/am/OnePlusBGController$NET_TYPE;

    invoke-virtual {v4}, Lcom/android/server/am/OnePlusBGController$NET_TYPE;->ordinal()I
    ...
    invoke-direct {v5, p1, p2, p3, p4}, Lcom/android/server/am/OnePlusBGController$UidSippermAhInfo;-><init>(ILcom/android/server/am/OnePlusBGController$PROC_TYPE;D)V
...
.method private updateUidSippermAhStatsBySippers(Ljava/util/List;)V
    ...
    iget-boolean v0, v9, Lcom/android/server/am/OnePlusBGController$UidStat;->mIsSpecialPkg:Z
    ...
    sget-object v0, Lcom/android/server/am/OnePlusBGController$4;->$SwitchMap$com$android$server$am$OnePlusBGController$NET_TYPE:[I

    iget-object v5, v1, Lcom/android/server/am/OnePlusBGController;->mNetWorkType:Lcom/android/server/am/OnePlusBGController$NET_TYPE;

    invoke-virtual {v5}, Lcom/android/server/am/OnePlusBGController$NET_TYPE;->ordinal()I
    ...
    const-string v4, "#### Revise special uid "
...
.method public dumpUidSippermAhStats(Ljava/io/PrintWriter;)V
    ...
    iget v3, p0, Lcom/android/server/am/OnePlusBGController;->mBg_HighCriteria_For_Notorious:F
    ...
    iget v3, p0, Lcom/android/server/am/OnePlusBGController;->mBg_GeneCriteria_For_Notorious:F
    ...
    iget v3, p0, Lcom/android/server/am/OnePlusBGController;->mBg_LowCriteria_For_Notorious:F
    ...
    iget v3, p0, Lcom/android/server/am/OnePlusBGController;->mPreload_Criteria:F
    ...
    iget v3, p0, Lcom/android/server/am/OnePlusBGController;->mBg_GMSCriteria:F
    ...
    iget v3, p0, Lcom/android/server/am/OnePlusBGController;->mBg_ReliefBonusmAh:F
...
.method handleOnUidStateChanged(II)V
    ...
    :cond_0
    invoke-virtual {p0, p1, p2}, Lcom/android/server/am/OnePlusBGController;->updateReloadUidState(II)V
...
.method public updateNetworkReachability(Lcom/android/server/am/OnePlusBGController$NET_TYPE;)V
    .locals 3
    ...
    iput-object p1, p0, Lcom/android/server/am/OnePlusBGController;->mNetWorkType:Lcom/android/server/am/OnePlusBGController$NET_TYPE;

    const v0, 0x101db

    const-wide/16 v1, 0xbb8

    invoke-direct {p0, v0, v1, v2}, Lcom/android/server/am/OnePlusBGController;->sendMessageDelayed(IJ)V

    return-void
.end method

.method updateReloadUidState(II)V
    .locals 3
    ...
    sget-object v1, Lcom/android/server/am/OnePlusBGController;->mPreloadUidSet:Ljava/util/HashSet;
