...
.method private filterSuffix(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_0
    iget-object v2, p0, Lcom/android/server/am/OnePlusPerfManager;->suffixListGame:Ljava/util/List;
    ...
    iget-object v2, p0, Lcom/android/server/am/OnePlusPerfManager;->suffixListCompany:Ljava/util/List;
...
.method private getInodeIndexPath(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v1, "/inode_index_disabled"
...
.method private resolvePerfConfigFromJSON(Lorg/json/JSONArray;)V
    ...
    invoke-direct {v1, v5}, Lcom/android/server/am/OnePlusPerfManager;->deciedDoFrameEnable(Ljava/lang/String;)V
    ...
    const-string/jumbo v7, "resolvePerfConfigFromJSON # DoFrame = "
    ...
    invoke-static {}, Lcom/android/server/OnePlusDexOptManager;->getInstance()Lcom/android/server/OnePlusDexOptManager;
    ...
    invoke-virtual {v2, v5}, Lcom/android/server/OnePlusDexOptManager;->setEnable(Z)V

    sget-boolean v2, Lcom/android/server/am/OnePlusPerfManager;->DEBUG:Z
    ...
    const-string/jumbo v5, "resolvePerfConfigFromJSON # dexopt = "
...
.method public getPkgPerfLock(Ljava/lang/String;)I
    ...
    iget-object v4, v2, Lcom/android/server/am/OnePlusPerfManager$PerfInfo;->mLevel:Ljava/lang/String;
...
.method public mayChangeInodeIndex(Ljava/lang/String;Ljava/lang/String;)V
    ...
    check-cast v1, Lcom/android/server/am/OnePlusPerfManager$PerfInfo;

    if-eqz v1, :cond_1

    const-string v2, "FST"

    iget-object v3, v1, Lcom/android/server/am/OnePlusPerfManager$PerfInfo;->mLevel:Ljava/lang/String;
    ...
    invoke-direct {p0, p2}, Lcom/android/server/am/OnePlusPerfManager;->getInodeIndexPath(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    const-string v3, "1"

    invoke-direct {p0, v2, v3}, Lcom/android/server/am/OnePlusPerfManager;->echo(Ljava/lang/String;Ljava/lang/String;)Z
