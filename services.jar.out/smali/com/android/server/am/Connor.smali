...
.field private static final TRAINING_MAX_TEMP:I = 0x27
...
.field private mIsPreciseDevTemp:Z
...
.method public constructor <init>(Lcom/android/server/am/ActivityManagerService;)V
    ...
    iput-boolean v1, p0, Lcom/android/server/am/Connor;->mIsPreciseDevTemp:Z
...
.method static synthetic access$1000(Lcom/android/server/am/Connor;)I
    .locals 1

    invoke-direct {p0}, Lcom/android/server/am/Connor;->getSysTemp()I
...
.method private getSysTemp()I
    ...
    iget-boolean v1, p0, Lcom/android/server/am/Connor;->mIsPreciseDevTemp:Z
...
.method private getThermalZoneId()I
    .locals 5
    ...
    :pswitch_1
    iput-boolean v4, p0, Lcom/android/server/am/Connor;->mIsPreciseDevTemp:Z
...
.method public dumpsys(Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    :cond_9
    const-string/jumbo v0, "showtemp"
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/server/am/Connor;->getSysTemp()I
...
.method public init()V
    ...
    invoke-direct {p0}, Lcom/android/server/am/Connor;->getThermalZoneId()I

    move-result v0

    iput v0, p0, Lcom/android/server/am/Connor;->mThermalZoneId:I
    ...
    const-string/jumbo v3, "mThermalZoneId "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v3, p0, Lcom/android/server/am/Connor;->mThermalZoneId:I
    ...
    iput-object v0, p0, Lcom/android/server/am/Connor;->mCollector:Lnet/oneplus/odm/insight/PreloadApplicationEventCollector;
    ...
    invoke-static {v0, p0}, Lcom/android/server/am/ConnorFilter;->getInstalledSet(Landroid/content/pm/PackageManagerInternal;Landroid/content/pm/PackageManagerInternal$PackageListObserver;)Ljava/util/HashSet;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/am/Connor;->mPackageSet:Ljava/util/HashSet;
    ...
    invoke-static {v0}, Lcom/android/server/am/Connor;->nativePkgListUpdate([Ljava/lang/String;)V

    new-instance v0, Lcom/android/server/am/ConnorDbHelper;
    ...
    invoke-direct {v0, v2, v3, v4}, Lcom/android/server/am/ConnorDbHelper;-><init>(Landroid/content/Context;Ljava/lang/String;I)V

    iput-object v0, p0, Lcom/android/server/am/Connor;->mDbHelper:Lcom/android/server/am/ConnorDbHelper;
    ...
    iput-object v0, p0, Lcom/android/server/am/Connor;->mOSTracker:Lnet/oneplus/odm/insight/tracker/OSTracker;
