...
# direct methods
.method public constructor <init>(Lcom/android/server/am/RestartProcessManager;Ljava/lang/String;ZZ)V
    .locals 6

    iput-object p1, p0, Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->this$0:Lcom/android/server/am/RestartProcessManager;
    ...
    iput-object p2, p0, Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->mPackageName:Ljava/lang/String;
    ...
    :goto_0
    invoke-static {p1}, Lcom/android/server/am/RestartProcessManager;->access$3200(Lcom/android/server/am/RestartProcessManager;)I
    ...
    new-instance p1, Lcom/android/server/am/RestartProcessManager$DayRecord;

    iget-object v0, p0, Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->mPackageName:Ljava/lang/String;

    invoke-direct {p1, v0}, Lcom/android/server/am/RestartProcessManager$DayRecord;-><init>(Ljava/lang/String;)V

    iget-wide v0, p0, Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->mLastCountTime:J

    invoke-static {p1, v0, v1}, Lcom/android/server/am/RestartProcessManager$DayRecord;->access$1302(Lcom/android/server/am/RestartProcessManager$DayRecord;J)J
...
.method private getIndexOfRecord(J)I
    ...
    iget-object v6, v0, Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->this$0:Lcom/android/server/am/RestartProcessManager;

    invoke-static {v6}, Lcom/android/server/am/RestartProcessManager;->access$3200(Lcom/android/server/am/RestartProcessManager;)I
    ...
    invoke-static {v6, v7}, Lcom/android/server/am/RestartProcessManager;->access$3202(Lcom/android/server/am/RestartProcessManager;I)I
...
.method public cleanData(J)V
    ...
    iget-object v1, p0, Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->this$0:Lcom/android/server/am/RestartProcessManager;

    const/4 v2, 0x0

    invoke-static {v1, v2}, Lcom/android/server/am/RestartProcessManager;->access$302(Lcom/android/server/am/RestartProcessManager;Z)Z

    iget-object v1, p0, Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->this$0:Lcom/android/server/am/RestartProcessManager;

    invoke-static {v1, p1, p2}, Lcom/android/server/am/RestartProcessManager;->access$402(Lcom/android/server/am/RestartProcessManager;J)J

    iget-object v1, p0, Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->this$0:Lcom/android/server/am/RestartProcessManager;

    const-string v3, ""

    invoke-static {v1, v3}, Lcom/android/server/am/RestartProcessManager;->access$3302(Lcom/android/server/am/RestartProcessManager;Ljava/lang/String;)Ljava/lang/String;

    const-wide/16 v3, 0x0

    iput-wide v3, p0, Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->mTotalLaunchTimesScore:D

    iput-wide v3, p0, Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->mTotalFGScore:D

    iput-wide v3, p0, Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->mTotalLruScore:D
    ...
    iput-wide v3, p0, Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->mLastCountTime:J

    const-wide/16 v3, 0x0

    iput-wide v3, p0, Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->mTotalLaunchTime:J

    iput-wide v3, p0, Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->mTotalForegroundTime:J
    ...
    invoke-direct {v1, v5}, Lcom/android/server/am/RestartProcessManager$DayRecord;-><init>(Ljava/lang/String;)V

    iget-wide v5, p0, Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->mLastCountTime:J

    invoke-static {v1, v5, v6}, Lcom/android/server/am/RestartProcessManager$DayRecord;->access$1302(Lcom/android/server/am/RestartProcessManager$DayRecord;J)J

    iget-object v5, p0, Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->mDayRecords:Ljava/util/ArrayList;

    invoke-virtual {v5, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iput v2, p0, Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->mCurRecordIndex:I

    iput-wide v3, p0, Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->mLastLaunchTime:J

    iput-wide v3, p0, Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->mTempLastLaunchTime:J
...
.method public setFinishTime(J)V
    ...
    iget-object v2, p0, Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->this$0:Lcom/android/server/am/RestartProcessManager;

    const-string v4, ""

    invoke-static {v2, v4}, Lcom/android/server/am/RestartProcessManager;->access$3302(Lcom/android/server/am/RestartProcessManager;Ljava/lang/String;)Ljava/lang/String;
...
.method public updateSelf(J)Z
    ...
    iget-object v7, p0, Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->this$0:Lcom/android/server/am/RestartProcessManager;

    invoke-static {v7}, Lcom/android/server/am/RestartProcessManager;->access$3200(Lcom/android/server/am/RestartProcessManager;)I
    ...
    :cond_2
    iget-object v5, p0, Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->this$0:Lcom/android/server/am/RestartProcessManager;

    invoke-static {v5}, Lcom/android/server/am/RestartProcessManager;->access$3200(Lcom/android/server/am/RestartProcessManager;)I
    ...
    iget-object v4, p0, Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->this$0:Lcom/android/server/am/RestartProcessManager;

    invoke-static {v4}, Lcom/android/server/am/RestartProcessManager;->access$3200(Lcom/android/server/am/RestartProcessManager;)I
    ...
    invoke-static {v4, v5}, Lcom/android/server/am/RestartProcessManager;->access$3202(Lcom/android/server/am/RestartProcessManager;I)I
