...
.method private trimInactiveRecentTasks()V
    ...
    const-string v5, " mGlobalMaxNumTasks="

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v5, p0, Lcom/android/server/am/RecentTasks;->mGlobalMaxNumTasks:I
...
.method getRecentTasks(IIZZII)Landroid/content/pm/ParceledListSlice;
    ...
    const-string/jumbo v9, "getRecentTasks for invisible task from callingUid="
    ...
    :cond_2
    iget-object v7, v0, Lcom/android/server/am/RecentTasks;->mService:Lcom/android/server/am/ActivityManagerService;

    const/4 v8, 0x4

    invoke-virtual {v7, v1, v8}, Lcom/android/server/am/ActivityManagerService;->isUserRunning(II)Z
    ...
    const-string v8, " is still locked. Cannot load recents"
    ...
    iget-object v7, v0, Lcom/android/server/am/RecentTasks;->mUserController:Lcom/android/server/am/UserController;

    invoke-virtual {v7, v1}, Lcom/android/server/am/UserController;->getProfileIds(I)Ljava/util/Set;
    ...
    iput v4, v0, Lcom/android/server/am/RecentTasks;->mNumObservedLockedTasks:I
    ...
    iget-object v11, v0, Lcom/android/server/am/RecentTasks;->mTasks:Ljava/util/ArrayList;
    ...
    invoke-direct {v0, v11}, Lcom/android/server/am/RecentTasks;->isVisibleRecentTask(Lcom/android/server/am/TaskRecord;)Z
    ...
    invoke-direct {v0, v11, v10}, Lcom/android/server/am/RecentTasks;->isInVisibleRange(Lcom/android/server/am/TaskRecord;I)Z
    ...
    sget-boolean v12, Lcom/android/server/am/ActivityManagerDebugConfig;->DEBUG_RECENTS:Z
    ...
    const-string v1, "Skipping, not user: "
    ...
    :cond_6
    iget-boolean v1, v11, Lcom/android/server/am/TaskRecord;->realActivitySuspended:Z
    ...
    iget-object v1, v11, Lcom/android/server/am/TaskRecord;->intent:Landroid/content/Intent;
    ...
    invoke-virtual {v11}, Lcom/android/server/am/TaskRecord;->isActivityTypeHome()Z

    move-result v12

    if-nez v12, :cond_9

    iget v12, v11, Lcom/android/server/am/TaskRecord;->effectiveUid:I
    ...
    const-string v1, "Skipping, not allowed: "
    ...
    :cond_a
    iget-boolean v12, v11, Lcom/android/server/am/TaskRecord;->inPreload:Z
    ...
    :cond_b
    iget-boolean v12, v11, Lcom/android/server/am/TaskRecord;->autoRemoveRecents:Z
    ...
    iget-boolean v1, v11, Lcom/android/server/am/TaskRecord;->isAvailable:Z
    ...
    :cond_d
    iget-boolean v1, v11, Lcom/android/server/am/TaskRecord;->mUserSetupComplete:Z
    ...
    iget v1, v11, Lcom/android/server/am/TaskRecord;->mCallingUid:I
    ...
    :cond_f
    invoke-virtual {v0, v11}, Lcom/android/server/am/RecentTasks;->createRecentTaskInfo(Lcom/android/server/am/TaskRecord;)Landroid/app/ActivityManager$RecentTaskInfo;
