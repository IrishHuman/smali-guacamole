...
.method constructor <init>(Lcom/android/server/am/OnePlusBGController;IZI)V
    ...
    iput-boolean v0, p0, Lcom/android/server/am/OnePlusBGController$UidStat;->mIsSpecialPkg:Z
    ...
    iput-boolean v2, p0, Lcom/android/server/am/OnePlusBGController$UidStat;->mIsSpecialPkg:Z
    ...
    iput-wide v3, p0, Lcom/android/server/am/OnePlusBGController$UidStat;->mLastUpdate:J

    iget-object v1, p0, Lcom/android/server/am/OnePlusBGController$UidStat;->mStats:Landroid/util/SparseLongArray;

    const-wide/16 v3, 0x0

    invoke-virtual {v1, p4, v3, v4}, Landroid/util/SparseLongArray;->put(IJ)V
    ...
    :cond_2
    iget-boolean v3, p0, Lcom/android/server/am/OnePlusBGController$UidStat;->mIsFgBlack:Z

    invoke-static {p1, v3, p4}, Lcom/android/server/am/OnePlusBGController;->access$3000(Lcom/android/server/am/OnePlusBGController;ZI)Z

    move-result v3

    if-eqz v3, :cond_4

    iput-boolean v2, p0, Lcom/android/server/am/OnePlusBGController$UidStat;->mIsBackGround:Z
    ...
    invoke-static {}, Lcom/android/server/am/OnePlusBGController;->access$3100()Z
    ...
    invoke-static/range {v2 .. v7}, Lcom/android/server/am/OnePlusBGController;->access$3200(Lcom/android/server/am/OnePlusBGController;IJLcom/android/server/am/OnePlusBGController$UidStat;Lcom/android/server/am/OnePlusBGController$PROC_TYPE;)V
...
.method dump()V
    ...
    invoke-static {v0, v1, v2}, Lcom/android/server/am/OnePlusBGController;->access$3300(Lcom/android/server/am/OnePlusBGController;IZ)Z
...
.method getTotalTimeInBackground()J
    ...
    invoke-static {v4, v5, v3}, Lcom/android/server/am/OnePlusBGController;->access$3000(Lcom/android/server/am/OnePlusBGController;ZI)Z
...
.method isFgBgChange(I)Z
    ...
    invoke-static {v1, v2, p1}, Lcom/android/server/am/OnePlusBGController;->access$3000(Lcom/android/server/am/OnePlusBGController;ZI)Z
...
.method update(IZ)V
    ...
    invoke-static/range {v0 .. v5}, Lcom/android/server/am/OnePlusBGController;->access$3200(Lcom/android/server/am/OnePlusBGController;IJLcom/android/server/am/OnePlusBGController$UidStat;Lcom/android/server/am/OnePlusBGController$PROC_TYPE;)V
