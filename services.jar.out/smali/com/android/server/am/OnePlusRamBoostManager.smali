...
.implements Lcom/android/server/OnePlusUtil$OnePlusTouchWinJudge$TouchWindowListener;
...
.field private static MEMPLUS:Z = false

.field private static final MEMPLUS_TYPE_HIGHUSED:I = 0x1

.field private static final MEMPLUS_TYPE_PERCEIVABLE:I = 0x3

.field private static final MEMPLUS_TYPE_RARELY:I = 0x0

.field private static final MEMPLUS_TYPE_SYSTEM:I = 0x2
...
.field private static final MSG_WRITE_MEMPLUS:I = 0x10

.field private static final MSG_WRITE_MEMPLUS_JUSAGE:I = 0xe

.field private static final MSG_WRITE_MEMPLUS_RESUME:I = 0xd
...
.field private static final PROP_MEMPLUS:Ljava/lang/String; = "persist.sys.ramboost.memplus"
...
.field private mCurrentIopPkg:Ljava/lang/String;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/am/OnePlusRamBoostManager;->MEMPLUS:Z
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/am/OnePlusRamBoostManager;->mCurrentIopPkg:Ljava/lang/String;
...
.method static synthetic access$1200(Lcom/android/server/am/OnePlusRamBoostManager;Ljava/lang/String;IZ)I
    .locals 1

    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/am/OnePlusRamBoostManager;->getMemPlusType(Ljava/lang/String;IZ)I
...
.method static synthetic access$1300(Lcom/android/server/am/OnePlusRamBoostManager;III)Z
    .locals 1

    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/am/OnePlusRamBoostManager;->writeMemplus(III)Z
...
.method static synthetic access$1400(Lcom/android/server/am/OnePlusRamBoostManager;IILjava/lang/String;)Z
    .locals 1

    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/am/OnePlusRamBoostManager;->writeMemplusAndResumeLast(IILjava/lang/String;)Z
...
.method static synthetic access$1500(Lcom/android/server/am/OnePlusRamBoostManager;Lorg/json/JSONArray;)V
    .locals 0
...
.method private getHotCountFromHighList(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_0
    iget-object v2, p0, Lcom/android/server/am/OnePlusRamBoostManager;->mBlackHighUsageList:Ljava/util/ArrayList;
    ...
    const-string/jumbo v4, "getHotCountFromHighList # blacklist has "
    ...
    const-string/jumbo v4, "getHotCountFromHighList: "
...
.method private getMemPlusType(Ljava/lang/String;IZ)I
    .locals 1
    ...
    invoke-virtual {v0, p2}, Lcom/android/server/OnePlusUtil$OnePlusTouchWinJudge;->isContainUid(I)Z
...
.method private resolveConfigFromJSON(Lorg/json/JSONArray;)V
    ...
    const-string/jumbo v4, "persist.sys.ramboost.memplus"
...
.method private sendMsgIOPrefetchStart(ILjava/lang/String;Ljava/lang/String;)I
    ...
    iput-object v3, p0, Lcom/android/server/am/OnePlusRamBoostManager;->mCurrentIopPkg:Ljava/lang/String;
...
.method private updateSwitch(Z)V
    ...
    :goto_2
    const-string/jumbo v0, "persist.sys.ramboost.memplus"

    sget-boolean v1, Lcom/android/server/am/OnePlusRamBoostManager;->MEMPLUS:Z
    ...
    sget-boolean v0, Lcom/android/server/am/OnePlusRamBoostManager;->MEMPLUS:Z

    if-eqz v0, :cond_6

    const-string v0, "OnePlusSmartBoostManager"

    const-string v1, "MEMPLUS true and registerTouchWindowListener!"
    ...
    invoke-virtual {v0, p0}, Lcom/android/server/OnePlusUtil$OnePlusTouchWinJudge;->registerTouchWindowListener(Lcom/android/server/OnePlusUtil$OnePlusTouchWinJudge$TouchWindowListener;)V
    ...
    const-string v1, "MEMPLUS false and unregisterTouchWindowListener!"
    ...
    invoke-virtual {v0, p0}, Lcom/android/server/OnePlusUtil$OnePlusTouchWinJudge;->unregisterTouchWindowListener(Lcom/android/server/OnePlusUtil$OnePlusTouchWinJudge$TouchWindowListener;)V
...
.method private writeMemplus(III)Z
    .locals 4
    ...
    invoke-direct {p0, v1, v2}, Lcom/android/server/am/OnePlusRamBoostManager;->echo(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string/jumbo v3, "writeMemplus "
...
.method private writeMemplusAndResumeLast(IILjava/lang/String;)Z
    .locals 4
    ...
    invoke-direct {p0, p3, p1, v0}, Lcom/android/server/am/OnePlusRamBoostManager;->getMemPlusType(Ljava/lang/String;IZ)I

    move-result v0

    invoke-direct {p0, p1, p2, v0}, Lcom/android/server/am/OnePlusRamBoostManager;->writeMemplus(III)Z
    ...
    const-string/jumbo v3, "writeMemplusAndResumeLast: resume:"
...
# virtual methods
.method public addTouchWindow(IILjava/lang/String;II)V
    .locals 4
...
.method public frontPackageChanged(Ljava/lang/String;IILjava/lang/String;II)V
    ...
    const-string v2, "frontPackageChanged: "
    ...
    const-string/jumbo v4, "lastPid"

    invoke-virtual {v3, v4, p6}, Landroid/os/Bundle;->putInt(Ljava/lang/String;I)V

    const-string/jumbo v4, "lastUid"

    invoke-virtual {v3, v4, p5}, Landroid/os/Bundle;->putInt(Ljava/lang/String;I)V

    const-string/jumbo v4, "lastPkgName"

    invoke-virtual {v3, v4, p4}, Landroid/os/Bundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v2, v3}, Landroid/os/Message;->setData(Landroid/os/Bundle;)V

    iget-object v4, p0, Lcom/android/server/am/OnePlusRamBoostManager;->mRamBoostHandler:Lcom/android/server/am/OnePlusRamBoostManager$RamBoostHandler;

    const-wide/16 v5, 0x1f4

    invoke-virtual {v4, v2, v5, v6}, Lcom/android/server/am/OnePlusRamBoostManager$RamBoostHandler;->sendMessageDelayed(Landroid/os/Message;J)Z
...
.method public notifyIOPrefetchStart(ILjava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p2, p0, Lcom/android/server/am/OnePlusRamBoostManager;->mCurrentIopPkg:Ljava/lang/String;

    goto :goto_0

    :cond_1
    iget-object v0, p0, Lcom/android/server/am/OnePlusRamBoostManager;->mCurrentIopPkg:Ljava/lang/String;
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/server/am/OnePlusRamBoostManager;->mBlackIopList:Ljava/util/ArrayList;
    ...
    const-string/jumbo v3, "notifyIOPrefetchStart # iop black pkg: "
...
.method public removeTouchWindow(IILjava/lang/String;II)V
    .locals 3
    ...
    const-string/jumbo v2, "removeTouchWindow: "
