...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/OnePlusPowerController$MyThread;,
...
.field private static final GMS_PKGNAME:Ljava/lang/String; = "com.google.android.gms"
...
.field private static final NSG_ADD_NET_RESTRICT_WAKELOCK:I = 0xc
...
.field private mIsApplyFirewallRule:Z

.field private mIsCharging:Z

.field private mIsConnected:Z

.field private mIsUnderRestriction:Lcom/android/server/OnePlusPowerController$PKG_RESTRICT_TYPE;
...
.field private mOnePlusHighPowerDetector:Lcom/android/server/am/OnePlusHighPowerDetector;
...
.field unRestrictRules:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "Lcom/android/server/OPFirewallRule;",
            ">;"
        }
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lcom/android/server/OnePlusPowerController;->mLock:Ljava/lang/Object;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v1, p0, Lcom/android/server/OnePlusPowerController;->mIsConnected:Z

    sget-object v2, Lcom/android/server/OnePlusPowerController$PKG_RESTRICT_TYPE;->NA:Lcom/android/server/OnePlusPowerController$PKG_RESTRICT_TYPE;

    iput-object v2, p0, Lcom/android/server/OnePlusPowerController;->mIsUnderRestriction:Lcom/android/server/OnePlusPowerController$PKG_RESTRICT_TYPE;

    const/4 v2, 0x1

    iput-boolean v2, p0, Lcom/android/server/OnePlusPowerController;->mListenToConnEvent:Z

    iput-boolean v1, p0, Lcom/android/server/OnePlusPowerController;->mIsAfter1stLightIdle:Z

    iput-boolean v1, p0, Lcom/android/server/OnePlusPowerController;->mIsApplyFirewallRule:Z

    new-instance v3, Ljava/util/ArrayList;

    invoke-direct {v3}, Ljava/util/ArrayList;-><init>()V

    iput-object v3, p0, Lcom/android/server/OnePlusPowerController;->unRestrictRules:Ljava/util/ArrayList;

    const/4 v3, -0x1

    iput v3, p0, Lcom/android/server/OnePlusPowerController;->mGMS_Uid:I

    iput-boolean v2, p0, Lcom/android/server/OnePlusPowerController;->mUserSleep:Z

    iput-boolean v1, p0, Lcom/android/server/OnePlusPowerController;->mSensorRestrict:Z

    iput-boolean v2, p0, Lcom/android/server/OnePlusPowerController;->mSensorEnabled:Z

    iput v1, p0, Lcom/android/server/OnePlusPowerController;->mDozeState:I
    ...
    const-string/jumbo v3, "http://www.google.com/gen_204"

    invoke-direct {p0, v3}, Lcom/android/server/OnePlusPowerController;->makeURL(Ljava/lang/String;)Ljava/net/URL;

    move-result-object v3

    iput-object v3, p0, Lcom/android/server/OnePlusPowerController;->mHttpPublicGoogleAtChinaUrl:Ljava/net/URL;
    ...
    iput-object v3, p0, Lcom/android/server/OnePlusPowerController;->mHttpsPublicGoogleAtChinaUrl:Ljava/net/URL;
...
.method static synthetic access$000()Ljava/lang/Object;
    ...
    sget-object v0, Lcom/android/server/OnePlusPowerController;->mLock:Ljava/lang/Object;
...
.method static synthetic access$1300(Lcom/android/server/OnePlusPowerController;)Landroid/content/ContentResolver;
    .locals 1
...
.method static synthetic access$2100(Lcom/android/server/OnePlusPowerController;)Lcom/android/server/OnePlusPowerController$PKG_RESTRICT_TYPE;
    .locals 1

    iget-object v0, p0, Lcom/android/server/OnePlusPowerController;->mIsUnderRestriction:Lcom/android/server/OnePlusPowerController$PKG_RESTRICT_TYPE;

    return-object v0
.end method

.method static synthetic access$2202(Lcom/android/server/OnePlusPowerController;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/android/server/OnePlusPowerController;->mIsAfter1stLightIdle:Z

    return p1
.end method

.method static synthetic access$2300(Lcom/android/server/OnePlusPowerController;)Landroid/os/PowerManagerInternal;
    .locals 1
...
.method static synthetic access$2400(Lcom/android/server/OnePlusPowerController;)Landroid/os/PowerManager;
    .locals 1
...
.method static synthetic access$2500(Lcom/android/server/OnePlusPowerController;)Landroid/net/ConnectivityManager;
    .locals 1

    iget-object v0, p0, Lcom/android/server/OnePlusPowerController;->mConnectivityManager:Landroid/net/ConnectivityManager;

    return-object v0
.end method

.method static synthetic access$2600(Lcom/android/server/OnePlusPowerController;)Z
    .locals 1

    iget-boolean v0, p0, Lcom/android/server/OnePlusPowerController;->mIsConnected:Z

    return v0
.end method

.method static synthetic access$2602(Lcom/android/server/OnePlusPowerController;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/android/server/OnePlusPowerController;->mIsConnected:Z

    return p1
.end method

.method static synthetic access$2700(Lcom/android/server/OnePlusPowerController;)Z
    .locals 1

    iget-boolean v0, p0, Lcom/android/server/OnePlusPowerController;->mListenToConnEvent:Z

    return v0
.end method

.method static synthetic access$2800(Lcom/android/server/OnePlusPowerController;Lcom/android/server/OnePlusPowerController$PKG_RESTRICT_TYPE;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/OnePlusPowerController;->enableRestriction(Lcom/android/server/OnePlusPowerController$PKG_RESTRICT_TYPE;)V
...
.method static synthetic access$3700(Lcom/android/server/OnePlusPowerController;Lorg/json/JSONArray;)V
    .locals 0
...
.method static synthetic access$3800(Lcom/android/server/OnePlusPowerController;)Landroid/content/Context;
    .locals 1
...
.method static synthetic access$3900(Lcom/android/server/OnePlusPowerController;)Landroid/telephony/SubscriptionManager;
    .locals 1
...
.method static synthetic access$4000(Lcom/android/server/OnePlusPowerController;)Lcom/android/server/OnePlusPowerController$KMeans;
    .locals 1
...
.method static synthetic access$4200()D
    .locals 2
...
.method static synthetic access$4500(Lcom/android/server/OnePlusPowerController;)Landroid/app/AlarmManager$OnAlarmListener;
    .locals 1
...
.method static synthetic access$4600(Lcom/android/server/OnePlusPowerController;)Landroid/app/AlarmManager;
    .locals 1
...
.method static synthetic access$4700(Lcom/android/server/OnePlusPowerController;Ljava/time/LocalDateTime;)J
    .locals 2
...
.method static synthetic access$4800(Lcom/android/server/OnePlusPowerController;)Landroid/app/Notification;
    .locals 1
...
.method static synthetic access$4900(Lcom/android/server/OnePlusPowerController;)Landroid/app/NotificationManager;
    .locals 1
...
.method static synthetic access$5300(Lcom/android/server/OnePlusPowerController;)Z
    .locals 1

    invoke-direct {p0}, Lcom/android/server/OnePlusPowerController;->sendParallelHttpChinaH2Probes()Z
...
.method static synthetic access$5400(Lcom/android/server/OnePlusPowerController;)Ljava/net/URL;
    .locals 1

    iget-object v0, p0, Lcom/android/server/OnePlusPowerController;->mHttpPublicGoogleAtChinaUrl:Ljava/net/URL;

    return-object v0
.end method

.method static synthetic access$5500(Lcom/android/server/OnePlusPowerController;Ljava/net/URL;)Z
    .locals 1

    invoke-direct {p0, p1}, Lcom/android/server/OnePlusPowerController;->sendHttpProbe(Ljava/net/URL;)Z
...
.method static synthetic access$5600(Lcom/android/server/OnePlusPowerController;)Ljava/net/URL;
    .locals 1

    iget-object v0, p0, Lcom/android/server/OnePlusPowerController;->mHttpsPublicGoogleAtChinaUrl:Ljava/net/URL;
...
.method static synthetic access$5800(Lcom/android/server/OnePlusPowerController;)Ljava/time/LocalDateTime;
    .locals 1
...
.method static synthetic access$5900(Lcom/android/server/OnePlusPowerController;)Ljava/time/LocalDateTime;
    .locals 1
...
.method static synthetic access$900(Lcom/android/server/OnePlusPowerController;)Lnet/oneplus/odm/insight/tracker/OSTracker;
    .locals 1
...
.method private applyGMSFirewallLocked(Z)V
    ...
    :cond_0
    iget v0, p0, Lcom/android/server/OnePlusPowerController;->mGMS_Uid:I
    ...
    invoke-static {v1}, Lcom/android/server/OPFirewallUtils;->selectAllFirewallRules(Landroid/content/Context;)Ljava/util/List;

    move-result-object v1

    const-string v2, "all"

    invoke-direct {p0, v1, v2}, Lcom/android/server/OnePlusPowerController;->dumpFirewallRules(Ljava/util/List;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3, v4}, Lcom/android/server/OPFirewallUtils;->selectFirewallRuleByPkg(Landroid/content/Context;Ljava/lang/String;)Lcom/android/server/OPFirewallRule;
    ...
    const-string/jumbo v1, "oops, observe user ever modify OPFirewallRule, so skip apply..."
    ...
    :cond_2
    sget-boolean v4, Lcom/android/server/OnePlusPowerController;->DEBUG_ONEPLUS:Z

    if-eqz v4, :cond_3

    const-string v4, "OnePlusPowerController"

    const-string v5, "apply OPFirewallRule..."
    ...
    iget-object v1, p0, Lcom/android/server/OnePlusPowerController;->mNetworkManagementService:Landroid/os/INetworkManagementService;
    ...
    iget v4, p0, Lcom/android/server/OnePlusPowerController;->mGMS_Uid:I

    const/4 v5, 0x2

    invoke-interface {v1, v2, v4, v5}, Landroid/os/INetworkManagementService;->setFirewallUidRule(III)V
    ...
    invoke-interface {v1, v2, v0, v5}, Landroid/os/INetworkManagementService;->setFirewallUidRule(III)V
    :try_end_0
    ...
    const-string v4, "RemoteException error message: "
    ...
    const-string/jumbo v1, "mNetworkManagementService == null"
    ...
    const-string v2, "after restricted, all"
    ...
    :cond_8
    iget-boolean v3, p0, Lcom/android/server/OnePlusPowerController;->mIsApplyFirewallRule:Z

    if-eqz v3, :cond_e

    iput-boolean v2, p0, Lcom/android/server/OnePlusPowerController;->mIsApplyFirewallRule:Z
    ...
    const-string/jumbo v1, "oops, observe user ever modify OPFirewallRule, so skip relief..."
    ...
    const-string/jumbo v5, "relief OPFirewallRule..."

    invoke-static {v4, v5}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    :cond_a
    iget-object v4, p0, Lcom/android/server/OnePlusPowerController;->mNetworkManagementService:Landroid/os/INetworkManagementService;
    ...
    iget v5, p0, Lcom/android/server/OnePlusPowerController;->mGMS_Uid:I

    invoke-interface {v4, v2, v5, v1}, Landroid/os/INetworkManagementService;->setFirewallUidRule(III)V
    ...
    invoke-interface {v4, v2, v0, v1}, Landroid/os/INetworkManagementService;->setFirewallUidRule(III)V
    :try_end_1
    ...
    const-string/jumbo v1, "oops, not ever apply OPFirewallRule before, so skip relief"
    ...
    const-string v2, "after relief, all"
...
.method private dumpFirewallRules(Ljava/util/List;Ljava/lang/String;)Ljava/lang/String;
    ...
    check-cast v2, Lcom/android/server/OPFirewallRule;

    invoke-virtual {v2, p2}, Lcom/android/server/OPFirewallRule;->dumpInfo(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v2, " OPFirewallRule is null"
...
.method private declared-synchronized enableRestriction(Lcom/android/server/OnePlusPowerController$PKG_RESTRICT_TYPE;)V
    .locals 4
    ...
    invoke-virtual {p1}, Lcom/android/server/OnePlusPowerController$PKG_RESTRICT_TYPE;->toString()Ljava/lang/String;
    ...
    const-string v1, "already applied, just return...."
    ...
    :cond_0
    :try_start_1
    sget-object v0, Lcom/android/server/OnePlusPowerController$PKG_RESTRICT_TYPE;->ENABLE:Lcom/android/server/OnePlusPowerController$PKG_RESTRICT_TYPE;
    ...
    iput-object v0, p0, Lcom/android/server/OnePlusPowerController;->mIsUnderRestriction:Lcom/android/server/OnePlusPowerController$PKG_RESTRICT_TYPE;

    iget-object v0, p0, Lcom/android/server/OnePlusPowerController;->mAlarmManagerInternal:Lcom/android/server/AlarmManagerInternal;

    invoke-interface {v0, v2}, Lcom/android/server/AlarmManagerInternal;->setPkgNetworkAlarmRestriction(Z)V

    iget-boolean v0, p0, Lcom/android/server/OnePlusPowerController;->mIsAfter1stLightIdle:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/android/server/OnePlusPowerController;->mLocalPowerManager:Landroid/os/PowerManagerInternal;

    invoke-virtual {v0, v2}, Landroid/os/PowerManagerInternal;->disableExclusiveWakeLocks(Z)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/server/am/OnePlusAppBootManager;->updateGMSRestrict(Z)V

    :cond_1
    iget-object v0, p0, Lcom/android/server/OnePlusPowerController;->mOnePlusHighPowerDetector:Lcom/android/server/am/OnePlusHighPowerDetector;

    if-eqz v0, :cond_2

    iget-object v0, p0, Lcom/android/server/OnePlusPowerController;->mOnePlusHighPowerDetector:Lcom/android/server/am/OnePlusHighPowerDetector;

    invoke-virtual {v0, v2}, Lcom/android/server/am/OnePlusHighPowerDetector;->enableAggressive(Z)V
    ...
    const-string/jumbo v1, "oops, mOnePlusHighPowerDetector is null"

    invoke-static {v0, v1}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    :cond_3
    :goto_0
    invoke-direct {p0, v2}, Lcom/android/server/OnePlusPowerController;->applyGMSFirewallLocked(Z)V

    iget-object v0, p0, Lcom/android/server/OnePlusPowerController;->mOnePlusBGController:Lcom/android/server/am/OnePlusBGController;
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/am/OnePlusBGController;->updateNetworkReachability(Lcom/android/server/am/OnePlusBGController$NET_TYPE;)V

    goto :goto_2

    :cond_4
    sget-object v0, Lcom/android/server/OnePlusPowerController$PKG_RESTRICT_TYPE;->DISABLE:Lcom/android/server/OnePlusPowerController$PKG_RESTRICT_TYPE;
    ...
    invoke-interface {v0, v3}, Lcom/android/server/AlarmManagerInternal;->setPkgNetworkAlarmRestriction(Z)V
    ...
    invoke-virtual {v0, v3}, Lcom/android/server/am/OnePlusHighPowerDetector;->enableAggressive(Z)V
    ...
    const-string/jumbo v2, "oops, mOnePlusHighPowerDetector is null"

    invoke-static {v0, v2}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    :cond_6
    :goto_1
    invoke-direct {p0, v3}, Lcom/android/server/OnePlusPowerController;->applyGMSFirewallLocked(Z)V

    iget-object v0, p0, Lcom/android/server/OnePlusPowerController;->mOnePlusBGController:Lcom/android/server/am/OnePlusBGController;

    sget-object v2, Lcom/android/server/am/OnePlusBGController$NET_TYPE;->PUBLIC:Lcom/android/server/am/OnePlusBGController$NET_TYPE;

    invoke-virtual {v0, v2}, Lcom/android/server/am/OnePlusBGController;->updateNetworkReachability(Lcom/android/server/am/OnePlusBGController$NET_TYPE;)V
    ...
    invoke-virtual {v0, v3}, Lcom/android/server/am/OnePlusAppBootManager;->updateGMSRestrict(Z)V
    :try_end_1
...
.method private parseBadProcess(Lorg/json/JSONObject;)V
    ...
    const-string/jumbo v1, "parseBadProcess..."
    ...
    :try_start_0
    iget-object v4, p0, Lcom/android/server/OnePlusPowerController;->mActivityManager:Lcom/android/server/am/ActivityManagerService;

    invoke-virtual {v4, v0, v1, v2, v3}, Lcom/android/server/am/ActivityManagerService;->configBadProcess(ZJI)V
...
.method private parseNetworkRestrict(Lorg/json/JSONObject;)V
    ...
    const-string/jumbo v1, "parseNetworkRestrict..."

    invoke-static {v0, v1}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    :try_start_0
    const-string/jumbo v0, "public_http"
    ...
    invoke-direct {p0, v0}, Lcom/android/server/OnePlusPowerController;->makeURL(Ljava/lang/String;)Ljava/net/URL;

    move-result-object v1

    iput-object v1, p0, Lcom/android/server/OnePlusPowerController;->mHttpPublicGoogleAtChinaUrl:Ljava/net/URL;
    ...
    const-string v3, "Update mHttpPublicGoogleAtChinaUrl to "
    ...
    :cond_0
    const-string/jumbo v0, "public_https"
    ...
    iput-object v1, p0, Lcom/android/server/OnePlusPowerController;->mHttpsPublicGoogleAtChinaUrl:Ljava/net/URL;
    ...
    const-string v3, "Update mHttpsPublicGoogleAtChinaUrl to "
    ...
    invoke-virtual {v2, v1}, Lcom/android/server/am/OnePlusAppBootManager;->updateGMSActionSet(Ljava/util/List;)V
    ...
    const-string v4, "Update GMSBindActList to "
...
.method private parseProcessResident(Lorg/json/JSONObject;)V
    .locals 2

    const-string v0, "OnePlusPowerController"

    const-string/jumbo v1, "parseProcessResident..."
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/server/OnePlusPowerController;->mActivityManager:Lcom/android/server/am/ActivityManagerService;

    invoke-virtual {v1, v0}, Lcom/android/server/am/ActivityManagerService;->setProcessResident(Z)V
...
.method private parseWakeLock(Lorg/json/JSONObject;)V
    ...
    iget-object v6, p0, Lcom/android/server/OnePlusPowerController;->mLocalPowerManager:Landroid/os/PowerManagerInternal;

    invoke-virtual {v6, v3}, Landroid/os/PowerManagerInternal;->clearExclusiveWakeLock(Z)V
    ...
    iget-object v12, p0, Lcom/android/server/OnePlusPowerController;->mHandler:Lcom/android/server/OnePlusPowerController$MyHandler;

    invoke-virtual {v12, v8, v11}, Lcom/android/server/OnePlusPowerController$MyHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-virtual {v9, v8, v7}, Lcom/android/server/OnePlusPowerController$MyHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    :cond_3
    const-string/jumbo v6, "packageNameForNet"
    ...
    invoke-virtual {v6, v7}, Landroid/os/PowerManagerInternal;->clearExclusiveWakeLock(Z)V
...
.method private resolveConfigFromJSON(Lorg/json/JSONArray;)V
    ...
    :sswitch_0
    const-string/jumbo v5, "process_resident"
    ...
    :sswitch_1
    const-string/jumbo v5, "network_restrict"
    ...
    invoke-direct {p0, v2}, Lcom/android/server/OnePlusPowerController;->parseNetworkRestrict(Lorg/json/JSONObject;)V

    goto :goto_2

    :pswitch_1
    invoke-direct {p0, v2}, Lcom/android/server/OnePlusPowerController;->parseBadProcess(Lorg/json/JSONObject;)V
    ...
    invoke-direct {p0, v2}, Lcom/android/server/OnePlusPowerController;->parseProcessResident(Lorg/json/JSONObject;)V
...
.method private sendHttpProbe(Ljava/net/URL;)Z
    ...
    new-instance v4, Landroid/net/util/Stopwatch;

    invoke-direct {v4}, Landroid/net/util/Stopwatch;-><init>()V

    invoke-virtual {v4}, Landroid/net/util/Stopwatch;->start()Landroid/net/util/Stopwatch;
...
.method private sendParallelHttpChinaH2Probes()Z
    ...
    new-instance v1, Lcom/android/server/OnePlusPowerController$1ProbeThread;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2, v0}, Lcom/android/server/OnePlusPowerController$1ProbeThread;-><init>(Lcom/android/server/OnePlusPowerController;ILjava/util/concurrent/CountDownLatch;)V

    new-instance v3, Lcom/android/server/OnePlusPowerController$1ProbeThread;

    const/4 v4, 0x1

    invoke-direct {v3, p0, v4, v0}, Lcom/android/server/OnePlusPowerController$1ProbeThread;-><init>(Lcom/android/server/OnePlusPowerController;ILjava/util/concurrent/CountDownLatch;)V

    :try_start_0
    invoke-virtual {v1}, Lcom/android/server/OnePlusPowerController$1ProbeThread;->start()V

    invoke-virtual {v3}, Lcom/android/server/OnePlusPowerController$1ProbeThread;->start()V
    ...
    invoke-virtual {v1}, Lcom/android/server/OnePlusPowerController$1ProbeThread;->result()Z

    move-result v5

    invoke-virtual {v3}, Lcom/android/server/OnePlusPowerController$1ProbeThread;->result()Z
    ...
    const-string v9, ", httpPublicGoogleAtChinaResult result ["
    ...
    const-string v9, ", httpsPublicGoogleAtChinaResult result ["
    ...
    const-string v6, "Error: array out of bound!"
    ...
    const-string v6, "Error: probes wait interrupted!"
...
.method dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v0, v1, Lcom/android/server/OnePlusPowerController;->mOnePlusBGController:Lcom/android/server/am/OnePlusBGController;
...
.method enterOPSMIfAppropriated(Z)V
    ...
    const-string v6, "Abort entering OPSM mode because of "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    sget v6, Lcom/android/server/OnePlusPowerController;->mSleepState:I

    invoke-virtual {p0, v6}, Lcom/android/server/OnePlusPowerController;->convertToString(I)Ljava/lang/String;
    ...
    const-string v5, "Abort entering OPSM mode because of audio playing"
    ...
    iget v6, p0, Lcom/android/server/OnePlusPowerController;->mDozeState:I
    ...
    :cond_2
    iget-boolean v4, p0, Lcom/android/server/OnePlusPowerController;->mIsCharging:Z

    if-eqz v4, :cond_3

    const-string v4, "OnePlusPowerController"

    const-string v5, "Abort entering OPSM mode because of charging"
    ...
    :cond_3
    iget-boolean v4, p0, Lcom/android/server/OnePlusPowerController;->mOPSMActive:Z

    if-ne v4, v3, :cond_4

    const-string v4, "OnePlusPowerController"

    const-string v5, "Abort entering OPSM mode because OPSM is already active."
    ...
    const-string v5, "Abort entering OPSM mode because of Screen-off Timeout"
    ...
    iget-object v4, p0, Lcom/android/server/OnePlusPowerController;->mOSTracker:Lnet/oneplus/odm/insight/tracker/OSTracker;
    ...
    const-string v5, "Entering OPSM mode"
    ...
    const-string/jumbo v8, "mSleepEndOverridden = "
    ...
    invoke-virtual {v6, v7, v8}, Ljava/time/LocalDateTime;->minusSeconds(J)Ljava/time/LocalDateTime;

    move-result-object v6

    invoke-static {v1, v6}, Ljava/time/Duration;->between(Ljava/time/temporal/Temporal;Ljava/time/temporal/Temporal;)Ljava/time/Duration;
    ...
    :goto_1
    iget-object v6, p0, Lcom/android/server/OnePlusPowerController;->mLocalIdleController:Lcom/android/server/DeviceIdleController$LocalService;

    const-wide/32 v7, 0x36ee80

    add-long/2addr v7, v4

    invoke-virtual {v6, v7, v8, v3}, Lcom/android/server/DeviceIdleController$LocalService;->scheduleAlarm(JZ)V
    ...
    iput-object v6, p0, Lcom/android/server/OnePlusPowerController;->mSavedTetheredIfaces:[Ljava/lang/String;
    ...
    iput-boolean v6, p0, Lcom/android/server/OnePlusPowerController;->mSavedWifiState:Z

    iget-object v6, p0, Lcom/android/server/OnePlusPowerController;->mResolver:Landroid/content/ContentResolver;
    ...
    :goto_2
    iput-boolean v6, p0, Lcom/android/server/OnePlusPowerController;->mSavedWifiScanState:Z
    ...
    iput-boolean v6, p0, Lcom/android/server/OnePlusPowerController;->mSavedDataState:Z
    ...
    iput-boolean v6, p0, Lcom/android/server/OnePlusPowerController;->mSavedBluetoothState:Z

    iget-object v6, p0, Lcom/android/server/OnePlusPowerController;->mResolver:Landroid/content/ContentResolver;

    const-string v7, "ble_scan_always_enabled"

    invoke-static {v6, v7, v8}, Landroid/provider/Settings$Global;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I

    move-result v6

    iput v6, p0, Lcom/android/server/OnePlusPowerController;->mSavedBleScanAlwaysAvailable:I
    ...
    const-string/jumbo v9, "mSavedBluetoothState="

    invoke-virtual {v7, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v9, p0, Lcom/android/server/OnePlusPowerController;->mSavedBluetoothState:Z

    invoke-virtual {v7, v9}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v9, ", mSavedBleScanAlwaysAvailable="

    invoke-virtual {v7, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v9, p0, Lcom/android/server/OnePlusPowerController;->mSavedBleScanAlwaysAvailable:I
    ...
    const-string v9, "Tethered interfaces: "
    ...
    iget-object v6, p0, Lcom/android/server/OnePlusPowerController;->mSavedTetheredIfaces:[Ljava/lang/String;
    ...
    iget-object v11, p0, Lcom/android/server/OnePlusPowerController;->mConnectivityManager:Landroid/net/ConnectivityManager;

    invoke-direct {p0, v10}, Lcom/android/server/OnePlusPowerController;->ifaceNameToType(Ljava/lang/String;)I
    ...
    invoke-static {v11, v12}, Lcom/android/server/OPLogger$Slog;->d(Ljava/lang/String;Ljava/lang/String;)I
    ...
    iget-object v6, p0, Lcom/android/server/OnePlusPowerController;->mBatteryManagerInternal:Landroid/os/BatteryManagerInternal;

    invoke-virtual {v6, v3}, Landroid/os/BatteryManagerInternal;->setDeepSleepMode(Z)V

    iget-object v6, p0, Lcom/android/server/OnePlusPowerController;->mAlarmManagerInternal:Lcom/android/server/AlarmManagerInternal;

    invoke-interface {v6, v3}, Lcom/android/server/AlarmManagerInternal;->setDeepSleepMode(Z)V

    iget-object v6, p0, Lcom/android/server/OnePlusPowerController;->mLocalPowerManager:Landroid/os/PowerManagerInternal;

    invoke-virtual {v6, v3}, Landroid/os/PowerManagerInternal;->setDeepSleepMode(Z)V

    iget-object v6, p0, Lcom/android/server/OnePlusPowerController;->mNotificationLight:Lcom/android/server/lights/Light;

    if-eqz v6, :cond_d

    iget-object v6, p0, Lcom/android/server/OnePlusPowerController;->mNotificationLight:Lcom/android/server/lights/Light;

    invoke-virtual {v6, v3}, Lcom/android/server/lights/Light;->setPowerSaveMode(Z)V

    :cond_d
    iget-object v6, p0, Lcom/android/server/OnePlusPowerController;->mSensorManager:Landroid/hardware/SensorManager;

    if-eqz v6, :cond_e

    iget-boolean v6, p0, Lcom/android/server/OnePlusPowerController;->mSensorRestrict:Z

    if-eqz v6, :cond_e

    iget-object v6, p0, Lcom/android/server/OnePlusPowerController;->mSensorManager:Landroid/hardware/SensorManager;

    invoke-virtual {v6}, Landroid/hardware/SensorManager;->enterOPSM()V

    iput-boolean v8, p0, Lcom/android/server/OnePlusPowerController;->mSensorEnabled:Z

    :cond_e
    if-eqz v0, :cond_10

    iget v6, p0, Lcom/android/server/OnePlusPowerController;->mSavedBleScanAlwaysAvailable:I
    ...
    const-string v7, "Set BLE_SCAN_ALWAYS_AVAILABLE to 0"

    invoke-static {v6, v7}, Lcom/android/server/OPLogger$Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    :cond_f
    iget-boolean v6, p0, Lcom/android/server/OnePlusPowerController;->mSavedBluetoothState:Z

    if-ne v6, v3, :cond_10

    invoke-virtual {v0, v8}, Landroid/bluetooth/BluetoothAdapter;->disable(Z)Z

    const-string v6, "OnePlusPowerController"

    const-string v7, "Disable bluetooth"
    ...
    sput v7, Lcom/android/server/OnePlusPowerController;->mActivationCount:I

    iget-object v3, p0, Lcom/android/server/OnePlusPowerController;->mResolver:Landroid/content/ContentResolver;

    const-string/jumbo v7, "optimal_power_save_mode_activation"

    sget v8, Lcom/android/server/OnePlusPowerController;->mActivationCount:I

    invoke-static {v3, v7, v8}, Landroid/provider/Settings$System;->putInt(Landroid/content/ContentResolver;Ljava/lang/String;I)Z
...
.method getSleepState(Ljava/time/LocalDateTime;)I
    ...
    const-string/jumbo v10, "getSleepState: sleepStart="
...
.method public onBootPhase(I)V
    ...
    invoke-static {v0}, Lcom/android/server/OnePlusLoggingService;->schedule(Landroid/content/Context;)V
    ...
    iput-object v5, p0, Lcom/android/server/OnePlusPowerController;->mNetworkManagementService:Landroid/os/INetworkManagementService;

    const-string v5, "OnePlusPowerController"

    const-string/jumbo v6, "init NetworkManagementService"
    ...
    iput v6, p0, Lcom/android/server/OnePlusPowerController;->mGMS_Uid:I
    ...
    const-string v8, "Get GMS Uid = "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v8, p0, Lcom/android/server/OnePlusPowerController;->mGMS_Uid:I
    ...
    const-string v7, "Can\'t get GMS Uid"
    ...
    const-string v8, "get NameNotFoundException error:"
    ...
    iget-object v0, p0, Lcom/android/server/OnePlusPowerController;->mActivityManager:Lcom/android/server/am/ActivityManagerService;
    ...
    iput-object v0, p0, Lcom/android/server/OnePlusPowerController;->mOnePlusHighPowerDetector:Lcom/android/server/am/OnePlusHighPowerDetector;
    ...
    const-string/jumbo v5, "init mOnePlusHighPowerDetector is OK"
    ...
    const-string/jumbo v5, "init mOnePlusHighPowerDetector is Failed"
    ...
    iput-object v0, p0, Lcom/android/server/OnePlusPowerController;->mOnePlusBGController:Lcom/android/server/am/OnePlusBGController;
    ...
    const-string/jumbo v5, "init mOnePlusBGController is OK"
    ...
    const-string/jumbo v5, "init mOnePlusBGController is Failed"
    ...
    invoke-virtual {v0, v5}, Lcom/android/server/OnePlusPowerController$MyHandler;->obtainMessage(I)Landroid/os/Message;
    ...
    invoke-virtual {v5, v0, v6, v7}, Lcom/android/server/OnePlusPowerController$MyHandler;->sendMessageDelayed(Landroid/os/Message;J)Z
    ...
    const-string/jumbo v3, "net.oneplus.powercontroller.intent.OPSM"
    ...
    const-string v3, "OP_FEATURE_RESRTICT_PKG_BASE_ON_NETWORK enabled"
    ...
    const-string v3, "OP_FEATURE_RESRTICT_PKG_BASE_ON_NETWORK disabled"
    ...
    :cond_e
    iget-object v6, p0, Lcom/android/server/OnePlusPowerController;->mContext:Landroid/content/Context;

    iget-object v7, p0, Lcom/android/server/OnePlusPowerController;->mBroadcastReceiver:Landroid/content/BroadcastReceiver;
    ...
    const-string/jumbo v6, "{\"packageName\":\"com.google.android.gms\",\"tag\":\"NlpWakeLock\"}"

    invoke-virtual {v2, v6}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    const-string/jumbo v6, "{\"packageName\":\"com.google.android.gms\",\"tag\":\"NlpCollectorWakeLock\"}"

    invoke-virtual {v2, v6}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    const-string/jumbo v6, "{\"packageName\":\"com.google.android.gms\",\"tag\":\".measurement.PackageMeasurementService\"}"
    ...
    :cond_f
    const-string/jumbo v6, "{\"packageName\":\"com.google.android.gms\"}"
    ...
    iget-object v8, p0, Lcom/android/server/OnePlusPowerController;->mHandler:Lcom/android/server/OnePlusPowerController$MyHandler;
    ...
    :goto_6
    invoke-virtual {v8, v9, v7}, Lcom/android/server/OnePlusPowerController$MyHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    const-string v9, "Failed to initial an exclusive wakelock : "
    ...
    :goto_7
    iget-object v6, p0, Lcom/android/server/OnePlusPowerController;->mOverHeatingDiagnosis:Lcom/android/server/OverHeatingDiagnosis;

    invoke-virtual {v6}, Lcom/android/server/OverHeatingDiagnosis;->start()V

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J

    move-result-wide v6

    iput-wide v6, p0, Lcom/android/server/OnePlusPowerController;->mBootCompletedElapsedTime:J
    ...
    iput-object v6, p0, Lcom/android/server/OnePlusPowerController;->tetherableUsbRegexs:[Ljava/lang/String;

    const-string/jumbo v6, "persist.vendor.fst.softap.en"
    ...
    const-string/jumbo v7, "persist.vendor.fst.data.interface"
    ...
    invoke-virtual {v1, v6}, Lcom/android/server/lights/LightsManager;->getLight(I)Lcom/android/server/lights/Light;
...
.method onShellCommand(Lcom/android/server/OnePlusPowerController$Shell;Ljava/lang/String;)I
    ...
    invoke-virtual {v4, v6}, Landroid/os/PowerManagerInternal;->getExclusiveWakeLock(Z)Ljava/util/HashMap;

    move-result-object v4

    const-string v7, "=====exclusive wakelocks=====\n"
    ...
    iget-object v7, v1, Lcom/android/server/OnePlusPowerController;->mLocalPowerManager:Landroid/os/PowerManagerInternal;

    invoke-virtual {v7, v5}, Landroid/os/PowerManagerInternal;->getExclusiveWakeLock(Z)Ljava/util/HashMap;
    ...
    const-string/jumbo v13, "packageNameForNet: "
    ...
    invoke-virtual {v0, v6}, Landroid/os/PowerManagerInternal;->enableExclusiveWakeLocks(Z)V
    ...
    invoke-virtual {v0, v6}, Landroid/os/PowerManagerInternal;->disableExclusiveWakeLocks(Z)V
    :try_end_b
    ...
    const-string/jumbo v9, "mHttpPublicGoogleAtChinaUrl: "

    invoke-virtual {v5, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v9, v1, Lcom/android/server/OnePlusPowerController;->mHttpPublicGoogleAtChinaUrl:Ljava/net/URL;
    ...
    const-string/jumbo v9, "mHttpsPublicGoogleAtChinaUrl: "

    invoke-virtual {v5, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v9, v1, Lcom/android/server/OnePlusPowerController;->mHttpsPublicGoogleAtChinaUrl:Ljava/net/URL;
    ...
    const-string/jumbo v9, "mIsUnderRestriction: "

    invoke-virtual {v5, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v9, v1, Lcom/android/server/OnePlusPowerController;->mIsUnderRestriction:Lcom/android/server/OnePlusPowerController$PKG_RESTRICT_TYPE;

    invoke-virtual {v9}, Lcom/android/server/OnePlusPowerController$PKG_RESTRICT_TYPE;->toString()Ljava/lang/String;
    ...
    const-string/jumbo v9, "mListenToConnEvent: "

    invoke-virtual {v5, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v9, v1, Lcom/android/server/OnePlusPowerController;->mListenToConnEvent:Z
    ...
    const-string/jumbo v9, "mIsApplyFirewallRule: "

    invoke-virtual {v5, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v9, v1, Lcom/android/server/OnePlusPowerController;->mIsApplyFirewallRule:Z
    ...
    iget-object v5, v1, Lcom/android/server/OnePlusPowerController;->mContext:Landroid/content/Context;

    invoke-static {v5}, Lcom/android/server/OPFirewallUtils;->selectAllFirewallRules(Landroid/content/Context;)Ljava/util/List;

    move-result-object v5

    const-string v9, "all"

    invoke-direct {v1, v5, v9}, Lcom/android/server/OnePlusPowerController;->dumpFirewallRules(Ljava/util/List;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v0, "Manual enableRestriction to true, so stop listening connectivity events"

    invoke-virtual {v3, v0}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    iput-boolean v6, v1, Lcom/android/server/OnePlusPowerController;->mListenToConnEvent:Z

    sget-object v0, Lcom/android/server/OnePlusPowerController$PKG_RESTRICT_TYPE;->ENABLE:Lcom/android/server/OnePlusPowerController$PKG_RESTRICT_TYPE;

    invoke-direct {v1, v0}, Lcom/android/server/OnePlusPowerController;->enableRestriction(Lcom/android/server/OnePlusPowerController$PKG_RESTRICT_TYPE;)V
    ...
    const-string v0, "Manual enableRestriction to false, so stop listening connectivity events"
    ...
    :cond_17
    const-string/jumbo v0, "listenback"
    ...
    const-string/jumbo v0, "listen back to connectivity events again...."

    invoke-virtual {v3, v0}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    iput-boolean v5, v1, Lcom/android/server/OnePlusPowerController;->mListenToConnEvent:Z
    :try_end_e
    ...
    invoke-static {v10, v0}, Ljava/time/LocalDateTime;->parse(Ljava/lang/CharSequence;Ljava/time/format/DateTimeFormatter;)Ljava/time/LocalDateTime;
    ...
    const-string/jumbo v13, "mSleepStartOverridden: "
    ...
    const-string/jumbo v13, "mSleepEndOverridden: "
    ...
    iget-object v5, v1, Lcom/android/server/OnePlusPowerController;->mHandler:Lcom/android/server/OnePlusPowerController$MyHandler;

    invoke-virtual {v5, v0}, Lcom/android/server/OnePlusPowerController$MyHandler;->obtainMessage(I)Landroid/os/Message;
    ...
    const-string/jumbo v10, "mTimeOutAfterScreenOff="

    invoke-virtual {v5, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    sget v10, Lcom/android/server/OnePlusPowerController;->mTimeOutAfterScreenOff:I
    ...
    const-string/jumbo v10, "mTimeOutBeforeUserAwake="
    ...
    invoke-virtual {v1, v5}, Lcom/android/server/OnePlusPowerController;->enterOPSMIfAppropriated(Z)V
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/OnePlusPowerController;->leaveOPSM()V
    ...
    iget-object v10, v1, Lcom/android/server/OnePlusPowerController;->mResolver:Landroid/content/ContentResolver;
    ...
    const-string v10, "ble_scan_always_enabled"

    invoke-static {v5, v10, v6}, Landroid/provider/Settings$Global;->putInt(Landroid/content/ContentResolver;Ljava/lang/String;I)Z
    ...
    iget-object v8, v1, Lcom/android/server/OnePlusPowerController;->mStartTetheringCallback:Lcom/android/server/OnePlusPowerController$OnStartTetheringCallback;

    invoke-virtual {v5, v6, v6, v8}, Landroid/net/ConnectivityManager;->startTethering(IZLandroid/net/ConnectivityManager$OnStartTetheringCallback;)V
    ...
    invoke-direct {v1, v4}, Lcom/android/server/OnePlusPowerController;->enableDisableData(Z)V
...
.method scheduleNextAlarmIfNeededLocked(Ljava/time/LocalDateTime;)V
    ...
    const-string v5, "PowerController.SleepStateChange"

    iget-object v6, p0, Lcom/android/server/OnePlusPowerController;->mSleepStateChangeAlarmListener:Landroid/app/AlarmManager$OnAlarmListener;
