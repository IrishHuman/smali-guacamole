...
.field private incStrength:I

.field private mADSmothTimer:Landroid/os/CountDownTimer;

.field private mADTimer:Landroid/os/CountDownTimer;

.field private mAD_ON:Z

.field public mAdjustBrightness:Z
...
.field private final mCheckCut:I

.field private final mCheckingTimes:I
...
.field private mLodFeature:Z

.field private final mLuxDefault:F

.field private final mLuxThreshold:F

.field private final mNormalLightSensorRate:I

.field private mOffCheckFlag:Z

.field private mOffChecking:Z

.field private mOnCheckFlag:Z

.field private mOnChecking:Z

.field public mOnSwitchUser:Z
...
.field private final mSmothCut:I

.field private final mSmothTimes:I
...
.method public constructor <init>(Lcom/android/server/display/AutomaticBrightnessController$Callbacks;Landroid/os/Looper;Landroid/hardware/SensorManager;Lcom/android/server/display/BrightnessMappingStrategy;IIIFIIJJZLcom/android/server/display/HysteresisLevels;)V
    ...
    iput v0, v1, Lcom/android/server/display/AutomaticBrightnessController;->mLastObservedLux:F
    ...
    iput v2, v1, Lcom/android/server/display/AutomaticBrightnessController;->mDisplayPolicy:I

    const v3, 0x3f19999a    # 0.6f

    iput v3, v1, Lcom/android/server/display/AutomaticBrightnessController;->SHORT_TERM_MODEL_THRESHOLD_RATIO:F

    const-wide/16 v3, 0x3e8

    iput-wide v3, v1, Lcom/android/server/display/AutomaticBrightnessController;->mFirstLuxDebounceConfig:J

    iput-boolean v2, v1, Lcom/android/server/display/AutomaticBrightnessController;->mbStartTimer:Z

    iput-boolean v2, v1, Lcom/android/server/display/AutomaticBrightnessController;->mAdjustBrightness:Z

    const-wide/16 v3, 0x0

    iput-wide v3, v1, Lcom/android/server/display/AutomaticBrightnessController;->mZeroStartTime:J

    iput-boolean v2, v1, Lcom/android/server/display/AutomaticBrightnessController;->mFirst_lux:Z

    iput-boolean v2, v1, Lcom/android/server/display/AutomaticBrightnessController;->mCall_UpdateFast:Z

    const/high16 v3, 0x3f800000    # 1.0f

    iput v3, v1, Lcom/android/server/display/AutomaticBrightnessController;->mLuxDefault:F

    const/high16 v3, 0x40800000    # 4.0f

    iput v3, v1, Lcom/android/server/display/AutomaticBrightnessController;->mLuxThreshold:F

    iput-boolean v2, v1, Lcom/android/server/display/AutomaticBrightnessController;->mPickupState:Z

    iput-boolean v2, v1, Lcom/android/server/display/AutomaticBrightnessController;->mFirst_PickupState:Z

    iput-boolean v2, v1, Lcom/android/server/display/AutomaticBrightnessController;->mUpdate_Fast:Z

    iput-boolean v2, v1, Lcom/android/server/display/AutomaticBrightnessController;->mEnableAutoBrightness:Z

    iput-boolean v2, v1, Lcom/android/server/display/AutomaticBrightnessController;->mHBM_State:Z

    const/4 v3, 0x1

    iput-boolean v3, v1, Lcom/android/server/display/AutomaticBrightnessController;->mAutoBrightnessEnabled:Z

    iput-boolean v2, v1, Lcom/android/server/display/AutomaticBrightnessController;->mOnSwitchUser:Z

    const/4 v4, 0x0

    iput-object v4, v1, Lcom/android/server/display/AutomaticBrightnessController;->mDaemon:Lvendor/oneplus/hardware/display/V1_0/IOneplusDisplay;

    iput-boolean v2, v1, Lcom/android/server/display/AutomaticBrightnessController;->mLodFeature:Z

    iput-boolean v2, v1, Lcom/android/server/display/AutomaticBrightnessController;->mOnChecking:Z

    iput-boolean v2, v1, Lcom/android/server/display/AutomaticBrightnessController;->mOffChecking:Z

    const/16 v4, 0x1388

    iput v4, v1, Lcom/android/server/display/AutomaticBrightnessController;->mCheckingTimes:I

    const/16 v4, 0x3e8

    iput v4, v1, Lcom/android/server/display/AutomaticBrightnessController;->mCheckCut:I

    iput v4, v1, Lcom/android/server/display/AutomaticBrightnessController;->mSmothTimes:I

    const/16 v4, 0x64

    iput v4, v1, Lcom/android/server/display/AutomaticBrightnessController;->mSmothCut:I

    iput-boolean v2, v1, Lcom/android/server/display/AutomaticBrightnessController;->mOnCheckFlag:Z

    iput-boolean v2, v1, Lcom/android/server/display/AutomaticBrightnessController;->mOffCheckFlag:Z

    iput-boolean v2, v1, Lcom/android/server/display/AutomaticBrightnessController;->mAD_ON:Z

    iput v2, v1, Lcom/android/server/display/AutomaticBrightnessController;->incStrength:I

    new-instance v4, Lcom/android/server/display/AutomaticBrightnessController$2;

    invoke-direct {v4, v1}, Lcom/android/server/display/AutomaticBrightnessController$2;-><init>(Lcom/android/server/display/AutomaticBrightnessController;)V

    iput-object v4, v1, Lcom/android/server/display/AutomaticBrightnessController;->zeroHandler:Landroid/os/Handler;

    new-instance v4, Lcom/android/server/display/AutomaticBrightnessController$6;

    invoke-direct {v4, v1}, Lcom/android/server/display/AutomaticBrightnessController$6;-><init>(Lcom/android/server/display/AutomaticBrightnessController;)V

    iput-object v4, v1, Lcom/android/server/display/AutomaticBrightnessController;->mLightSensorListener:Landroid/hardware/SensorEventListener;

    new-instance v4, Lcom/android/server/display/AutomaticBrightnessController$7;

    invoke-direct {v4, v1}, Lcom/android/server/display/AutomaticBrightnessController$7;-><init>(Lcom/android/server/display/AutomaticBrightnessController;)V

    iput-object v4, v1, Lcom/android/server/display/AutomaticBrightnessController;->mProximitySensorListener:Landroid/hardware/SensorEventListener;

    new-instance v4, Lcom/android/server/display/AutomaticBrightnessController$8;

    invoke-direct {v4, v1}, Lcom/android/server/display/AutomaticBrightnessController$8;-><init>(Lcom/android/server/display/AutomaticBrightnessController;)V

    iput-object v4, v1, Lcom/android/server/display/AutomaticBrightnessController;->mPickUpSensorListener:Landroid/hardware/SensorEventListener;

    move-object/from16 v4, p1

    iput-object v4, v1, Lcom/android/server/display/AutomaticBrightnessController;->mCallbacks:Lcom/android/server/display/AutomaticBrightnessController$Callbacks;

    move-object/from16 v5, p3

    iput-object v5, v1, Lcom/android/server/display/AutomaticBrightnessController;->mSensorManager:Landroid/hardware/SensorManager;

    move-object/from16 v6, p4

    iput-object v6, v1, Lcom/android/server/display/AutomaticBrightnessController;->mBrightnessMapper:Lcom/android/server/display/BrightnessMappingStrategy;

    move/from16 v7, p6

    iput v7, v1, Lcom/android/server/display/AutomaticBrightnessController;->mScreenBrightnessRangeMinimum:I

    move/from16 v8, p7

    iput v8, v1, Lcom/android/server/display/AutomaticBrightnessController;->mScreenBrightnessRangeMaximum:I

    move/from16 v9, p5

    iput v9, v1, Lcom/android/server/display/AutomaticBrightnessController;->mLightSensorWarmUpTimeConfig:I

    move/from16 v10, p8

    iput v10, v1, Lcom/android/server/display/AutomaticBrightnessController;->mDozeScaleFactor:F

    move/from16 v11, p9

    iput v11, v1, Lcom/android/server/display/AutomaticBrightnessController;->mNormalLightSensorRate:I

    move/from16 v12, p10

    iput v12, v1, Lcom/android/server/display/AutomaticBrightnessController;->mInitialLightSensorRate:I

    iput v0, v1, Lcom/android/server/display/AutomaticBrightnessController;->mCurrentLightSensorRate:I

    move-wide/from16 v13, p11

    iput-wide v13, v1, Lcom/android/server/display/AutomaticBrightnessController;->mBrighteningLightDebounceConfig:J

    move-wide/from16 v2, p13

    iput-wide v2, v1, Lcom/android/server/display/AutomaticBrightnessController;->mDarkeningLightDebounceConfig:J

    move/from16 v15, p15

    iput-boolean v15, v1, Lcom/android/server/display/AutomaticBrightnessController;->mResetAmbientLuxAfterWarmUpConfig:Z

    const/16 v0, 0x2710

    iput v0, v1, Lcom/android/server/display/AutomaticBrightnessController;->mAmbientLightHorizon:I

    iput v0, v1, Lcom/android/server/display/AutomaticBrightnessController;->mWeightingIntercept:I

    move-object/from16 v2, p16

    iput-object v2, v1, Lcom/android/server/display/AutomaticBrightnessController;->mHysteresisLevels:Lcom/android/server/display/HysteresisLevels;

    const/4 v0, 0x1

    iput-boolean v0, v1, Lcom/android/server/display/AutomaticBrightnessController;->mShortTermModelValid:Z

    const/high16 v3, -0x40800000    # -1.0f

    iput v3, v1, Lcom/android/server/display/AutomaticBrightnessController;->mShortTermModelAnchor:F
    ...
    iput-boolean v0, v1, Lcom/android/server/display/AutomaticBrightnessController;->mLodFeature:Z
    ...
    iput-object v0, v1, Lcom/android/server/display/AutomaticBrightnessController;->mDaemon:Lvendor/oneplus/hardware/display/V1_0/IOneplusDisplay;
    :try_end_0
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/server/display/AutomaticBrightnessController$AutomaticBrightnessHandler;-><init>(Lcom/android/server/display/AutomaticBrightnessController;Landroid/os/Looper;)V

    iput-object v0, v1, Lcom/android/server/display/AutomaticBrightnessController;->mHandler:Lcom/android/server/display/AutomaticBrightnessController$AutomaticBrightnessHandler;

    new-instance v0, Lcom/android/server/display/AutomaticBrightnessController$AmbientLightRingBuffer;

    iget v3, v1, Lcom/android/server/display/AutomaticBrightnessController;->mNormalLightSensorRate:I

    int-to-long v2, v3

    iget v4, v1, Lcom/android/server/display/AutomaticBrightnessController;->mAmbientLightHorizon:I

    invoke-direct {v0, v2, v3, v4}, Lcom/android/server/display/AutomaticBrightnessController$AmbientLightRingBuffer;-><init>(JI)V

    iput-object v0, v1, Lcom/android/server/display/AutomaticBrightnessController;->mAmbientLightRingBuffer:Lcom/android/server/display/AutomaticBrightnessController$AmbientLightRingBuffer;

    iget-object v0, v1, Lcom/android/server/display/AutomaticBrightnessController;->mSensorManager:Landroid/hardware/SensorManager;
    ...
    iput-object v0, v1, Lcom/android/server/display/AutomaticBrightnessController;->mLightSensor:Landroid/hardware/Sensor;
    ...
    iput-object v0, v1, Lcom/android/server/display/AutomaticBrightnessController;->mProximitySensor:Landroid/hardware/Sensor;
    ...
    iput-object v0, v1, Lcom/android/server/display/AutomaticBrightnessController;->mPickUpSensor:Landroid/hardware/Sensor;
...
.method static synthetic access$1000(Lcom/android/server/display/AutomaticBrightnessController;)Z
    ...
    iget-boolean v0, p0, Lcom/android/server/display/AutomaticBrightnessController;->mOffCheckFlag:Z
...
.method static synthetic access$1002(Lcom/android/server/display/AutomaticBrightnessController;Z)Z
    ...
    iput-boolean p1, p0, Lcom/android/server/display/AutomaticBrightnessController;->mOffCheckFlag:Z
...
.method static synthetic access$1102(Lcom/android/server/display/AutomaticBrightnessController;Z)Z
    ...
    iput-boolean p1, p0, Lcom/android/server/display/AutomaticBrightnessController;->mOffChecking:Z

    return p1
.end method

.method static synthetic access$1202(Lcom/android/server/display/AutomaticBrightnessController;Landroid/os/CountDownTimer;)Landroid/os/CountDownTimer;
    .locals 0

    iput-object p1, p0, Lcom/android/server/display/AutomaticBrightnessController;->mADSmothTimer:Landroid/os/CountDownTimer;
...
.method static synthetic access$1800(Lcom/android/server/display/AutomaticBrightnessController;)Z
    .locals 1
...
.method static synthetic access$1802(Lcom/android/server/display/AutomaticBrightnessController;Z)Z
    .locals 0
...
.method static synthetic access$2002(Lcom/android/server/display/AutomaticBrightnessController;Z)Z
    .locals 0
...
.method static synthetic access$2200(Lcom/android/server/display/AutomaticBrightnessController;)F
    .locals 1
...
.method static synthetic access$2300(Lcom/android/server/display/AutomaticBrightnessController;)Landroid/hardware/SensorEventListener;
    .locals 1
...
.method static synthetic access$2400(Lcom/android/server/display/AutomaticBrightnessController;)Landroid/hardware/SensorManager;
    .locals 1
...
.method static synthetic access$2500(Lcom/android/server/display/AutomaticBrightnessController;)Z
    ...
    iget-boolean v0, p0, Lcom/android/server/display/AutomaticBrightnessController;->mLodFeature:Z

    return v0
.end method

.method static synthetic access$2600(Lcom/android/server/display/AutomaticBrightnessController;)J
    .locals 2
...
.method static synthetic access$2602(Lcom/android/server/display/AutomaticBrightnessController;J)J
    .locals 0
...
.method static synthetic access$2700(Lcom/android/server/display/AutomaticBrightnessController;)V
    .locals 0
...
.method static synthetic access$400(Lcom/android/server/display/AutomaticBrightnessController;)I
    ...
    iget v0, p0, Lcom/android/server/display/AutomaticBrightnessController;->incStrength:I
...
.method static synthetic access$402(Lcom/android/server/display/AutomaticBrightnessController;I)I
    ...
    iput p1, p0, Lcom/android/server/display/AutomaticBrightnessController;->incStrength:I

    return p1
.end method

.method static synthetic access$412(Lcom/android/server/display/AutomaticBrightnessController;I)I
    .locals 1
    ...
    iput v0, p0, Lcom/android/server/display/AutomaticBrightnessController;->incStrength:I

    return v0
.end method

.method static synthetic access$500(Lcom/android/server/display/AutomaticBrightnessController;)Lvendor/oneplus/hardware/display/V1_0/IOneplusDisplay;
    .locals 1

    iget-object v0, p0, Lcom/android/server/display/AutomaticBrightnessController;->mDaemon:Lvendor/oneplus/hardware/display/V1_0/IOneplusDisplay;
...
.method static synthetic access$600(Lcom/android/server/display/AutomaticBrightnessController;)F
    ...
    iget v0, p0, Lcom/android/server/display/AutomaticBrightnessController;->mGlobaAmbientLux:F
...
.method static synthetic access$700(Lcom/android/server/display/AutomaticBrightnessController;)Z
    ...
    iget-boolean v0, p0, Lcom/android/server/display/AutomaticBrightnessController;->mOnCheckFlag:Z
...
.method static synthetic access$702(Lcom/android/server/display/AutomaticBrightnessController;Z)Z
    ...
    iput-boolean p1, p0, Lcom/android/server/display/AutomaticBrightnessController;->mOnCheckFlag:Z
...
.method static synthetic access$802(Lcom/android/server/display/AutomaticBrightnessController;Z)Z
    ...
    iput-boolean p1, p0, Lcom/android/server/display/AutomaticBrightnessController;->mAD_ON:Z
...
.method static synthetic access$902(Lcom/android/server/display/AutomaticBrightnessController;Z)Z
    ...
    iput-boolean p1, p0, Lcom/android/server/display/AutomaticBrightnessController;->mOnChecking:Z
...
.method private setAutoAssertiveDisplay(F)V
    .locals 8

    iget-boolean v0, p0, Lcom/android/server/display/AutomaticBrightnessController;->mAD_ON:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/display/AutomaticBrightnessController;->mOnChecking:Z

    if-nez v0, :cond_1

    iput-boolean v3, p0, Lcom/android/server/display/AutomaticBrightnessController;->mOnChecking:Z

    iput-boolean v3, p0, Lcom/android/server/display/AutomaticBrightnessController;->mOnCheckFlag:Z

    iget-object v0, p0, Lcom/android/server/display/AutomaticBrightnessController;->mADTimer:Landroid/os/CountDownTimer;
    ...
    iput-object v1, p0, Lcom/android/server/display/AutomaticBrightnessController;->mADTimer:Landroid/os/CountDownTimer;
    ...
    invoke-direct/range {v2 .. v7}, Lcom/android/server/display/AutomaticBrightnessController$4;-><init>(Lcom/android/server/display/AutomaticBrightnessController;JJ)V

    invoke-virtual {v0}, Lcom/android/server/display/AutomaticBrightnessController$4;->start()Landroid/os/CountDownTimer;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/display/AutomaticBrightnessController;->mADTimer:Landroid/os/CountDownTimer;
    ...
    iget-boolean v0, p0, Lcom/android/server/display/AutomaticBrightnessController;->mOffChecking:Z

    if-nez v0, :cond_3

    iput-boolean v3, p0, Lcom/android/server/display/AutomaticBrightnessController;->mOffChecking:Z

    iput-boolean v3, p0, Lcom/android/server/display/AutomaticBrightnessController;->mOffCheckFlag:Z
    ...
    invoke-direct/range {v2 .. v7}, Lcom/android/server/display/AutomaticBrightnessController$5;-><init>(Lcom/android/server/display/AutomaticBrightnessController;JJ)V

    invoke-virtual {v0}, Lcom/android/server/display/AutomaticBrightnessController$5;->start()Landroid/os/CountDownTimer;
...
.method private setLightSensorEnabled(Z)Z
    ...
    iget-boolean v2, p0, Lcom/android/server/display/AutomaticBrightnessController;->mLodFeature:Z
    ...
    iget-object v2, p0, Lcom/android/server/display/AutomaticBrightnessController;->mADTimer:Landroid/os/CountDownTimer;
    ...
    iput-object v3, p0, Lcom/android/server/display/AutomaticBrightnessController;->mADTimer:Landroid/os/CountDownTimer;

    iput-boolean v1, p0, Lcom/android/server/display/AutomaticBrightnessController;->mOnChecking:Z

    iput-boolean v1, p0, Lcom/android/server/display/AutomaticBrightnessController;->mOffChecking:Z
    ...
    :goto_0
    iget-boolean v2, p0, Lcom/android/server/display/AutomaticBrightnessController;->mAD_ON:Z
    ...
    sget-object v2, Lcom/android/server/oneplus/display/ColorBalanceService;->mIsScreenOn:Ljava/lang/Boolean;
    ...
    :cond_3
    :try_start_1
    iget-object v2, p0, Lcom/android/server/display/AutomaticBrightnessController;->mDaemon:Lvendor/oneplus/hardware/display/V1_0/IOneplusDisplay;

    const/16 v5, 0xc

    invoke-interface {v2, v5, v1}, Lvendor/oneplus/hardware/display/V1_0/IOneplusDisplay;->setMode(II)V
    :try_end_1
    ...
    :goto_1
    iput-boolean v1, p0, Lcom/android/server/display/AutomaticBrightnessController;->mAD_ON:Z

    sget-boolean v2, Lserver/oneplus/scene/OemSceneAdModeController;->mManualAdStatus:Z
    ...
    invoke-interface {v2, v5, v0}, Lvendor/oneplus/hardware/display/V1_0/IOneplusDisplay;->setMode(II)V
    :try_end_2
    ...
    :goto_2
    iget-object v2, p0, Lcom/android/server/display/AutomaticBrightnessController;->mADSmothTimer:Landroid/os/CountDownTimer;
    ...
    iput-object v3, p0, Lcom/android/server/display/AutomaticBrightnessController;->mADSmothTimer:Landroid/os/CountDownTimer;
    ...
    invoke-direct/range {v5 .. v10}, Lcom/android/server/display/AutomaticBrightnessController$3;-><init>(Lcom/android/server/display/AutomaticBrightnessController;JJ)V

    invoke-virtual {v2}, Lcom/android/server/display/AutomaticBrightnessController$3;->start()Landroid/os/CountDownTimer;

    move-result-object v2

    iput-object v2, p0, Lcom/android/server/display/AutomaticBrightnessController;->mADSmothTimer:Landroid/os/CountDownTimer;
    ...
    :cond_6
    iget-boolean v2, p0, Lcom/android/server/display/AutomaticBrightnessController;->mAutoBrightnessEnabled:Z
...
.method private setScreenBrightnessByUser(F)Z
    ...
    const-string v4, "ShortTermModel: anchor="
    ...
    const-string v4, ",UserSetBrightness ="
...
.method private updateAmbientLux(J)V
    ...
    :goto_1
    iput v1, p0, Lcom/android/server/display/AutomaticBrightnessController;->mGlobaAmbientLux:F

    invoke-direct {p0, v1}, Lcom/android/server/display/AutomaticBrightnessController;->setAutoAssertiveDisplay(F)V
    ...
    :cond_b
    iget-boolean v2, p0, Lcom/android/server/display/AutomaticBrightnessController;->mOnSwitchUser:Z
...
.method private updateAutoBrightness(Z)V
    ...
    const-string/jumbo v7, "updateAutoBrightness: value="
    ...
    iput-boolean v5, p0, Lcom/android/server/display/AutomaticBrightnessController;->mEnableAutoBrightness:Z
    ...
    iput-boolean v4, p0, Lcom/android/server/display/AutomaticBrightnessController;->mUpdate_Fast:Z
    ...
    iput-boolean v5, p0, Lcom/android/server/display/AutomaticBrightnessController;->mOnSwitchUser:Z
    ...
    iput-boolean v5, p0, Lcom/android/server/display/AutomaticBrightnessController;->mUpdate_Fast:Z
    ...
    invoke-virtual {v2, v3}, Lcom/android/server/display/BrightnessMappingStrategy;->getHBMBrightness(F)F
    ...
    const-string/jumbo v7, "hbm_brightness="
    ...
    invoke-interface {v3, v2}, Lcom/android/server/display/AutomaticBrightnessController$Callbacks;->animateHBMBrightness(I)V
    ...
    iput-boolean v5, p0, Lcom/android/server/display/AutomaticBrightnessController;->mCall_UpdateFast:Z
...
.method public configure(ZLandroid/hardware/display/BrightnessConfiguration;FZFZI)V
    ...
    const v9, 0x42c954fe    # 100.666f

    cmpl-float v9, v3, v9

    if-eqz v9, :cond_1

    const v9, 0x42c98dd3    # 100.777f
