...
.field private static final HBM_MAX_BRIGHTNESS:I = 0x64
...
# instance fields
.field OP_ENABLE_COVERT_DISPLAY:Z
...
.field mLocalDisplayAdapter:Lcom/android/server/display/LocalDisplayAdapter;
...
.field mPMS:Landroid/content/pm/PackageManager;
...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/display/DisplayManagerService$Injector;)V
    ...
    const-string/jumbo v1, "sys.diable.displayinfo"
    ...
    iput-boolean v1, p0, Lcom/android/server/display/DisplayManagerService;->OP_ENABLE_COVERT_DISPLAY:Z
...
.method static synthetic access$4800(Lcom/android/server/display/DisplayManagerService;F)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/display/DisplayManagerService;->setBrightnessMatrixLevelInternal(F)V
...
.method private getDisplayInfoInternal(II)Landroid/view/DisplayInfo;
    ...
    iget-boolean v3, p0, Lcom/android/server/display/DisplayManagerService;->OP_ENABLE_COVERT_DISPLAY:Z

    if-eqz v3, :cond_0

    if-nez p1, :cond_0

    invoke-direct {p0, v2, p2}, Lcom/android/server/display/DisplayManagerService;->tryConvertDpi(Landroid/view/DisplayInfo;I)Landroid/view/DisplayInfo;
...
.method private registerDefaultDisplayAdapters()V
    ...
    iput-object v1, p0, Lcom/android/server/display/DisplayManagerService;->mLocalDisplayAdapter:Lcom/android/server/display/LocalDisplayAdapter;

    iget-object v1, p0, Lcom/android/server/display/DisplayManagerService;->mLocalDisplayAdapter:Lcom/android/server/display/LocalDisplayAdapter;
...
.method private setBrightnessMatrixLevelInternal(F)V
    .locals 2
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/display/DisplayTransformManager;->setBrightnessMatrixLevel(F)V
    ...
    const-string v1, "Brightness level must be between 0 and 1"
...
.method private setSaturationLevelInternal(F)V
    ...
    const-string/jumbo v2, "grayscale  is opening"
    ...
    const-string/jumbo v2, "grayscale is closed"
...
.method private tryConvertDpi(Landroid/view/DisplayInfo;I)Landroid/view/DisplayInfo;
    .locals 4
    ...
    iget-object v2, p0, Lcom/android/server/display/DisplayManagerService;->mPMS:Landroid/content/pm/PackageManager;
    ...
    iput-object v2, p0, Lcom/android/server/display/DisplayManagerService;->mPMS:Landroid/content/pm/PackageManager;
    ...
    :cond_1
    invoke-static {v1, p2}, Lcom/android/server/wm/WindowManagerService;->isDisplayCompat(Ljava/lang/String;I)Z
    ...
    invoke-static {v2}, Lcom/android/server/wm/WindowManagerService;->getDensityForResolution(I)I
