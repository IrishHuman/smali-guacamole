...
.field private mDropPkgAlarmList:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.field private mDropPkgAlarmMap:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap<",
            "Ljava/lang/String;",
...
.field private mDropPkgNetWorkAlarmMap:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap<",
            "Ljava/lang/String;",
...
.field private mDropPkgNetworkAlarmList:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.field private mIsDropPkgNetAlarmEnabled:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/server/AlarmManagerService;->mDropPkgAlarmMap:Ljava/util/HashMap;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/server/AlarmManagerService;->mDropPkgAlarmList:Ljava/util/List;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/android/server/AlarmManagerService;->mIsDropPkgNetAlarmEnabled:Z

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, Lcom/android/server/AlarmManagerService;->mDropPkgNetWorkAlarmMap:Ljava/util/HashMap;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lcom/android/server/AlarmManagerService;->mDropPkgNetworkAlarmList:Ljava/util/List;
    ...
    iput-object v1, p0, Lcom/android/server/AlarmManagerService;->mPendingBackgroundAlarms:Landroid/util/SparseArray;

    new-instance v1, Ljava/lang/Object;

    invoke-direct {v1}, Ljava/lang/Object;-><init>()V

    iput-object v1, p0, Lcom/android/server/AlarmManagerService;->mPendingDelayWakeupAlarmsLock:Ljava/lang/Object;
    ...
    new-instance v3, Lcom/android/server/AlarmManagerService$Alignment;
    ...
    iget-object v6, p0, Lcom/android/server/AlarmManagerService;->mConfigHandler:Lcom/android/server/AlarmManagerService$ConfigHandler;

    invoke-direct {v3, p0, v4, v5, v6}, Lcom/android/server/AlarmManagerService$Alignment;-><init>(Lcom/android/server/AlarmManagerService;Landroid/content/Context;Landroid/os/Handler;Landroid/os/Handler;)V

    iput-object v3, p0, Lcom/android/server/AlarmManagerService;->mAlignment:Lcom/android/server/AlarmManagerService$Alignment;
    ...
    const-string v3, "OP_FEATURE_RESRTICT_PKG_BASE_ON_NETWORK enabled, update mIsDropPkgNetAlarmEnabled to true by default"

    invoke-static {v0, v3}, Landroid/util/Slog;->e(Ljava/lang/String;Ljava/lang/String;)I

    :cond_1
    iput-boolean v1, p0, Lcom/android/server/AlarmManagerService;->mIsDropPkgNetAlarmEnabled:Z
...
.method static synthetic access$1202(Lcom/android/server/AlarmManagerService;Z)Z
    ...
    iput-boolean p1, p0, Lcom/android/server/AlarmManagerService;->mIsDropPkgNetAlarmEnabled:Z

    return p1
.end method

.method static synthetic access$1300(Lcom/android/server/AlarmManagerService;)Ljava/util/List;
    .locals 1
...
.method static synthetic access$1400(Lcom/android/server/AlarmManagerService;Landroid/app/PendingIntent;Landroid/app/IAlarmListener;)V
    .locals 0
...
.method static synthetic access$1500(Lcom/android/server/AlarmManagerService;)Ljava/util/HashMap;
    .locals 1

    iget-object v0, p0, Lcom/android/server/AlarmManagerService;->mDropPkgAlarmMap:Ljava/util/HashMap;

    return-object v0
.end method

.method static synthetic access$1600(Lcom/android/server/AlarmManagerService;Ljava/util/HashMap;Ljava/io/PrintWriter;Z)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/AlarmManagerService;->dumpDropPkgAlarmInfo(Ljava/util/HashMap;Ljava/io/PrintWriter;Z)V
...
.method static synthetic access$1700(Lcom/android/server/AlarmManagerService;)Ljava/util/HashMap;
    ...
    iget-object v0, p0, Lcom/android/server/AlarmManagerService;->mDropPkgNetWorkAlarmMap:Ljava/util/HashMap;

    return-object v0
.end method

.method static synthetic access$1900(Lcom/android/server/AlarmManagerService;J)I
    .locals 1
...
.method static synthetic access$2300(Lcom/android/server/AlarmManagerService;Lcom/android/server/AlarmManagerService$Alarm;)Z
    .locals 1
...
.method static synthetic access$2400(Lcom/android/server/AlarmManagerService;)Landroid/content/Context;
    .locals 1
...
.method static synthetic access$2700(Lcom/android/server/AlarmManagerService;)Landroid/util/ArrayMap;
    .locals 1
...
.method static synthetic access$3100(Lcom/android/server/AlarmManagerService;JI)I
    .locals 1
...
.method static synthetic access$3202(Lcom/android/server/AlarmManagerService;J)J
    .locals 0
...
.method static synthetic access$3300(Lcom/android/server/AlarmManagerService;)Landroid/util/ArrayMap;
    .locals 1
...
.method static synthetic access$3702(Lcom/android/server/AlarmManagerService;J)J
    .locals 0
...
.method static synthetic access$3800(Lcom/android/server/AlarmManagerService;)Landroid/content/Intent;
    .locals 1
...
.method static synthetic access$4000(Lcom/android/server/AlarmManagerService;)Landroid/os/IBinder;
    .locals 1
...
.method private dumpDropPkgAlarmInfo(Ljava/util/HashMap;Ljava/io/PrintWriter;Z)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string v2, "===Pkg network block alarm info==="

    goto :goto_0

    :cond_0
    const-string v2, "===Pkg block alarm info==="
...
.method private ifDropPkgAlarm(Ljava/util/HashMap;Lcom/android/server/AlarmManagerService$Alarm;ZZ)Z
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string v5, "Drop Pkg - "

    goto :goto_0

    :cond_1
    const-string v5, "Skip Pkg - "

    :goto_0
    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v5, p2, Lcom/android/server/AlarmManagerService$Alarm;->packageName:Ljava/lang/String;
    ...
    const-string/jumbo v5, "network alarm(a) : "

    goto :goto_1

    :cond_2
    const-string v5, "alarm(a) : "
    ...
    const-string v4, "Drop Pkg - "

    goto :goto_2

    :cond_7
    const-string v4, "Skip Pkg - "

    :goto_2
    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v4, p2, Lcom/android/server/AlarmManagerService$Alarm;->packageName:Ljava/lang/String;
    ...
    const-string/jumbo v4, "network alarm(l) : "

    goto :goto_3

    :cond_8
    const-string v4, "alarm(l) : "

    :goto_3
    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v4, p2, Lcom/android/server/AlarmManagerService$Alarm;->listenerTag:Ljava/lang/String;
...
.method private initDropPkgAlarmMap(Ljava/util/HashMap;Ljava/util/List;Z)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string v8, " should be dropped "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    if-eqz p3, :cond_0

    const-string v8, "based on network reachability"
    ...
    const-string v8, "Add alarm black - "
...
.method private resolveFrequentBlackListConfigFromJSON(Lorg/json/JSONArray;)V
    ...
    const-string v5, "config_oemDropPkgAlarm"
    ...
    iget-object v5, p0, Lcom/android/server/AlarmManagerService;->mDropPkgAlarmList:Ljava/util/List;
    ...
    :try_start_6
    iget-object v6, p0, Lcom/android/server/AlarmManagerService;->mDropPkgAlarmList:Ljava/util/List;
    ...
    sget-boolean v7, Lcom/android/server/AlarmManagerService;->DEBUG_ONEPLUS:Z
    ...
    :cond_5
    iget-object v7, p0, Lcom/android/server/AlarmManagerService;->mDropPkgAlarmList:Ljava/util/List;
    ...
    :cond_6
    iget-object v6, p0, Lcom/android/server/AlarmManagerService;->mDropPkgAlarmMap:Ljava/util/HashMap;

    iget-object v7, p0, Lcom/android/server/AlarmManagerService;->mDropPkgAlarmList:Ljava/util/List;

    invoke-direct {p0, v6, v7, v1}, Lcom/android/server/AlarmManagerService;->initDropPkgAlarmMap(Ljava/util/HashMap;Ljava/util/List;Z)V
    ...
    const-string v5, "config_oemDropPkgNetworkAlarm"
    ...
    iget-object v5, p0, Lcom/android/server/AlarmManagerService;->mDropPkgNetworkAlarmList:Ljava/util/List;
    ...
    :try_start_8
    iget-object v6, p0, Lcom/android/server/AlarmManagerService;->mDropPkgNetworkAlarmList:Ljava/util/List;
    ...
    :cond_8
    iget-object v7, p0, Lcom/android/server/AlarmManagerService;->mDropPkgNetworkAlarmList:Ljava/util/List;
    ...
    :cond_9
    iget-object v6, p0, Lcom/android/server/AlarmManagerService;->mDropPkgNetWorkAlarmMap:Ljava/util/HashMap;

    iget-object v7, p0, Lcom/android/server/AlarmManagerService;->mDropPkgNetworkAlarmList:Ljava/util/List;

    const/4 v8, 0x1

    invoke-direct {p0, v6, v7, v8}, Lcom/android/server/AlarmManagerService;->initDropPkgAlarmMap(Ljava/util/HashMap;Ljava/util/List;Z)V
...
.method private setImplLocked(IJJJJJLandroid/app/PendingIntent;Landroid/app/IAlarmListener;Ljava/lang/String;IZLandroid/os/WorkSource;Landroid/app/AlarmManager$AlarmClockInfo;ILjava/lang/String;)V
    ...
    iget-object v7, v1, Lcom/android/server/AlarmManagerService;->mPendingDelayOperation:Ljava/util/ArrayList;
    ...
    const-string v9, " cancel setImplLocked  beause of screenOffAdjust tag ="
    ...
    invoke-virtual {v1, v7, v8}, Lcom/android/server/AlarmManagerService;->currentNonWakeupDelayLocked(J)J
    ...
    :cond_4
    iput-wide v11, v2, Lcom/android/server/AlarmManagerService$Alarm;->origWhen:J

    iput-wide v11, v2, Lcom/android/server/AlarmManagerService$Alarm;->when:J

    iput-wide v7, v2, Lcom/android/server/AlarmManagerService$Alarm;->whenElapsed:J

    move-object/from16 v13, p13

    invoke-direct {v1, v6, v13}, Lcom/android/server/AlarmManagerService;->removeLocked(Landroid/app/PendingIntent;Landroid/app/IAlarmListener;)V

    iget-object v14, v1, Lcom/android/server/AlarmManagerService;->mDropPkgAlarmMap:Ljava/util/HashMap;

    invoke-direct {v1, v14, v2, v0, v5}, Lcom/android/server/AlarmManagerService;->ifDropPkgAlarm(Ljava/util/HashMap;Lcom/android/server/AlarmManagerService$Alarm;ZZ)Z
    ...
    :cond_5
    iget-boolean v14, v1, Lcom/android/server/AlarmManagerService;->mIsDropPkgNetAlarmEnabled:Z

    if-eqz v14, :cond_6

    iget-object v14, v1, Lcom/android/server/AlarmManagerService;->mDropPkgNetWorkAlarmMap:Ljava/util/HashMap;

    invoke-direct {v1, v14, v2, v5, v5}, Lcom/android/server/AlarmManagerService;->ifDropPkgAlarm(Ljava/util/HashMap;Lcom/android/server/AlarmManagerService$Alarm;ZZ)Z
    ...
    invoke-direct {v1, v2, v0, v14}, Lcom/android/server/AlarmManagerService;->setImplLocked(Lcom/android/server/AlarmManagerService$Alarm;ZZ)V
    ...
    iget-object v7, v1, Lcom/android/server/AlarmManagerService;->mDropPkgAlarmMap:Ljava/util/HashMap;

    invoke-direct {v1, v7, v2, v0, v5}, Lcom/android/server/AlarmManagerService;->ifDropPkgAlarm(Ljava/util/HashMap;Lcom/android/server/AlarmManagerService$Alarm;ZZ)Z
    ...
    :cond_8
    iget-boolean v7, v1, Lcom/android/server/AlarmManagerService;->mIsDropPkgNetAlarmEnabled:Z

    if-eqz v7, :cond_9

    iget-object v7, v1, Lcom/android/server/AlarmManagerService;->mDropPkgNetWorkAlarmMap:Ljava/util/HashMap;

    invoke-direct {v1, v7, v2, v5, v5}, Lcom/android/server/AlarmManagerService;->ifDropPkgAlarm(Ljava/util/HashMap;Lcom/android/server/AlarmManagerService$Alarm;ZZ)Z
...
.method public onBootPhase(I)V
    ...
    invoke-virtual {v1}, Lcom/android/server/AlarmManagerService$Alignment;->initBlackAlarm()V
...
.method public onStart()V
    ...
    const-string v7, "feature - OP_FEATURE_RESRTICT_PKG_BASE_ON_NETWORK is enabled"
    ...
    iget-object v7, p0, Lcom/android/server/AlarmManagerService;->mDropPkgNetWorkAlarmMap:Ljava/util/HashMap;

    invoke-direct {p0, v7, v5, v6}, Lcom/android/server/AlarmManagerService;->initDropPkgAlarmMap(Ljava/util/HashMap;Ljava/util/List;Z)V
...
.method restorePendingWhileIdleAlarmsLocked()V
    ...
    iget-object v0, v1, Lcom/android/server/AlarmManagerService;->mPendingWhileIdleAlarms:Ljava/util/ArrayList;
    ...
    iput-object v2, v1, Lcom/android/server/AlarmManagerService;->mPendingWhileIdleAlarms:Ljava/util/ArrayList;
    ...
    iget-wide v3, v6, Lcom/android/server/AlarmManagerService$Alarm;->origWhen:J
    ...
    :cond_3
    invoke-virtual {v1, v6, v8, v9, v7}, Lcom/android/server/AlarmManagerService;->reAddAlarmLocked(Lcom/android/server/AlarmManagerService$Alarm;JZ)V
    ...
    :cond_4
    iget-object v3, v6, Lcom/android/server/AlarmManagerService$Alarm;->statsTag:Ljava/lang/String;

    if-eqz v3, :cond_5

    iget-object v3, v6, Lcom/android/server/AlarmManagerService$Alarm;->statsTag:Ljava/lang/String;

    invoke-direct {v1, v3}, Lcom/android/server/AlarmManagerService;->checkAlarmOperation(Ljava/lang/String;)Z
    ...
    iget-wide v7, v6, Lcom/android/server/AlarmManagerService$Alarm;->windowLength:J
    ...
    iget-wide v2, v6, Lcom/android/server/AlarmManagerService$Alarm;->windowLength:J
    ...
    :cond_7
    iget-wide v7, v6, Lcom/android/server/AlarmManagerService$Alarm;->repeatInterval:J
    ...
    :goto_4
    iput-wide v12, v0, Lcom/android/server/AlarmManagerService$Alarm;->expectedWhenElapsed:J
    ...
    invoke-virtual {v1, v0, v4, v5, v15}, Lcom/android/server/AlarmManagerService;->reAddAlarmLocked(Lcom/android/server/AlarmManagerService$Alarm;JZ)V
    ...
    const-string/jumbo v4, "reAddAlarmLocked a.when  = "
    ...
    iget-object v4, v0, Lcom/android/server/AlarmManagerService$Alarm;->statsTag:Ljava/lang/String;
    ...
    const-string v4, " operation =  null"
    ...
    :try_start_0
    iget-object v0, v1, Lcom/android/server/AlarmManagerService;->mTimeTickSender:Landroid/app/PendingIntent;
...
.method public setBlockAlarmUidLock(Ljava/lang/String;ZI)V
    ...
    :try_start_0
    sget-object v3, Lcom/android/server/AlarmManagerService;->mFrozeenUids:Landroid/util/ArrayMap;
...
.method triggerAlarmsLocked(Ljava/util/ArrayList;JJ)Z
    ...
    :cond_a
    iget-object v0, v15, Lcom/android/server/AlarmManagerService;->mDropPkgAlarmMap:Ljava/util/HashMap;

    const/4 v1, 0x0

    invoke-direct {v15, v0, v10, v1, v1}, Lcom/android/server/AlarmManagerService;->ifDropPkgAlarm(Ljava/util/HashMap;Lcom/android/server/AlarmManagerService$Alarm;ZZ)Z
    ...
    :cond_b
    iget-boolean v0, v15, Lcom/android/server/AlarmManagerService;->mIsDropPkgNetAlarmEnabled:Z

    if-eqz v0, :cond_c

    iget-object v0, v15, Lcom/android/server/AlarmManagerService;->mDropPkgNetWorkAlarmMap:Ljava/util/HashMap;

    const/4 v11, 0x1

    invoke-direct {v15, v0, v10, v11, v1}, Lcom/android/server/AlarmManagerService;->ifDropPkgAlarm(Ljava/util/HashMap;Lcom/android/server/AlarmManagerService$Alarm;ZZ)Z
