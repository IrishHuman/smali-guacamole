...
.method private handleStop(I)V
    ...
    const-string v3, "handleStop reason"

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v2, p1}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v3, " stopToast:"
...
.method private isTopActivityDisplayCompat()Z
    ...
    const-string v5, " isTopActivityDisplayCompat topactivity:"
...
.method public isRecognizeScrollView()Z
    ...
    const-string v2, "isRecognizeScrollView getLastMove:"
...
.method public notifyScrollViewSearchComplete(III)V
    ...
    const-string v2, "notifyWindowLayerChange scrollViewType:"
...
.method public stop(I)V
    ...
    const-string v2, " Configs.IS_LONGSHOT_RUNNING:"
...
.method public updateState(Lcom/oneplus/screenshot/longshot/state/LongshotState;Lcom/oneplus/screenshot/longshot/state/LongshotAction$OnStateListener;)V
    ...
    invoke-direct {p0, v2}, Lcom/oneplus/screenshot/longshot/state/LongshotMode;->blockWindowTouch(Z)V

    invoke-direct {p0, v2}, Lcom/oneplus/screenshot/longshot/state/LongshotMode;->disableKeys(Z)V
    ...
    invoke-virtual {v4}, Lcom/oneplus/screenshot/longshot/preview/PreviewController;->onStart()V

    iget-object v4, p0, Lcom/oneplus/screenshot/longshot/state/LongshotMode;->mBarCache:Lcom/oneplus/screenshot/longshot/cache/ImageCache;
    ...
    invoke-virtual {v7, v2}, Lcom/oneplus/screenshot/longshot/cache/ImageCache;->get(I)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Landroid/graphics/Bitmap;

    invoke-virtual {v6, v2}, Lcom/oneplus/screenshot/longshot/preview/PreviewController;->setStatusbar(Landroid/graphics/Bitmap;)V
    ...
    invoke-virtual {v6, v3}, Lcom/oneplus/screenshot/longshot/cache/ImageCache;->get(I)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Landroid/graphics/Bitmap;

    invoke-virtual {v2, v3}, Lcom/oneplus/screenshot/longshot/preview/PreviewController;->setNavibar(Landroid/graphics/Bitmap;)V
