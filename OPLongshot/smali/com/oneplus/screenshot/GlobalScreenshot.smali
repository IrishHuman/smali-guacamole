...
.method private createScreenshotDropOutAnimation(IIZZ)Landroid/animation/ValueAnimator;
    ...
    invoke-direct {v7, p0, v2, v6}, Lcom/oneplus/screenshot/GlobalScreenshot$18;-><init>(Lcom/oneplus/screenshot/GlobalScreenshot;Landroid/view/animation/Interpolator;Landroid/graphics/PointF;)V
...
.method private endScreenshotAnim()V
    ...
    iget-boolean v2, p0, Lcom/oneplus/screenshot/GlobalScreenshot;->mIsBusy:Z
...
.method private endSmallScreenshotAnim(Z)V
    ...
    const-string v1, "simple edit is launching,cancel endSmallScreenshotAnim"
    ...
    iget v3, p0, Lcom/oneplus/screenshot/GlobalScreenshot;->mWindowState:I

    const/4 v4, 0x1

    if-nez v3, :cond_2

    iget-object v3, p0, Lcom/oneplus/screenshot/GlobalScreenshot;->mFinisher:Ljava/lang/Runnable;

    invoke-direct {p0, v3, v4, v2, v4}, Lcom/oneplus/screenshot/GlobalScreenshot;->saveScreenshotInWorkerThread(Ljava/lang/Runnable;ZLjava/lang/Runnable;Z)V
    ...
    invoke-direct {p0, v3, v1, v2, v4}, Lcom/oneplus/screenshot/GlobalScreenshot;->saveScreenshotInWorkerThread(Ljava/lang/Runnable;ZLjava/lang/Runnable;Z)V

    :goto_0
    const/4 v0, 0x1

    :cond_3
    iget-object v3, p0, Lcom/oneplus/screenshot/GlobalScreenshot;->mAnimationScreenshotIcon:Landroid/widget/ImageView;
    ...
    :cond_4
    iget-object v3, p0, Lcom/oneplus/screenshot/GlobalScreenshot;->mAnimationWindow:Landroid/widget/FrameLayout;
    ...
    :cond_8
    iget-object v3, p0, Lcom/oneplus/screenshot/GlobalScreenshot;->mSmallScreenshot:Landroid/widget/ImageView;

    invoke-virtual {v3, v2}, Landroid/widget/ImageView;->setImageBitmap(Landroid/graphics/Bitmap;)V

    iput-boolean v1, p0, Lcom/oneplus/screenshot/GlobalScreenshot;->mIsSmallScreenshotBusy:Z

    const/high16 v1, 0x3f800000    # 1.0f

    iput v1, p0, Lcom/oneplus/screenshot/GlobalScreenshot;->mSmallScreenAnimScale:F
...
.method private hideScreenshotLayout()V
    ...
    const-string v2, "hideScreenshotLayout mWindowState:"

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v2, p0, Lcom/oneplus/screenshot/GlobalScreenshot;->mWindowState:I
...
.method private setWindowState(I)V
    ...
    const-string v2, " setWindowState:"
...
.method private shareVia(Landroid/content/Context;)V
    ...
    const-string v3, "footer_share_times"
...
.method public onClick(Landroid/view/View;)V
    ...
    .sparse-switch
        ...
        0x7f0e0056 -> :sswitch_5
        0x7f0e0057 -> :sswitch_4
        0x7f0e0059 -> :sswitch_3
        0x7f0e005e -> :sswitch_2
        0x7f0e00f1 -> :sswitch_1
...
.method takeScreenshot(Ljava/lang/Runnable;ZZLandroid/graphics/Rect;)V
    ...
    iget-object v6, v7, Lcom/oneplus/screenshot/GlobalScreenshot;->mDisplayMetrics:Landroid/util/DisplayMetrics;
    ...
    iput-object v6, v7, Lcom/oneplus/screenshot/GlobalScreenshot;->mScreenBitmap:Landroid/graphics/Bitmap;
    ...
    new-instance v2, Lcom/oneplus/screenshot/GlobalScreenshot$closeReceiver;

    const/4 v0, 0x0

    invoke-direct {v2, v7, v0}, Lcom/oneplus/screenshot/GlobalScreenshot$closeReceiver;-><init>(Lcom/oneplus/screenshot/GlobalScreenshot;Lcom/oneplus/screenshot/GlobalScreenshot$1;)V

    iput-object v2, v7, Lcom/oneplus/screenshot/GlobalScreenshot;->mCloseReceiver:Lcom/oneplus/screenshot/GlobalScreenshot$closeReceiver;
    ...
    invoke-static {v0, v14, v15, v6, v5}, Landroid/graphics/Bitmap;->createBitmap(Landroid/graphics/Bitmap;IIII)Landroid/graphics/Bitmap;
