...
.method public onPermissionDataObtained(Landroid/util/GlobalPermissionState$PackagePermissionState;)V
    ...
    const-string v2, "PermissionManager onPermissionDataObtained permissionState.mPkgName:"

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v2, p1, Landroid/util/GlobalPermissionState$PackagePermissionState;->mPkgName:Ljava/lang/String;
    ...
    :cond_2
    invoke-static {v3}, Lcom/oneplus/settings/permission/CustomPermissionUtils;->isCustomPermission(Ljava/lang/String;)Z
    ...
    check-cast v4, Landroid/util/GlobalPermissionState$PermissionState;

    iget-boolean v4, v4, Landroid/util/GlobalPermissionState$PermissionState;->isGranted:Z

    if-eqz v4, :cond_3

    invoke-static {v3}, Lcom/oneplus/settings/permission/CustomPermissionUtils;->getGroupForCustomPermission(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v5, v3}, Lcom/oneplus/settings/permission/CustomPermissionUtils;->getGroupLabelForCustomPermission(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v6}, Lcom/android/settings/applications/appinfo/AppPermissionPreferenceController;->access$100(Lcom/android/settings/applications/appinfo/AppPermissionPreferenceController;)Ljava/util/List;

    move-result-object v6

    invoke-interface {v6, v5}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    const-string v6, "PermissionPrefControl"
...
.method public onPermissionDataUpdated(I)V
    ...
    const-string v2, "onPermissionDataUpdated result:"
...
.method public onServiceConnected()V
    ...
    const-string v2, "PermissionManager queryPermissionData packageName:"
