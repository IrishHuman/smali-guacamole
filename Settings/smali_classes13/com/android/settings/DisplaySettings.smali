...
.field private mScreenRefreshRate:Landroid/support/v7/preference/Preference;

.field private mScreenResolutionAdjust:Landroid/support/v7/preference/Preference;
...
.field private mVideoEnhancerPreference:Landroid/support/v7/preference/Preference;
...
.method private disableEntryForAccessibilityDisplayDaltonizerAndInversion()V
    ...
    :cond_3
    iget-object v5, p0, Lcom/android/settings/DisplaySettings;->mNightModePreference:Landroid/support/v7/preference/Preference;
    ...
    :cond_7
    iget-object v5, p0, Lcom/android/settings/DisplaySettings;->mReadingModePreference:Landroid/support/v7/preference/Preference;
...
.method private updateScreenColorModePreference()V
    ...
    const-string v1, "ro.sensor.not_support_rbg"
    ...
    iget-object v2, p0, Lcom/android/settings/DisplaySettings;->mScreenColorModePreference:Landroid/support/v7/preference/Preference;
...
.method private updateState()V
    ...
    :cond_15
    :goto_a
    iget-object v0, p0, Lcom/android/settings/DisplaySettings;->mVideoEnhancerPreference:Landroid/support/v7/preference/Preference;
    ...
    iget-object v3, p0, Lcom/android/settings/DisplaySettings;->mVideoEnhancerPreference:Landroid/support/v7/preference/Preference;
    ...
    :cond_19
    iget-object v0, p0, Lcom/android/settings/DisplaySettings;->mScreenResolutionAdjust:Landroid/support/v7/preference/Preference;
    ...
    :cond_1c
    iget-object v0, p0, Lcom/android/settings/DisplaySettings;->mScreenRefreshRate:Landroid/support/v7/preference/Preference;
    ...
    iget-object v1, p0, Lcom/android/settings/DisplaySettings;->mScreenRefreshRate:Landroid/support/v7/preference/Preference;
...
.method private updateThemeModePreferenceDescription(I)V
    ...
    iget-object v3, p0, Lcom/android/settings/DisplaySettings;->mThemeModePreference:Landroid/support/v7/preference/ListPreference;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v7, p0, Lcom/android/settings/DisplaySettings;->mVideoEnhancerPreference:Landroid/support/v7/preference/Preference;
    ...
    iget-object v7, p0, Lcom/android/settings/DisplaySettings;->mVideoEnhancerPreference:Landroid/support/v7/preference/Preference;

    if-eqz v7, :cond_17

    iget-object v7, p0, Lcom/android/settings/DisplaySettings;->mScreenBrightnessRootPreference:Landroid/support/v7/preference/PreferenceCategory;

    iget-object v8, p0, Lcom/android/settings/DisplaySettings;->mVideoEnhancerPreference:Landroid/support/v7/preference/Preference;
    ...
    const-string v8, "font_style_settings"

    invoke-virtual {p0, v8}, Lcom/android/settings/DisplaySettings;->findPreference(Ljava/lang/CharSequence;)Landroid/support/v7/preference/Preference;
    ...
    const-string v7, "header_category_custom"

    invoke-virtual {p0, v7}, Lcom/android/settings/DisplaySettings;->removePreference(Ljava/lang/String;)Z

    :cond_1e
    iget-object v7, p0, Lcom/android/settings/DisplaySettings;->mSliderAnimator:Landroid/animation/ValueAnimator;
    ...
    const-string v7, "status_bar_custom"

    invoke-virtual {p0, v7}, Lcom/android/settings/DisplaySettings;->removePreference(Ljava/lang/String;)Z

    :cond_20
    const-string v7, "oneplus_screen_refresh_rate"

    invoke-virtual {p0, v7}, Lcom/android/settings/DisplaySettings;->findPreference(Ljava/lang/CharSequence;)Landroid/support/v7/preference/Preference;

    move-result-object v7

    iput-object v7, p0, Lcom/android/settings/DisplaySettings;->mScreenRefreshRate:Landroid/support/v7/preference/Preference;
    ...
    iget-object v7, p0, Lcom/android/settings/DisplaySettings;->mScreenRefreshRate:Landroid/support/v7/preference/Preference;

    invoke-virtual {v7, v5}, Landroid/support/v7/preference/Preference;->setVisible(Z)V

    :cond_21
    const-string v7, "oneplus_screen_resolution_adjust"

    invoke-virtual {p0, v7}, Lcom/android/settings/DisplaySettings;->findPreference(Ljava/lang/CharSequence;)Landroid/support/v7/preference/Preference;

    move-result-object v7

    iput-object v7, p0, Lcom/android/settings/DisplaySettings;->mScreenResolutionAdjust:Landroid/support/v7/preference/Preference;
    ...
    :cond_22
    iget-object v7, p0, Lcom/android/settings/DisplaySettings;->mScreenResolutionAdjust:Landroid/support/v7/preference/Preference;
