...
.method private static buildPreferenceControllers(Landroid/content/Context;Landroid/app/Activity;Lcom/android/settings/deviceinfo/aboutphone/MyDeviceInfoFragment;Lcom/android/settingslib/core/lifecycle/Lifecycle;)Ljava/util/List;
    ...
    new-instance v2, Lcom/oneplus/settings/OPCarrierConfigVersionPreferenceController;

    invoke-direct {v2, p0}, Lcom/oneplus/settings/OPCarrierConfigVersionPreferenceController;-><init>(Landroid/content/Context;)V

    invoke-interface {v0, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance v2, Lcom/android/settings/deviceinfo/BrandNamePreferenceController;

    invoke-direct {v2, p0}, Lcom/android/settings/deviceinfo/BrandNamePreferenceController;-><init>(Landroid/content/Context;)V
