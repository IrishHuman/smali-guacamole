...
.method protected initViews()V
    ...
    invoke-virtual {p0, v3}, Lcom/android/settings/fingerprint/SetupFaceUnlockEnrollIntroduction;->setHeaderText(I)V
    ...
    invoke-virtual {p0, v2}, Lcom/android/settings/fingerprint/SetupFaceUnlockEnrollIntroduction;->setHeaderTextColor(I)V
...
.method protected onActivityResult(IILandroid/content/Intent;)V
    ...
    iget-boolean v2, p0, Lcom/android/settings/fingerprint/SetupFaceUnlockEnrollIntroduction;->mAlreadyHadLockScreenSetup:Z
    ...
    const-string v3, "enter_faceunlock_mode_settings_from_suw"

    invoke-virtual {v1, v3, v0}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    const-string v0, "hw_auth_token"

    iget-object v3, p0, Lcom/android/settings/fingerprint/SetupFaceUnlockEnrollIntroduction;->mToken:[B

    invoke-virtual {v1, v0, v3}, Landroid/content/Intent;->putExtra(Ljava/lang/String;[B)Landroid/content/Intent;

    iget v0, p0, Lcom/android/settings/fingerprint/SetupFaceUnlockEnrollIntroduction;->mUserId:I
    ...
    invoke-virtual {p0, v1, v4}, Lcom/android/settings/fingerprint/SetupFaceUnlockEnrollIntroduction;->startActivityForResult(Landroid/content/Intent;I)V
    ...
    iget-object v4, p0, Lcom/android/settings/fingerprint/SetupFaceUnlockEnrollIntroduction;->mToken:[B
    ...
    :cond_7
    invoke-direct {p0}, Lcom/android/settings/fingerprint/SetupFaceUnlockEnrollIntroduction;->goToNextPage()V
    ...
    invoke-virtual {p0}, Lcom/android/settings/fingerprint/SetupFaceUnlockEnrollIntroduction;->updatePasswordQuality()V
