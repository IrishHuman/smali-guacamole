...
.method private goSkipOrNext(Z)V
    .locals 4

    iput-boolean p1, p0, Lcom/android/settings/fingerprint/SetupFingerprintEnrollIntroduction;->mForFingerprint:Z

    iget-boolean v0, p0, Lcom/android/settings/fingerprint/SetupFingerprintEnrollIntroduction;->mNextButtonClicked:Z
    ...
    iput-boolean v0, p0, Lcom/android/settings/fingerprint/SetupFingerprintEnrollIntroduction;->mNextButtonClicked:Z

    iget-boolean v0, p0, Lcom/android/settings/fingerprint/SetupFingerprintEnrollIntroduction;->mHasPassword:Z

    if-nez v0, :cond_1

    invoke-virtual {p0}, Lcom/android/settings/fingerprint/SetupFingerprintEnrollIntroduction;->launchChooseLock()V
    ...
    invoke-virtual {p0}, Lcom/android/settings/fingerprint/SetupFingerprintEnrollIntroduction;->launchConfirmLock()V

    goto :goto_0

    :cond_2
    iget-object v0, p0, Lcom/android/settings/fingerprint/SetupFingerprintEnrollIntroduction;->mToken:[B

    invoke-virtual {p0, v0}, Lcom/android/settings/fingerprint/SetupFingerprintEnrollIntroduction;->launchFindSensor([B)V

    :goto_0
    iget-object v0, p0, Lcom/android/settings/fingerprint/SetupFingerprintEnrollIntroduction;->mHandler:Landroid/os/Handler;

    new-instance v1, Lcom/android/settings/fingerprint/SetupFingerprintEnrollIntroduction$2;

    invoke-direct {v1, p0}, Lcom/android/settings/fingerprint/SetupFingerprintEnrollIntroduction$2;-><init>(Lcom/android/settings/fingerprint/SetupFingerprintEnrollIntroduction;)V
...
.method protected onActivityResult(IILandroid/content/Intent;)V
    ...
    invoke-virtual {p0}, Lcom/android/settings/fingerprint/SetupFingerprintEnrollIntroduction;->skipToNextPage()V
    ...
    :cond_1
    invoke-virtual {p0, v1}, Lcom/android/settings/fingerprint/SetupFingerprintEnrollIntroduction;->setResult(I)V
...
.method protected onCancelButtonClick()V
    ...
    invoke-direct {p0, v0}, Lcom/android/settings/fingerprint/SetupFingerprintEnrollIntroduction;->goSkipOrNext(Z)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-boolean v0, p0, Lcom/android/settings/fingerprint/SetupFingerprintEnrollIntroduction;->mFromSetup:Z
    ...
    iput-object v1, p0, Lcom/android/settings/fingerprint/SetupFingerprintEnrollIntroduction;->mHowToUseTipsAnimView:Lcom/airbnb/lottie/LottieAnimationView;
    ...
    iget-object v1, p0, Lcom/android/settings/fingerprint/SetupFingerprintEnrollIntroduction;->mHowToUseTipsAnimView:Lcom/airbnb/lottie/LottieAnimationView;
    ...
    const-string v3, "op_custom_fingerprint_guide_dark.json"
